...
export declare function getDeployEnvFiles(projectDir: string): Promise<string[]>;
...
export declare function deployAction(dir: string | undefined, opts: StudioDeployOptions): Promise<void>;
export {};
