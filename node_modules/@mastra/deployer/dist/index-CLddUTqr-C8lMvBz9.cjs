//#region ../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@/quansync/0.2.11/80c02040920fbd1f80e0521f68247e3de68ce8d966700e38ce40b9ed5f8db5e3/node_modules/quansync/dist/index.mjs
...
//#endregion
//#region ../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@standard-community/standard-json/0.3.5/66cfaacd123cb91a4622503e450d47277c5e66dafdfc7e9d4c4d1c8f5b17d18e/node_modules/@standard-community/standard-json/dist/index-CLddUTqr.js
...
const getToJsonSchemaFn = async (vendor) => {
	...
	switch (vendor) {
		case "arktype":
			vendorFnPromise = (await Promise.resolve().then(() => require("./arktype-aI7TBD0R-BWucI7hY.cjs"))).default();
			break;
		case "effect":
			vendorFnPromise = (await Promise.resolve().then(() => require("./effect-QlVUlMFu-CWx-dnsz.cjs"))).default();
			break;
		case "sury":
			vendorFnPromise = (await Promise.resolve().then(() => require("./sury-CWZTCd75-Bbjr0vWq.cjs"))).default();
			break;
		case "typebox":
			vendorFnPromise = (await Promise.resolve().then(() => require("./typebox-Dei93FPO-n37w7tHC.cjs"))).default();
			break;
		case "valibot":
			vendorFnPromise = (await Promise.resolve().then(() => require("./valibot--1zFm7rT-BN2-Xy7Y.cjs"))).default();
			break;
		case "zod":
			vendorFnPromise = (await Promise.resolve().then(() => require("./zod-Bwrt9trS-Cbwhu5Zl.cjs"))).default();
			break;
...
//# sourceMappingURL=index-CLddUTqr-C8lMvBz9.cjs.map