...
const getToJsonSchemaFn = async (vendor) => {
	...
	switch (vendor) {
		case "arktype":
			vendorFnPromise = (await import("./arktype-aI7TBD0R-D06--n84.js")).default();
			break;
		case "effect":
			vendorFnPromise = (await import("./effect-QlVUlMFu-CovUzKO9.js")).default();
			break;
		case "sury":
			vendorFnPromise = (await import("./sury-CWZTCd75-C3LyvnOp.js")).default();
			break;
		case "typebox":
			vendorFnPromise = (await import("./typebox-Dei93FPO-EcvSqxpn.js")).default();
			break;
		case "valibot":
			vendorFnPromise = (await import("./valibot--1zFm7rT-DLXBDt2x.js")).default();
			break;
		case "zod":
			vendorFnPromise = (await import("./zod-Bwrt9trS-Si3ZkB_H.js")).default();
			break;
...
//#endregion
export { MissingDependencyError as t };

//# sourceMappingURL=index-CLddUTqr-Btqs8t-3.js.map