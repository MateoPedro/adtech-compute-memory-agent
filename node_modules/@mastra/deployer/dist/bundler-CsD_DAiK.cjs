...
function nodeModulesExtensionResolver() {
	...
	return {
		...
		async resolveId(id, importer, options) {
			if (!importer || !require_utils.isBareModuleSpecifier(id) || require_utils.isExternalProtocolImport(id) || (0, path.isAbsolute)(id)) return null;
...
//# sourceMappingURL=bundler-CsD_DAiK.cjs.map