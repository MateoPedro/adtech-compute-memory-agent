...
var dynamic_workflows_exports = /* @__PURE__ */ __exportAll({
...
*/
const LIST_DYNAMIC_WORKFLOWS_ROUTE = createRoute({
	method: "GET",
...
*/
const GET_DYNAMIC_WORKFLOW_ROUTE = createRoute({
	method: "GET",
...
*/
const UPSERT_DYNAMIC_WORKFLOW_ROUTE = createRoute({
	method: "POST",
	path: "/stored/workflows",
	responseType: "json",
...
*/
const DELETE_DYNAMIC_WORKFLOW_ROUTE = createRoute({
	method: "DELETE",
	path: "/stored/workflows/:dynamicWorkflowId",
	responseType: "json",
	pathParamSchema: dynamicWorkflowIdPathParams,
...
//# sourceMappingURL=dynamic-workflows-C6U0Rdoc.js.map