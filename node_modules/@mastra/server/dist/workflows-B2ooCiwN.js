import { a as messageResponseSchema, f as tracingOptionsSchema, p as typedPermissive, r as createCombinedPaginationSchema } from "./common-5ZZuR6wj.js";
...
*/
const serializedStepFlowEntrySchema = z.object({ type: z.enum([
	"step",
	"agent",
	"tool",
	"mapping",
...
*/
const sendWorkflowRunEventBodySchema = z.object({
	event: z.string(),
	data: z.unknown()
});
...
*/
const workflowControlResponseSchema = messageResponseSchema;
/**
...
//#endregion
export { workflowRunCountsResponseSchema as _, observeWorkflowQuerySchema as a, workflowRunResultSchema as b, sendWorkflowRunEventBodySchema as c, streamWorkflowBodySchema as d, timeTravelBodySchema as f, workflowInfoSchema as g, workflowIdPathParams as h, listWorkflowsResponseSchema as i, startAsyncWorkflowBodySchema as l, workflowExecutionResultSchema as m, createWorkflowRunResponseSchema as n, restartBodySchema as o, workflowControlResponseSchema as p, listWorkflowRunsQuerySchema as r, resumeBodySchema as s, createWorkflowRunBodySchema as t, streamLegacyWorkflowBodySchema as u, workflowRunPathParams as v, workflowRunsResponseSchema as x, workflowRunResultQuerySchema as y };

//# sourceMappingURL=workflows-B2ooCiwN.js.map