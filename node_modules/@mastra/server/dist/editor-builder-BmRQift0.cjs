...
async function resolveBuilderFeatures(mastra) {
	...
	const parsed = require_editor_builder.agentFeaturesSchema.safeParse(features);
...
async function requireBuilderFeature(mastra, feature) {
	if (!await isBuilderFeatureEnabled(mastra, feature)) throw new require_http_exception.HTTPException(404, { message: "Not Found" });
}
/**
...
*/
const GET_EDITOR_BUILDER_SETTINGS_ROUTE = require_route_builder.createRoute({
	method: "GET",
	path: "/editor/builder/settings",
	responseType: "json",
	responseSchema: require_editor_builder.builderSettingsResponseSchema,
	...
	handler: async ({ mastra }) => {
		try {
			...
			return require_server_handlers_error.handleError(error, "Error getting builder settings");
		}
	}
});
/**
...
*/
const GET_EDITOR_BUILDER_AVAILABLE_MODELS_ROUTE = require_route_builder.createRoute({
	method: "GET",
	path: "/editor/builder/models/available",
	responseType: "json",
	responseSchema: require_editor_builder.builderAvailableModelsResponseSchema,
	...
	handler: async ({ mastra }) => {
		try {
			const providers = (await require_server_handlers_agents.buildProvidersList(mastra)).filter((provider) => provider.connected);
			...
			return require_server_handlers_error.handleError(error, "Error fetching available models");
		}
	}
});
/**
...
*/
const GET_INFRASTRUCTURE_STATUS_ROUTE = require_route_builder.createRoute({
	method: "GET",
	path: "/editor/builder/infrastructure",
	responseType: "json",
	responseSchema: require_editor_builder.infrastructureStatusResponseSchema,
	...
	handler: async ({ mastra }) => {
		try {
			...
			return require_server_handlers_error.handleError(error, "Error getting infrastructure status");
		}
	}
});
//#endregion
Object.defineProperty(exports, "GET_EDITOR_BUILDER_AVAILABLE_MODELS_ROUTE", {
	enumerable: true,
	get: function() {
		return GET_EDITOR_BUILDER_AVAILABLE_MODELS_ROUTE;
	}
});
Object.defineProperty(exports, "GET_EDITOR_BUILDER_SETTINGS_ROUTE", {
	enumerable: true,
	get: function() {
		return GET_EDITOR_BUILDER_SETTINGS_ROUTE;
	}
});
Object.defineProperty(exports, "GET_INFRASTRUCTURE_STATUS_ROUTE", {
	enumerable: true,
	get: function() {
		return GET_INFRASTRUCTURE_STATUS_ROUTE;
	}
});
Object.defineProperty(exports, "isBuilderFeatureEnabled", {
	enumerable: true,
	get: function() {
		return isBuilderFeatureEnabled;
	}
});
Object.defineProperty(exports, "requireBuilderFeature", {
	enumerable: true,
	get: function() {
		return requireBuilderFeature;
	}
});

//# sourceMappingURL=editor-builder-BmRQift0.cjs.map