...
var ViewerRegistry = class {
	...
	*/
	async addViewer(viewerKey, ws, getToolset, agentId, threadId) {
		...
		viewerSet.add(ws);
		if (wasEmpty) await this.startScreencast(viewerKey, getToolset, agentId ?? viewerKey, threadId);
	...
	*/
	async startScreencast(viewerKey, getToolset, agentId, threadId) {
		...
		if (toolset.isBrowserRunning()) await this.doStartScreencast(viewerKey, toolset, threadId);
