...
import { l as runIdSchema } from "../../common-5ZZuR6wj.js";
...
var scores_exports = /* @__PURE__ */ __exportAll({
...
const LIST_SCORERS_ROUTE = createRoute({
	method: "GET",
	path: "/scores/scorers",
	responseType: "json",
...
const GET_SCORER_ROUTE = createRoute({
	method: "GET",
...
const LIST_SCORES_BY_RUN_ID_ROUTE = createRoute({
	method: "GET",
...
const LIST_SCORES_BY_SCORER_ID_ROUTE = createRoute({
	method: "GET",
...
const LIST_SCORES_BY_ENTITY_ID_ROUTE = createRoute({
	method: "GET",
	...
	handler: async ({ mastra, entityId, entityType, ...params }) => {
		try {
			...
			if (entityType === "AGENT") entityIdToUse = (await getAgentFromSystem({
				mastra,
				agentId: entityId
			})).id;
...
const SAVE_SCORE_ROUTE = createRoute({
	method: "POST",
	path: "/scores",
	responseType: "json",
	...
	handler: async ({ mastra, ...params }) => {
		try {
			...
			if (!result) throw new HTTPException(500, { message: "Storage not configured" });
			return result;
		} catch (error) {
...
//#endregion
export { GET_SCORER_ROUTE, LIST_SCORERS_ROUTE, LIST_SCORES_BY_ENTITY_ID_ROUTE, LIST_SCORES_BY_RUN_ID_ROUTE, LIST_SCORES_BY_SCORER_ID_ROUTE, SAVE_SCORE_ROUTE, scores_exports as t };
