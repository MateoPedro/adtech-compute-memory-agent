export declare const CREATE_RESPONSE_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "POST";
    path: "/v1/responses";
...
export declare const GET_RESPONSE_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "GET";
...
export declare const DELETE_RESPONSE_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "DELETE";
    path: "/v1/responses/:responseId";
    responseType: "json";
    streamFormat?: "sse" | "stream";
