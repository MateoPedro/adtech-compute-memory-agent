export declare const LIST_AGENT_BUILDER_ACTIONS_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "GET";
    path: "/agent-builder";
    responseType: "json";
    ...
    readonly __schemas?: import("../server-adapter").RouteSchemas<undefined, undefined, undefined, import("zod").ZodRecord<import("zod").ZodString, import("zod").ZodObject<{
...
export declare const GET_AGENT_BUILDER_ACTION_BY_ID_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "GET";
...
export declare const LIST_AGENT_BUILDER_ACTION_RUNS_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "GET";
    ...
    readonly __schemas?: import("../server-adapter").RouteSchemas<import("zod").ZodObject<{
        ...
        runs: import("zod").ZodArray<import("zod").ZodObject<{
            ...
            snapshot: import("zod").ZodType<string | import("@mastra/core/workflows").WorkflowRunState, unknown, import("zod/v4/core").$ZodTypeInternals<string | import("@mastra/core/workflows").WorkflowRunState, unknown>>;
...
export declare const GET_AGENT_BUILDER_ACTION_RUN_BY_ID_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "GET";
    ...
    readonly __schemas?: import("../server-adapter").RouteSchemas<import("zod").ZodObject<{
        ...
        steps: import("zod").ZodOptional<import("zod").ZodRecord<import("zod").ZodString, import("zod").ZodUnknown>>;
...
export declare const CREATE_AGENT_BUILDER_ACTION_RUN_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "POST";
...
export declare const STREAM_AGENT_BUILDER_ACTION_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "POST";
...
export declare const START_ASYNC_AGENT_BUILDER_ACTION_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "POST";
...
export declare const START_AGENT_BUILDER_ACTION_RUN_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "POST";
...
export declare const OBSERVE_STREAM_AGENT_BUILDER_ACTION_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "POST";
...
export declare const RESUME_ASYNC_AGENT_BUILDER_ACTION_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "POST";
 ...
 */
export declare const RESUME_NO_WAIT_AGENT_BUILDER_ACTION_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "POST";
...
export declare const RESUME_AGENT_BUILDER_ACTION_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "POST";
...
export declare const RESUME_STREAM_AGENT_BUILDER_ACTION_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "POST";
...
export declare const CANCEL_AGENT_BUILDER_ACTION_RUN_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "POST";
...
export declare const STREAM_LEGACY_AGENT_BUILDER_ACTION_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "POST";
...
export declare const OBSERVE_STREAM_LEGACY_AGENT_BUILDER_ACTION_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "POST";
