...
*/
const LIST_PROCESSOR_PROVIDERS_ROUTE = createRoute({
	method: "GET",
...
*/
const GET_PROCESSOR_PROVIDER_ROUTE = createRoute({
	method: "GET",
	...
	handler: async ({ mastra, providerId }) => {
		try {
			...
			if (!provider) throw new HTTPException(404, { message: `Processor provider with id ${providerId} not found` });
			return {
				...provider.info,
				availablePhases: provider.availablePhases,
