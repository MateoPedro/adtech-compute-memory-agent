...
export declare function handleMessageSend({ requestId, params, taskStore, pushNotificationStore, pushNotificationSender, agent, agentId, logger, requestContext, }: {
    ...
    requestContext: RequestContext;
}): Promise<import("@mastra/core/a2a").JSONRPCResponse<null, unknown> | import("@mastra/core/a2a").JSONRPCResponse<Task, unknown>>;
...
export declare function handleTaskList({ requestId, taskStore, agentId, params, }: {
    requestId: number | string;
    taskStore: InMemoryTaskStore;
    agentId: string;
    params: Record<string, any>;
}): import("@mastra/core/a2a").JSONRPCResponse<{
    tasks: {
        id: any;
        contextId: any;
        status: {
...
export declare function handleMessageStream({ requestId, params, taskStore, pushNotificationStore, pushNotificationSender, agent, agentId, logger, requestContext, abortSignal, }: {
    requestId: number | string;
    params: MessageSendParams;
    taskStore: InMemoryTaskStore;
    pushNotificationStore?: InMemoryPushNotificationStore;
...
export declare function getAgentExecutionHandler({ requestId, mastra, agentId, requestContext, method, params, taskStore, pushNotificationStore, pushNotificationSender, logger, abortSignal, protocolVersion, }: Context & {
    requestId: number | string;
    requestContext: RequestContext;
    agentId: string;
    method: 'message/send' | 'message/stream' | 'tasks/get' | 'tasks/list' | 'tasks/cancel' | 'tasks/resubscribe' | 'tasks/pushNotificationConfig/set' | 'tasks/pushNotificationConfig/get' | 'tasks/pushNotificationConfig/list' | 'tasks/pushNotificationConfig/delete' | 'agent/getAuthenticatedExtendedCard';
