export declare const BACKGROUND_TASK_STREAM_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "GET";
...
export declare const LIST_BACKGROUND_TASKS_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "GET";
    ...
    handler(params: {
        agentId?: string | undefined;
        status?: "running" | "suspended" | "failed" | "pending" | "completed" | "cancelled" | "timed_out" | undefined;
        runId?: string | undefined;
        threadId?: string | undefined;
        resourceId?: string | undefined;
        ...
        dateFilterBy?: "createdAt" | "suspendedAt" | "startedAt" | "completedAt" | undefined;
        orderBy?: "createdAt" | "suspendedAt" | "startedAt" | "completedAt" | undefined;
        ...
        tasks: {
            id: string;
            status: "running" | "suspended" | "failed" | "pending" | "completed" | "cancelled" | "timed_out";
            toolName: string;
            toolCallId: string;
    ...
    readonly __schemas?: import("../server-adapter").RouteSchemas<undefined, import("zod").ZodObject<{
        ...
        dateFilterBy: import("zod").ZodOptional<import("zod").ZodEnum<{
            createdAt: "createdAt";
        ...
        tasks: import("zod").ZodArray<import("zod").ZodObject<{
            ...
            maxRetries: import("zod").ZodNumber;
            timeoutMs: import("zod").ZodNumber;
            suspendPayload: import("zod").ZodOptional<import("zod").ZodUnknown>;
        }, import("zod/v4/core").$strip>>;
...
export declare const GET_BACKGROUND_TASK_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "GET";
    ...
    readonly __schemas?: import("../server-adapter").RouteSchemas<import("zod").ZodObject<{
        backgroundTaskId: import("zod").ZodString;
