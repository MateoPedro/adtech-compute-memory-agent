 ...
 */
export declare const FAVORITE_STORED_AGENT_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "PUT";
 ...
 */
export declare const UNFAVORITE_STORED_AGENT_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "DELETE";
    path: "/stored/agents/:storedAgentId/favorite";
    responseType: "json";
    streamFormat?: "sse" | "stream";
...
//# sourceMappingURL=stored-agent-favorites.d.ts.map