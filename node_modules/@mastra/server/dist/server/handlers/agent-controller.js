...
function getAgentControllerOrThrow(mastra, controllerId) {
	...
	if (!controller) throw new HTTPException(404, { message: `agent controller "${controllerId}" not found` });
	return controller;
}
...
const listMessagesResponseSchema = z.object({ messages: z.array(z.object({
	id: z.string(),
	role: z.enum([
		"user",
		"assistant",
...
const LIST_AGENT_CONTROLLERS_ROUTE = createRoute({
	method: "GET",
...
const CREATE_AGENT_CONTROLLER_SESSION_ROUTE = createRoute({
	method: "POST",
...
const STREAM_AGENT_CONTROLLER_SESSION_ROUTE = createRoute({
	method: "GET",
...
const SEND_AGENT_CONTROLLER_MESSAGE_ROUTE = createRoute({
	method: "POST",
...
const ABORT_AGENT_CONTROLLER_SESSION_ROUTE = createRoute({
	method: "POST",
...
const AGENT_CONTROLLER_TOOL_APPROVAL_ROUTE = createRoute({
	method: "POST",
...
const AGENT_CONTROLLER_TOOL_SUSPENSION_ROUTE = createRoute({
	method: "POST",
...
const STEER_AGENT_CONTROLLER_SESSION_ROUTE = createRoute({
	method: "POST",
...
const SWITCH_AGENT_CONTROLLER_MODE_ROUTE = createRoute({
	method: "POST",
...
const SWITCH_AGENT_CONTROLLER_MODEL_ROUTE = createRoute({
	method: "POST",
...
const SWITCH_AGENT_CONTROLLER_THREAD_ROUTE = createRoute({
	method: "POST",
...
const GET_AGENT_CONTROLLER_SESSION_STATE_ROUTE = createRoute({
	method: "GET",
		...
		try {
			...
			if (requestedThreadId) {
				if (!await (await storage?.getStore("memory"))?.getThreadById({
					...
					resourceId
				})) throw new HTTPException(404, { message: `thread "${requestedThreadId}" not found` });
			}
...
const LIST_AGENT_CONTROLLER_MODES_ROUTE = createRoute({
	method: "GET",
...
const LIST_AGENT_CONTROLLER_ACTIVE_RUNS_ROUTE = createRoute({
	method: "GET",
...
const LIST_AGENT_CONTROLLER_THREADS_ROUTE = createRoute({
	method: "GET",
...
const SEND_AGENT_CONTROLLER_NOTIFICATION_ROUTE = createRoute({
	method: "POST",
...
const CREATE_AGENT_CONTROLLER_THREAD_ROUTE = createRoute({
	method: "POST",
	path: "/agent-controller/:controllerId/sessions/:resourceId/threads",
	responseType: "json",
	pathParamSchema: sessionPathParams,
...
const DELETE_AGENT_CONTROLLER_THREAD_ROUTE = createRoute({
	method: "DELETE",
...
const RENAME_AGENT_CONTROLLER_THREAD_ROUTE = createRoute({
	method: "PUT",
	path: "/agent-controller/:controllerId/sessions/:resourceId/threads/:threadId",
	responseType: "json",
	pathParamSchema: threadPathParams,
...
const CLONE_AGENT_CONTROLLER_THREAD_ROUTE = createRoute({
	method: "POST",
...
const LIST_AGENT_CONTROLLER_THREAD_MESSAGES_ROUTE = createRoute({
	method: "GET",
...
const FOLLOW_UP_AGENT_CONTROLLER_SESSION_ROUTE = createRoute({
	method: "POST",
...
const LIST_AGENT_CONTROLLER_MODELS_ROUTE = createRoute({
	method: "GET",
...
const GET_AGENT_CONTROLLER_WORKSPACE_STATUS_ROUTE = createRoute({
	method: "GET",
...
const GET_AGENT_CONTROLLER_OM_RECORD_ROUTE = createRoute({
	method: "GET",
...
const SET_AGENT_CONTROLLER_RESOURCE_ID_ROUTE = createRoute({
	method: "POST",
...
const GET_AGENT_CONTROLLER_RESOURCE_IDS_ROUTE = createRoute({
	method: "GET",
...
const GET_AGENT_CONTROLLER_GOAL_ROUTE = createRoute({
	method: "GET",
...
const SET_AGENT_CONTROLLER_GOAL_ROUTE = createRoute({
	method: "POST",
	path: "/agent-controller/:controllerId/sessions/:resourceId/goal",
	responseType: "json",
	pathParamSchema: sessionPathParams,
...
const UPDATE_AGENT_CONTROLLER_GOAL_ROUTE = createRoute({
	method: "PUT",
	path: "/agent-controller/:controllerId/sessions/:resourceId/goal",
	responseType: "json",
	pathParamSchema: sessionPathParams,
...
const CLEAR_AGENT_CONTROLLER_GOAL_ROUTE = createRoute({
	method: "DELETE",
	path: "/agent-controller/:controllerId/sessions/:resourceId/goal",
	responseType: "json",
	pathParamSchema: sessionPathParams,
...
const GET_AGENT_CONTROLLER_PERMISSIONS_ROUTE = createRoute({
	method: "GET",
...
const SET_AGENT_CONTROLLER_CATEGORY_PERMISSION_ROUTE = createRoute({
	method: "PUT",
...
const SET_AGENT_CONTROLLER_TOOL_PERMISSION_ROUTE = createRoute({
	method: "PUT",
...
const SET_AGENT_CONTROLLER_SESSION_STATE_ROUTE = createRoute({
	method: "PUT",
