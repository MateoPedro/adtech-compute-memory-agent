import { z } from 'zod';
export declare const LIST_DATASETS_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "GET";
    path: "/datasets";
    responseType: "json";
...
export declare const CREATE_DATASET_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "POST";
    path: "/datasets";
    responseType: "json";
    streamFormat?: "sse" | "stream";
...
export declare const GET_DATASET_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "GET";
    ...
    }, z.core.$strip>, undefined, z.ZodNullable<z.ZodObject<{
        id: z.ZodString;
        name: z.ZodString;
        description: z.ZodNullable<z.ZodOptional<z.ZodString>>;
        metadata: z.ZodNullable<z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodUnknown>>>;
...
export declare const UPDATE_DATASET_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "PATCH";
    path: "/datasets/:datasetId";
    responseType: "json";
    streamFormat?: "sse" | "stream";
...
export declare const DELETE_DATASET_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "DELETE";
    path: "/datasets/:datasetId";
    responseType: "json";
    streamFormat?: "sse" | "stream";
...
export declare const LIST_ITEMS_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "GET";
...
export declare const ADD_ITEM_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "POST";
    path: "/datasets/:datasetId/items";
    responseType: "json";
    streamFormat?: "sse" | "stream";
    ...
    readonly __schemas?: import("../server-adapter").RouteSchemas<z.ZodObject<{
        ...
        expectedTrajectory: z.ZodNullable<z.ZodOptional<z.ZodObject<{
            steps: z.ZodOptional<z.ZodArray<z.ZodUnion<readonly [z.ZodDiscriminatedUnion<[z.ZodObject<{
                ...
                metadata: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodUnknown>>;
                children: z.ZodOptional<z.ZodUnknown>;
            }, z.core.$strip>, z.ZodObject<{
...
export declare const GET_ITEM_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "GET";
...
export declare const UPDATE_ITEM_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "PATCH";
    path: "/datasets/:datasetId/items/:itemId";
    responseType: "json";
    streamFormat?: "sse" | "stream";
...
export declare const DELETE_ITEM_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "DELETE";
    path: "/datasets/:datasetId/items/:itemId";
    responseType: "json";
    streamFormat?: "sse" | "stream";
...
export declare const LIST_ALL_EXPERIMENTS_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "GET";
    path: "/experiments";
    responseType: "json";
    streamFormat?: "sse" | "stream";
...
export declare const EXPERIMENT_REVIEW_SUMMARY_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "GET";
...
export declare const LIST_EXPERIMENTS_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "GET";
...
export declare const TRIGGER_EXPERIMENT_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "POST";
    path: "/datasets/:datasetId/experiments";
    responseType: "json";
    streamFormat?: "sse" | "stream";
...
export declare const LIST_EXPERIMENT_RESULTS_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "GET";
...
export declare const UPDATE_EXPERIMENT_RESULT_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "PATCH";
...
export declare const COMPARE_EXPERIMENTS_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "POST";
...
export declare const LIST_DATASET_VERSIONS_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "GET";
...
export declare const LIST_ITEM_VERSIONS_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "GET";
...
export declare const GET_ITEM_VERSION_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "GET";
...
export declare const BATCH_INSERT_ITEMS_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "POST";
...
export declare const BATCH_DELETE_ITEMS_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "DELETE";
    path: "/datasets/:datasetId/items/batch";
    responseType: "json";
    streamFormat?: "sse" | "stream";
...
export declare const GENERATE_ITEMS_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "POST";
...
export declare const CLUSTER_FAILURES_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "POST";
