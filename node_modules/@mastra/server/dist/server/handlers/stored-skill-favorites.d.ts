 ...
 */
export declare const FAVORITE_STORED_SKILL_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "PUT";
 ...
 */
export declare const UNFAVORITE_STORED_SKILL_ROUTE: Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "DELETE";
    path: "/stored/skills/:storedSkillId/favorite";
    responseType: "json";
    streamFormat?: "sse" | "stream";
...
//# sourceMappingURL=stored-skill-favorites.d.ts.map