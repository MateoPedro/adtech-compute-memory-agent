...
const GET_API_SCHEMA_ROUTE = require_route_builder.createRoute({
	...
	requiresAuth: true,
	handler: async () => {
		const { buildApiSchemaManifest } = await Promise.resolve().then(() => require("../../api-schema-manifest-DPgfugJT.cjs"));
