...
import { l as systemPackagesResponseSchema, t as apiSchemaManifestResponseSchema } from "../../system-0TbTYKJY.js";
...
const GET_API_SCHEMA_ROUTE = createRoute({
	method: "GET",
	...
	requiresAuth: true,
	handler: async () => {
		const { buildApiSchemaManifest } = await import("../../api-schema-manifest-Bx_zU5qw.js");
		return buildApiSchemaManifest();
	}
});
const GET_SYSTEM_PACKAGES_ROUTE = createRoute({
	method: "GET",
