export declare const TOOL_PROVIDER_ROUTES: readonly [Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "GET";
    path: "/tool-providers";
    responseType: "json";
    ...
    handler(params: {
        providerId: string;
        toolSlug: string;
    } & import(".").ServerContext): Promise<Record<string, unknown>>;
    pathParamSchema?: import("zod").ZodType;
    queryParamSchema?: import("zod").ZodType;
    bodySchema?: import("zod").ZodType;
    responseSchema?: import("zod").ZodType;
