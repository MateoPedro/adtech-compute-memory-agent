export declare const STORED_SKILLS_ROUTES: readonly [Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "GET";
    path: "/stored/skills";
    responseType: "json";
    ...
    readonly __schemas?: import(".").RouteSchemas<import("zod").ZodObject<{
        ...
        favorited: import("zod").ZodBoolean;
        favoriteCount: import("zod").ZodNumber;
    }, import("zod/v4/core").$strip>> | undefined;
} & {
    readonly _mastraSchemaRoute: true;
}, Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
