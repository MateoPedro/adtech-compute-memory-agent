 ...
 */
export declare const SYSTEM_ROUTES: readonly [Omit<import("@mastra/core/server").ApiRoute, "path" | "method" | "handler" | "createHandler" | "openapi"> & {
    method: "GET";
    ...
    readonly __schemas?: import(".").RouteSchemas<undefined, undefined, undefined, import("zod").ZodObject<{
        ...
        observabilityStorageCapabilities: import("zod").ZodOptional<import("zod").ZodObject<{
            metrics: import("zod").ZodBoolean;
            logs: import("zod").ZodBoolean;
        }, import("zod/v4/core").$strip>>;
