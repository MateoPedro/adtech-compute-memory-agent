	...
	*/
	getFrameworkPublicMatcher() {
		...
		return (path, method) => {
			...
			return require_helpers.isCustomRoutePublic(path, upperMethod, customAuthConfig);
		};
	}
	async init() {
