import { a as createEventSourceResponseHandler, b as TooManyEmbeddingValuesForCallError, c as generateId, d as parseProviderOptions, h as withoutTrailingSlash, m as resolve, o as createJsonErrorResponseHandler, p as postJsonToApi, r as convertUint8ArrayToBase64, s as createJsonResponseHandler, t as combineHeaders, u as loadApiKey, x as UnsupportedFunctionalityError } from "./dist-F_Ql1co6.js";
...
var googleFailedResponseHandler = createJsonErrorResponseHandler({
	errorSchema: z$1.object({ error: z$1.object({
...
var contentSchema = z$1.object({ parts: z$1.array(z$1.union([
	z$1.object({ functionCall: z$1.object({
		name: z$1.string(),
		args: z$1.unknown()
	}) }),
	z$1.object({ inlineData: z$1.object({
		mimeType: z$1.string(),
		data: z$1.string()
	}) }),
	z$1.object({
...
var groundingMetadataSchema = z$1.object({
	...
	groundingSupports: z$1.array(z$1.object({
		segment: z$1.object({
	...
	retrievalMetadata: z$1.union([z$1.object({ webDynamicRetrievalScore: z$1.number() }), z$1.object({})]).nullish()
});
...
var googleGenerativeAITextEmbeddingResponseSchema = z$1.object({ embeddings: z$1.array(z$1.object({ values: z$1.array(z$1.number()) })) });
...
//# sourceMappingURL=dist-CRgxcDTg.js.map