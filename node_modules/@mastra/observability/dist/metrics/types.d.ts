...
export declare const PricingMeter: {
    ...
    readonly INPUT_CACHE_WRITE_5M_TOKENS: "input_cache_write_5m_tokens";
    readonly INPUT_CACHE_WRITE_1H_TOKENS: "input_cache_write_1h_tokens";
...
export declare const TokenMetrics: {
    ...
    readonly INPUT_CACHE_WRITE_5M: "mastra_model_input_cache_write_5m_tokens";
    readonly INPUT_CACHE_WRITE_1H: "mastra_model_input_cache_write_1h_tokens";
