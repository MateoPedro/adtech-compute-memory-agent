...
import type { Span, ObservabilityExporter, ObservabilityBridge, SpanOutputProcessor, TracingEvent, AnySpan, StartSpanOptions, CreateSpanOptions, ObservabilityInstance, CustomSamplerOptions, ExportedSpan, AnyExportedSpan, TraceState, TracingOptions, LoggerContext, MetricsContext, ObservabilityEvent, UsageStats } from '@mastra/core/observability';
...
export declare abstract class BaseObservabilityInstance extends MastraBase implements ObservabilityInstance {
     ...
     */
    private buildFallbackCorrelationContext;
    /**
    ...
    private getProcessedSpanForExport;
    /**
     ...
     */
    protected emitSpanEnded(span: AnySpan, excludedModelUsage?: {
        usage: UsageStats;
        provider?: string;
        model?: string;
    }): void;
     ...
     */
    private captureExcludedModelUsage;
    /**
