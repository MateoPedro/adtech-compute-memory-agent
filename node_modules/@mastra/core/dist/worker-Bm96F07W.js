...
import { n as StepExecutor, o as getStepEntry, t as WorkflowEventProcessor } from "./workflow-event-processor-mGtERBFZ.js";
import { t as resolveAgentById } from "./resolve-agent-LNSk8IsI.js";
import { t as Scheduler } from "./scheduler-DTwCvgvR.js";
...
var SchedulerWorker = class extends MastraWorker {
	...
	async init(deps) {
		...
		const isTargetReady = mastra ? async (target) => {
			...
			if (target.type === "agent") return (await resolveAgentById(mastra, target.agentId)).status !== "missing";
			return false;
		} : void 0;
...
//# sourceMappingURL=worker-Bm96F07W.js.map