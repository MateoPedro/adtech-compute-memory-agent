...
import { r as aiV5PromptToAIV6Prompt } from "./to-prompt-cgY09klY.js";
import { t as convertToDataContent } from "./content-DX_6irdy.js";
import { c as MastraModelGateway, i as MASTRA_USER_AGENT, l as createOpenAI, p as createOpenAICompatible, q as EventSourceParserStream, s as MASTRA_GATEWAY_STREAM_TRANSPORT, t as createGoogleGenerativeAI } from "./dist-4BaImG1o.js";
import { n as createStreamFromGenerateResult, t as AISDKV5LanguageModel } from "./model-VYZeGw7n.js";
import { i as shouldEnableGateway, n as getGatewayId, r as hasAuthCredentials, t as findGatewayForModel } from "./gateway-helpers-Dh-2ojNA.js";
import { r as parseModelRouterId, t as ModelsDevGateway } from "./models-dev-CFFh_ZJE.js";
import { c as modelSupportsTemperature, d as MastraGateway, n as PROVIDER_REGISTRY, t as GatewayRegistry } from "./provider-registry-DeNcniwM.js";
import { t as NetlifyGateway } from "./netlify-CKznM1ct.js";
...
*/
function remapToolResultMediaPartsToV3(options) {
	return {
		...options,
		prompt: aiV5PromptToAIV6Prompt(options.prompt)
	};
}
function remapCallOptionsToV3(options) {
...
var GatewayManager = class GatewayManager {
	...
	*/
	async resolveAuth(routerId) {
		...
		if (hasAuthCredentials(gatewayAuth)) return {
			...gatewayAuth,
	...
	*/
	async hasAuth(routerId) {
		try {
			return hasAuthCredentials(await this.resolveAuth(routerId));
		} catch (error) {
...
function isOpenAICompatibleObjectConfig(modelConfig) {
	...
	if (!("model" in modelConfig)) {
		if ("providerId" in modelConfig && "modelId" in modelConfig) return typeof modelConfig.providerId === "string" && typeof modelConfig.modelId === "string";
...
async function resolveModelAuth({ gateway, request, explicit }) {
	if (hasAuthCredentials(explicit)) return mergeAuthHeaders({
		...explicit,
		source: "explicit"
	}) ?? { source: "explicit" };
...
//# sourceMappingURL=llm-Dz6Jt17j.js.map