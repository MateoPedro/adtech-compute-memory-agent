...
import { f as EntityType, o as getRootExportSpan } from "./utils-CoqfpE2k.js";
import "./tracing-DYRZCMQm.js";
import { d as readModelStreamTransport, i as resolveModelConfig, u as attachModelStreamTransport } from "./llm-Dz6Jt17j.js";
...
import { a as coreContentToString, n as MessageList, o as messagesAreEqual, t as convertMessages } from "./message-list-Il1hgrzP.js";
...
import { a as applyStateSignal, o as getStateSignalsMetadata, r as parseMemoryRequestContext, s as resolveStateSignalHistory } from "./types-B09iCpNk.js";
...
function resolveOutputTextSkippingCompletionChecks(messageList) {
	...
	if (responseDbMessages.some((m) => m.content?.metadata?.completionResult)) {
		...
		return lastConverted ? coreContentToString(lastConverted.content) : void 0;
	}
	const responseMessages = messageList.get.response.aiV4.core();
	const lastResponseMessage = responseMessages[responseMessages.length - 1];
	return lastResponseMessage ? coreContentToString(lastResponseMessage.content) : void 0;
}
					...
					case "finish":
						...
						try {
							if (self.processorRunner && !self.#options.isLLMExecutionStep) {
								...
								if (self.#status !== "canceled") self.messageList = await self.processorRunner.runOutputProcessors(self.messageList, resolveObservabilityContext(options), self.#options.requestContext, 0, outputResultWriter, outputResult);
...
//# sourceMappingURL=trip-wire-BYyzlKHl.js.map