...
import { n as MessageList, t as convertMessages } from "../message-list-Il1hgrzP.js";
...
function throwIfA2AErrorResponse(response) {
	...
	if (typeof error !== "object" || !("code" in error) || typeof error.code !== "number" || !("message" in error) || typeof error.message !== "string") throw MastraA2AError.invalidAgentResponse("Remote A2A agent returned a malformed JSON-RPC error response.");
	throw new MastraA2AError(error.code, error.message, "data" in error ? error.data : void 0);
}
