...
import { f as EntityType } from "./utils-CoqfpE2k.js";
import { o as RequestContext, r as MASTRA_RESOURCE_ID_KEY } from "./request-context-bTdjxlgA.js";
import { t as deepEqual } from "./deep-equal-CQ4o_vUw.js";
import { b as isSupportedLanguageModel } from "./trip-wire-BYyzlKHl.js";
import { ln as ScorerRunError, sn as validateAndSaveScore } from "./agent-D5C9QXkF.js";
import { On as extractTrajectory, kn as extractTrajectoryFromTrace } from "./constants-C5_GUpHT.js";
...
async function executeAgent(agent, item, signal, requestContext, experimentId, versions, toolMocks, unmockedToolPolicy) {
	...
	const injectedThreadId = (Boolean(contextResourceId) || contextResourceId === void 0) && !requestContext?.["mastra__threadId"] && typeof agent.hasOwnMemory === "function" && agent.hasOwnMemory() ? randomUUID() : void 0;
	const memoryOption = injectedThreadId ? { memory: {
		...
		resource: contextResourceId ? String(contextResourceId) : `dataset-experiment:${experimentId ?? randomUUID()}:thread:${injectedThreadId}`,
...
//#endregion
export { compareExperiments as a, isRegression as c, runScorersForItem as d, executeTarget as f, ToolMockMatcher as g, TOOL_MOCK_NOT_DECLARED as h, runExperiment as i, EXPERIMENT_ITEM_SCORER_NOT_FOUND as l, TOOL_MOCK_MISMATCH as m, Dataset as n, computeMean as o, TOOL_MOCK_EXHAUSTED as p, EXPERIMENT_ITEM_BEFORE_EACH_FAILED as r, computeScorerStats as s, DatasetsManager as t, resolveScorers as u };

//# sourceMappingURL=manager-DjocF2Uy.js.map