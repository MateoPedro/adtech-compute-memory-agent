import { Bt as ToolCallFilter, Gt as TokenLimiterProcessor, Jt as LanguageDetector, Kt as BatchPartsProcessor, Wt as SystemPromptScrubber, Xt as PromptInjectionDetector, Yt as PIIDetector, Zt as ModerationProcessor, cr as UnicodeNormalizer } from "../agent-D5C9QXkF.js";
...
const structuredOutputOptionsSchema = z.object({ jsonPromptInjection: z.union([z.boolean(), z.enum([
	"system",
	"inline",
	"auto"
])]).optional() }).optional();
...
const tokenLimiterProvider = {
	...
	createProcessor(config) {
		return new TokenLimiterProcessor(config);
	}
};
