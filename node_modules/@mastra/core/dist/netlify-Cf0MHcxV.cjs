...
var netlify_exports = /* @__PURE__ */ require_rolldown_runtime.__exportAll({ NetlifyGateway: () => NetlifyGateway });
var NetlifyGateway = class extends require_dist.MastraModelGateway {
	id = "netlify";
	...
	*/
	...
	async resolveLanguageModel({ modelId, providerId, apiKey, headers }) {
		...
		switch (providerId) {
			...
			case "gemini": return require_dist.createGoogleGenerativeAI({
			...
			default: return require_dist.createOpenAICompatible({
				name: providerId,
				apiKey,
				baseURL,
				headers: mastraHeaders,
...
Object.defineProperty(exports, "netlify_exports", {
	enumerable: true,
	get: function() {
		return netlify_exports;
	}
});

//# sourceMappingURL=netlify-Cf0MHcxV.cjs.map