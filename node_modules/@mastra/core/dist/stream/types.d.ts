...
import type { ModelMessage, StepResult, ToolSet, TypedToolCall, UIMessage } from '../_types/@internal_ai-sdk-v5/dist/index.d.ts';
...
import type { ModelConfigModelSettings } from '../llm/model/model-settings.js';
...
export type ToolOutputDeniedChunk = BaseChunkType & {
    type: 'tool-output-denied';
    payload: ToolOutputDeniedPayload;
};
