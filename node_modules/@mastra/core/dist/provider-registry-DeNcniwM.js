...
import { c as MastraModelGateway, i as MASTRA_USER_AGENT, o as createAnthropic, r as GATEWAY_AUTH_HEADER } from "./dist-4BaImG1o.js";
import { a as getCapabilityFileName, i as shouldEnableGateway, n as getGatewayId } from "./gateway-helpers-Dh-2ojNA.js";
import { i as createOpenRouter, t as ModelsDevGateway } from "./models-dev-CFFh_ZJE.js";
...
var provider_registry_default = {
	providers: {
		...
		"jalapeno": {
			...
			"docUrl": "https://www.jalapeno-cloud.ai/docs/",
			"gateway": "models.dev"
		},
		"abliteration-ai": {
		...
		"google": {
			...
			"gateway": "models.dev",
			"npm": "@ai-sdk/google",
			"deprecatedModels": ["gemini-3.1-flash-lite-preview"]
		},
		"model-oracle-ai": {
		...
		"kosmik": {
			...
			"apiKeyEnvVar": "KOSMIK_API_KEY",
			"apiKeyHeader": "Authorization",
			"name": "Kosmik Compute",
			"models": ["qwen/qwen3.8-27b"],
			"docUrl": "https://api.koscompute.com/docs/",
			"gateway": "models.dev"
		},
		...
		"crusoe": {
			...
			"docUrl": "https://docs.crusoecloud.com/managed-inference/overview",
			"gateway": "models.dev"
		},
		"dinference": {
		...
		"llmtr": {
			...
			"gateway": "models.dev",
			"deprecatedModels": ["medgemma-4b"]
		},
		"merge-gateway": {
			"url": "https://api-gateway.merge.dev/v1/ai-sdk",
			"apiKeyEnvVar": "MERGE_GATEWAY_API_KEY",
			"apiKeyHeader": "Authorization",
			"name": "Merge Gateway",
			"models": [
			...
			"docUrl": "https://docs.merge.dev/merge-gateway",
			"gateway": "models.dev",
		...
		"opencode": {
			...
			"modelOverrides": {
				...
				"muse-spark-1.2": { "npm": "@ai-sdk/openai" },
				...
				"grok-build-0.1": { "npm": "@ai-sdk/openai" },
				"gemini-3.7-flash": { "npm": "@ai-sdk/google" },
		...
		"scnet-token-plan": {
			...
			"docUrl": "https://www.scnet.cn/ac/openapi/doc/2.0/moduleapi/plans/token-plan.html",
			"gateway": "models.dev"
		},
		"anyapi": {
		...
		"amd": {
			...
			"docUrl": "https://developer.amd.com.cn/radeon/tokenfactory",
			"gateway": "models.dev"
		},
		"bailing": {
		...
		"runinfra": {
			...
			"apiKeyEnvVar": "RUNINFRA_GATEWAY_KEY",
			"apiKeyHeader": "Authorization",
			"name": "RunInfra",
			"models": [
		...
		"coralbricks": {
			...
			"docUrl": "https://www.coralbricks.ai/docs",
			"gateway": "models.dev"
		},
		"aiand": {
	...
	models: {
		...
		"hetzner": ["Qwen/Qwen3.6-35B-A3B-FP8", "Qwen3.8-27B"],
		"regolo-ai": [
			"apertus-70b",
			"brick-complexity-pro",
			"brick-v1-beta",
...
var GatewayRegistry = class GatewayRegistry {
	...
	*/
	async syncGateways(forceRefresh = false, writeToSrc = false) {
		...
		try {
			const { ModelsDevGateway } = await import("./models-dev-CFFh_ZJE.js").then((n) => n.n);
			const { NetlifyGateway } = await import("./netlify-CKznM1ct.js").then((n) => n.n);
			const { MastraGateway } = await Promise.resolve().then(() => mastra_exports);
			const { fetchProvidersFromGateways, writeRegistryFiles } = await import("./registry-generator-D7LnGpOn.js");
...
//# sourceMappingURL=provider-registry-DeNcniwM.js.map