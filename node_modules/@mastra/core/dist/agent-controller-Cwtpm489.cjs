...
const require_workspace = require("./workspace-B4kYy4EN.cjs");
const require_tools = require("./tools-0N6yZwmc.cjs");
const require_channels = require("./channels-aTBC4jA1.cjs");
const require_mastra = require("./mastra-CDTky-c8.cjs");
		...
		switch (chunk.type) {
			...
			case "tool-error": {
				...
				this.applyToolOutcome(state, {
					...
					result: getDisplayTransform(chunk.metadata, "error", require_error.getErrorFromUnknown(toolError.error).message),
					isError: true,
			...
			case "tool-output-denied": {
				...
				const args = require_payload_transform.hasTransformedToolPayload(approvalTransform) ? approvalTransform.transformed : getDisplayTransform(chunk.metadata, "input-available", payload.args);
				const toolIndex = state.toolPartById.get(toolCallId);
				const existing = toolIndex !== void 0 ? state.currentMessage.content.parts[toolIndex] : void 0;
...
var Session = class {
	...
	*/
	...
	constructor({ resourceId, state, id, ownerId, tags, workspace, browser }) {
		...
		if (workspace !== void 0 && !(workspace instanceof require_workspace.Workspace)) throw new Error(`A session workspace must be a valid Workspace instance.`);
...
//# sourceMappingURL=agent-controller-Cwtpm489.cjs.map