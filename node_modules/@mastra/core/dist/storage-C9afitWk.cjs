...
var ObservabilityStorage = class ObservabilityStorage extends require_base$1.StorageDomain {
	...
	*/
	async listTracesLight(args) {
		...
		return {
			...rest,
			spans: spans.map(require_constants.toLightSpanRecord)
		};
	}
	/**
...
function createKnowledgeUlid(now = Date.now()) {
	if (now <= lastUlidTime) {
		...
		lastUlidTime = now;
		lastUlidRandom = BigInt(`0x${(0, crypto$1.randomBytes)(10).toString("hex")}`);
	}
...
/** @experimental Knowledge APIs are experimental and may change without notice. */
var KnowledgeStorage = class extends require_base$1.StorageDomain {
	constructor() {
		super({
			component: "STORAGE",
			name: "KNOWLEDGE"
...
var InMemoryMemory = class extends MemoryStorage {
	...
	*/
	...
	async listMessagesByResourceId({ resourceId, include, filter, perPage: perPageInput, page = 0, orderBy }) {
		...
		const finalMessages = new require_message_list.MessageList().add([...paginatedMessages, ...includedMessages].map((m) => this.parseStoredMessage(m)), "memory").get.all.db();
...
Object.defineProperty(exports, "InMemoryKnowledgeStorage", {
	enumerable: true,
	get: function() {
		return InMemoryKnowledgeStorage;
	}
});
...
Object.defineProperty(exports, "KnowledgeConflictError", {
	enumerable: true,
	get: function() {
		return KnowledgeConflictError;
	}
});
Object.defineProperty(exports, "KnowledgeNotFoundError", {
	enumerable: true,
	get: function() {
		return KnowledgeNotFoundError;
	}
});
Object.defineProperty(exports, "KnowledgeStorage", {
	enumerable: true,
	get: function() {
...
Object.defineProperty(exports, "assertKnowledgeCeilingRaised", {
	enumerable: true,
	get: function() {
		return assertKnowledgeCeilingRaised;
	}
});
Object.defineProperty(exports, "assertKnowledgeScopeWithinCeiling", {
	enumerable: true,
	get: function() {
		return assertKnowledgeScopeWithinCeiling;
	}
});
...
Object.defineProperty(exports, "canonicalizeKnowledgeScope", {
	enumerable: true,
	get: function() {
...
Object.defineProperty(exports, "createKnowledgeNodeCursor", {
	enumerable: true,
	get: function() {
		return createKnowledgeNodeCursor;
	}
});
Object.defineProperty(exports, "createKnowledgeUlid", {
	enumerable: true,
	get: function() {
		return createKnowledgeUlid;
	}
});
...
Object.defineProperty(exports, "expandKnowledgeScope", {
	enumerable: true,
	get: function() {
		return expandKnowledgeScope;
	}
});
...
Object.defineProperty(exports, "isKnowledgeScopeVisible", {
	enumerable: true,
	get: function() {
		return isKnowledgeScopeVisible;
	}
});
...
Object.defineProperty(exports, "knowledgeScopeKey", {
	enumerable: true,
	get: function() {
		return knowledgeScopeKey;
	}
});
Object.defineProperty(exports, "knowledgeSemanticDocumentId", {
	enumerable: true,
	get: function() {
		return knowledgeSemanticDocumentId;
	}
});
Object.defineProperty(exports, "knowledgeSemanticIdempotencyKey", {
	enumerable: true,
	get: function() {
		return knowledgeSemanticIdempotencyKey;
	}
});
...
Object.defineProperty(exports, "parseKnowledgeNodeCursor", {
	enumerable: true,
	get: function() {
		return parseKnowledgeNodeCursor;
	}
});
Object.defineProperty(exports, "parseKnowledgeWikilinks", {
	enumerable: true,
	get: function() {
		return parseKnowledgeWikilinks;
	}
});
...
//# sourceMappingURL=storage-C9afitWk.cjs.map