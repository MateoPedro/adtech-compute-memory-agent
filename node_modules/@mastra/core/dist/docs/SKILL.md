...
- [Agents](references/docs-agents-overview.md) - Overview of agents in Mastra, detailing their capabilities and how they interact with tools, workflows, and external systems.
...
- [Tools](references/docs-agents-tools.md) - Learn how to create tools and add them to agents to extend capabilities beyond text generation.
- [Composite Auth](references/docs-auth-composite-auth.md) - Documentation for the CompositeAuth class, which combines multiple authentication providers into a single auth handler.
- [Custom auth provider](references/docs-auth-custom-auth-provider.md) - Create custom authentication providers for specialized identity systems
...
- [Simple Auth](references/docs-auth-simple-auth.md) - Documentation for the SimpleAuth class, which provides token-to-user mapping authentication for development and basic API key scenarios.
- [Workers](references/docs-auth-workers.md) - Secure communication between standalone workers and the Mastra API server.
- [Browser](references/docs-browser.md) - Give agents browser control through SDK providers, CLI tools, or cloud browser services.
- [Channels](references/docs-channels.md) - Channels connect Mastra agents to messaging platforms like Slack, Discord, and Telegram.
...
- [Agent Client Protocol (ACP)](references/docs-connections-acp.md) - Wrap ACP-compatible coding agents as Mastra tools or sub-agents.
...
- [SDK agents](references/docs-connections-sdk-agents.md) - Use Claude Agent SDK, Cursor Agent SDK, and OpenAI Agents SDK agents from Mastra.
- [Datasets](references/docs-datasets-overview.md) - Manage versioned test data, run experiments against agents and workflows, and track results over time.
- [Running experiments](references/docs-datasets-running-experiments.md) - Run experiments against agents or workflows, with scoring and result tracking.
...
- [Develop](references/docs-develop.md) - Develop and test Mastra agents locally with the development server, Studio, and AI-assisted tools.
...
- [Multi-turn evals](references/docs-evals-multi-turn.md) - Evaluate agent behavior across multi-turn conversations by sending sequential inputs on a shared thread.
...
- [Multi-agent systems](references/docs-guides-multi-agent-systems.md) - Learn what multi-agent systems are, why teams use them, and how common patterns map to Mastra.
- [Streaming](references/docs-guides-streaming.md) - Streaming in Mastra enables real-time, incremental responses from both agents and workflows, providing immediate feedback as AI-generated content is produced.
- [Agent Controller](references/docs-harness-agent-controller.md) - Build interactive agent applications with isolated sessions, persistent threads, modes, approvals, subagents, and channels.
...
- [Durable agents](references/docs-harness-durable-agents.md) - Learn how to wrap agents with durable execution so streams survive disconnects, process restarts, and long-running turns.
...
- [Harness](references/docs-harness-overview.md) - Start, continue, update, and preserve agent work beyond a single request.
...
- [Signal providers](references/docs-harness-signal-providers.md) - Learn what signal providers are and how to build one that monitors an external source and pushes notifications into agent threads.
- [Signals](references/docs-harness-signals.md) - Learn how to send real-time messages and context into a Mastra agent thread.
- [Observability](references/docs-mastra-platform-observability.md) - Collect searchable traces, logs, metrics, scores, and feedback from Mastra applications with Mastra Platform Observability.
...
- [Filesystem](references/docs-sandbox-filesystem.md) - Give agents persistent files through sandbox mounts or workspace file tools.
- [LSP inspection](references/docs-sandbox-lsp.md) - Configure Language Server Protocol support for semantic code inspection in workspace files.
- [Sandbox](references/docs-sandbox-overview.md) - Give agents an isolated environment for working with files and running commands.
- [Search and indexing](references/docs-sandbox-search.md) - Index workspace content for BM25 keyword search, vector semantic search, or hybrid mode.
- [Skills](references/docs-sandbox-skills.md) - Teach agents reusable capabilities with the Agent Skills specification.
...
- [Server](references/docs-server-overview.md) - Overview of the Mastra server, covering HTTP endpoints, middleware, authentication, and client integration.
...
- [Request context](references/docs-server-request-context.md) - Learn how to use Mastra's RequestContext to provide runtime, request-specific configuration to agents.
- [Agent skills](references/docs-skills.md) - Give agents reusable skills directly in code, without a full workspace.
...
- [Observability](references/docs-studio-observability.md) - Use the metrics dashboard and traces view, and logs browser in Studio to monitor agent, workflow, plus tool performance.
...
- [Dynamic workflows](references/docs-workflows-dynamic-workflows.md) - Create, persist, update, and run workflows from JSON definitions.
...
- [Human-in-the-loop](references/docs-workflows-human-in-the-loop.md) - Human-in-the-loop workflows in Mastra allow you to pause execution for manual approvals, reviews, or user input before continuing.
- [Workflows](references/docs-workflows-overview.md) - Workflows in Mastra help you orchestrate complex sequences of tasks with features like branching, parallel execution, resource suspension, and more.
...
- [Assistant UI](references/integrations-agentic-ui-assistant-ui.md) - Learn how to integrate Assistant UI with Mastra
- [CopilotKit](references/integrations-agentic-ui-copilotkit.md) - Learn how to integrate CopilotKit with Mastra
- [OpenUI](references/integrations-agentic-ui-openui.md) - Learn how to integrate OpenUI with Mastra
...
- [Discord](references/integrations-channels-discord.md) - Configure a Mastra agent to receive Discord interactions and messages through a channel adapter.
- [GitHub](references/integrations-channels-github.md) - Notify a Mastra agent when subscribed GitHub pull requests change.
- [iMessage](references/integrations-channels-imessage.md) - Configure a Mastra agent to receive iMessage messages through a channel adapter.
- [Slack](references/integrations-channels-slack.md) - Configure a Mastra agent to respond in Slack channels and direct messages through a channel adapter.
- [Microsoft Teams](references/integrations-channels-teams.md) - Configure a Mastra agent to receive Microsoft Teams messages and mentions through a channel adapter.
- [Telegram](references/integrations-channels-telegram.md) - Configure a Mastra agent to receive Telegram messages through a channel adapter.
- [WhatsApp](references/integrations-channels-whatsapp.md) - Configure a Mastra agent to receive WhatsApp Business Cloud messages through a channel adapter.
...
- [DuckDB](references/integrations-databases-duckdb.md) - Documentation for the DuckDB storage implementation in Mastra, an embedded analytical backend for local observability development.
...
- [Astro](references/integrations-frameworks-astro.md) - Get started with Mastra and Astro
- [Electron](references/integrations-frameworks-electron.md) - Get started with Mastra and Electron
- [Express](references/integrations-frameworks-express.md) - Get started with Mastra and Express
- [Hono](references/integrations-frameworks-hono.md) - Get started with Mastra and Hono
- [NestJS](references/integrations-frameworks-nestjs.md) - Get started with Mastra and NestJS
- [Next.js](references/integrations-frameworks-next-js.md) - Get started with Mastra and Next.js
- [Nuxt](references/integrations-frameworks-nuxt.md) - Get started with Mastra and Nuxt
- [SvelteKit](references/integrations-frameworks-sveltekit.md) - Get started with Mastra and SvelteKit
- [React + Vite](references/integrations-frameworks-vite-react.md) - A step-by-step guide to integrating Mastra with React and Vite.
- [Arthur](references/integrations-observability-arthur.md) - Send traces to Arthur AI using OpenTelemetry and OpenInference semantic conventions
- [Firecrawl](references/integrations-tools-firecrawl.md) - Use Firecrawl in Mastra tools to search, scrape, and extract web data.
...
- [Reference: AgentController](references/reference-agent-controller-agent-controller-class.md) - API reference for AgentController, the shared host that creates isolated sessions and coordinates agents, storage, tools, workspaces, and channels.
- [Reference: Session](references/reference-agent-controller-session.md) - API reference for the AgentController Session, which owns the per-conversation state for a single conversation: identity, threads, mode, model, run state, grants, and the display snapshot.
...
- [Reference: Agent.getDefaultGenerateOptionsLegacy()](references/reference-agents-getDefaultGenerateOptions.md) - Documentation for the `Agent.getDefaultGenerateOptionsLegacy()` method in Mastra agents, which retrieves the default options used for legacy generation requests.
...
- [Reference: Agent.getDefaultStreamOptionsLegacy()](references/reference-agents-getDefaultStreamOptions.md) - Documentation for the `Agent.getDefaultStreamOptionsLegacy()` method in Mastra agents, which retrieves the default options used for legacy streaming requests.
...
- [Reference: IFGAProvider](references/reference-auth-fga.md) - API reference for the IFGAProvider interface, which authorizes users and system actors against resources for Mastra fine-grained authorization (FGA).
...
- [Reference: ChannelProvider](references/reference-channels-channel-provider.md) - API reference for ChannelProvider, the interface that platform integrations implement to provision apps and route webhooks, then wire adapters to agents.
...
- [Reference: createCodingAgent()](references/reference-coding-agent-create-coding-agent.md) - API reference for createCodingAgent(), which builds a coding agent with the essential defaults for workspace, task signals with memory, error retries, and goal judge.
- [Reference: Configuration](references/reference-configuration.md) - Reference documentation on Mastra's configuration options
- [Reference: Mastra.addDynamicWorkflow()](references/reference-core-addDynamicWorkflow.md) - Documentation for the `Mastra.addDynamicWorkflow()` method, which validates, persists, and live-registers a dynamic workflow definition.
- [Reference: Mastra.addDynamicWorkflows()](references/reference-core-addDynamicWorkflows.md) - Documentation for the `Mastra.addDynamicWorkflows()` method, which validates, persists, and live-registers a bundle of dynamic workflow definitions.
...
- [Reference: Mastra.getTool()](references/reference-core-getTool.md) - Documentation for the `Mastra.getTool()` method, which retrieves a tool by its Mastra registration key.
- [Reference: Mastra.getToolById()](references/reference-core-getToolById.md) - Documentation for the `Mastra.getToolById()` method, which retrieves a tool by its intrinsic ID or registration key.
...
- [Reference: Mastra.listTools()](references/reference-core-listTools.md) - Documentation for the `Mastra.listTools()` method, which returns the Mastra-level tool registry.
...
- [Reference: Prompt blocks](references/reference-editor-prompt-blocks.md) - Reference for Editor prompt block types, template values, display conditions, versions, and APIs.
...
- [config.ts](references/reference-file-based-agents-config.md) - Set a file-based agent's model and runtime options in config.ts with agentConfig.
- [Instructions](references/reference-file-based-agents-instructions.md) - Write a file-based agent's always-on system prompt with instructions.md or instructions.ts, and learn when to reach for tools or skills instead.
...
- [Observability](references/reference-file-based-agents-observability.md) - Configure observability by file convention with observability.ts.
- [Processors](references/reference-file-based-agents-processors.md) - Add input and output processors to a file-based agent under processors/input/ and processors/output/.
- [Schedules](references/reference-file-based-agents-schedules.md) - Declare recurring cron tasks for a file-based agent under schedules/.
- [Scorers](references/reference-file-based-agents-scorers.md) - Register scorers on a file-based agent under scorers/.
- [Server](references/reference-file-based-agents-server.md) - Configure the Mastra HTTP server by file convention with server.ts.
- [Skills](references/reference-file-based-agents-skills.md) - Add skills to a file-based agent under skills/ using modules or packaged SKILL.md files. Flat markdown is also supported.
...
- [Studio](references/reference-file-based-agents-studio.md) - Configure Mastra Studio by file convention with studio.ts.
- [Subagents](references/reference-file-based-agents-subagents.md) - Declare specialist child agents for a file-based agent under subagents/.
- [Tools](references/reference-file-based-agents-tools.md) - Add tools to a file-based agent by placing createTool modules under tools/.
- [Workflows](references/reference-file-based-agents-workflows.md) - Register workflows by file convention under src/mastra/workflows.
- [Workspace](references/reference-file-based-agents-workspace.md) - Give a file-based agent a workspace with workspace.ts and seed files under workspace/.
...
- [Manual install](references/reference-manual-install.md) - Set up a Mastra project manually without using the create mastra CLI.
...
- [Migration: AI SDK v4 to v5](references/reference-migrations-ai-sdk-v4-to-v5.md) - Mastra-specific guidance for upgrading from AI SDK v4 to v5.
- [Migrate from Mastra Cloud](references/reference-migrations-mastra-cloud.md) - Learn how to migrate from Mastra Cloud to the Mastra platform
- [Migration: .network() to supervisor agents](references/reference-migrations-network-to-supervisor.md) - Learn how to migrate from .network() to supervisor agents using .stream() and .generate() for better multi-agent coordination.
- [Agent class](references/reference-migrations-upgrade-to-v1-agent.md) - Learn how to migrate Agent class changes when upgrading to v1.
...
- [Mastra class](references/reference-migrations-upgrade-to-v1-mastra.md) - Learn how to migrate Mastra class changes when upgrading to v1.
...
- [Overview](references/reference-migrations-upgrade-to-v1-overview.md) - Overview of breaking changes when upgrading to Mastra v1.
- [Processors](references/reference-migrations-upgrade-to-v1-processors.md) - Learn how to migrate processor changes when upgrading to v1.
- [Storage](references/reference-migrations-upgrade-to-v1-storage.md) - Learn how to migrate storage-related changes when upgrading to v1.
- [Tools](references/reference-migrations-upgrade-to-v1-tools.md) - Learn how to migrate tool-related changes when upgrading to v1.
- [Tracing](references/reference-migrations-upgrade-to-v1-tracing.md) - Migration guide for updating from otel-telemetry or AI tracing to the new observability system.
- [Vectors](references/reference-migrations-upgrade-to-v1-vectors.md) - Learn how to migrate vector-related changes when upgrading to v1.
- [Voice](references/reference-migrations-upgrade-to-v1-voice.md) - Learn how to migrate voice package changes when upgrading to v1.
- [Workflows](references/reference-migrations-upgrade-to-v1-workflows.md) - Learn how to migrate workflow-related changes when upgrading to v1.
- [Migration: VNext to standard APIs](references/reference-migrations-vnext-to-standard-apis.md) - Learn how to migrate from VNext methods to the new standard agent APIs in Mastra.
...
- [Reference: TokenCostControl](references/reference-processors-token-cost-control.md) - API reference for TokenCostControl, a processor that enforces monetary cost limits on agent runs.
...
- [Reference: ToolSearchProcessor](references/reference-processors-tool-search-processor.md) - Documentation for the ToolSearchProcessor in Mastra, which enables runtime-defined tool discovery and loading for agents with large tool libraries.
...
- [Project structure](references/reference-project-structure.md) - Guide on organizing folders and files in Mastra, including best practices and recommended structures.
...
- [Reference: mastra.schedules](references/reference-schedules-overview.md) - API reference for mastra.schedules, the service for creating and managing agent and workflow cron schedules.
...
- [Reference: Storage](references/reference-storage-overview.md) - Core data schema and table structure for Mastra's storage system.
...
- [Reference: smoothStream()](references/reference-streaming-smoothStream.md) - API reference for smoothStream(), which buffers text and reasoning deltas and emits them in consistent chunks.
...
- [Reference: Templates](references/reference-templates-overview.md) - Complete guide to creating, using, and contributing Mastra templates
- [Reference: askUserTool](references/reference-tools-ask-user-tool.md) - API reference for askUserTool, a built-in tool that suspends an agent run to ask the user a question and resumes with their answer.
...
- [Reference: submitPlanTool](references/reference-tools-submit-plan-tool.md) - API reference for submitPlanTool, a built-in tool that suspends an agent run to submit a plan file for user approval.
- [Reference: Task tools](references/reference-tools-task-tools.md) - API reference for the built-in task tools (task_write, task_update, task_complete, task_check) that add structured task tracking to any agent.
...
- [Voice in Mastra](references/reference-voice-overview.md) - Overview of voice capabilities in Mastra, including text-to-speech, speech-to-text, and real-time speech-to-speech interactions.
- [Speech-to-Speech capabilities in Mastra](references/reference-voice-speech-to-speech.md) - Overview of speech-to-speech capabilities in Mastra, including real-time interactions and event-driven architecture.
- [Speech-to-Text (STT)](references/reference-voice-speech-to-text.md) - Overview of Speech-to-Text capabilities in Mastra, including configuration, usage, and integration with voice providers.
- [Text-to-Speech (TTS)](references/reference-voice-text-to-speech.md) - Overview of Text-to-Speech capabilities in Mastra, including configuration, usage, and integration with voice providers.
...
- [Reference: Workers](references/reference-workers-overview.md) - API reference for Mastra workers, the background processing units that handle workflow orchestration, cron scheduling, and background task execution.
- [Reference: Dynamic workflow definition](references/reference-workflows-dynamic-workflow-definition.md) - Reference for the JSON definition format used to persist and register dynamic workflows.
...
- [Reference: Workflow.agent()](references/reference-workflows-workflow-methods-agent.md) - Documentation for the `Workflow.agent()` method in workflows, which adds an agent as a declarative step.
...
- [Reference: Workflow.tool()](references/reference-workflows-workflow-methods-tool.md) - Documentation for the `Workflow.tool()` method in workflows, which adds a tool as a declarative step.
