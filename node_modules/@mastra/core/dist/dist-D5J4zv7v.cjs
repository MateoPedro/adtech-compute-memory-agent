...
var openaiCompatibleLanguageModelChatOptions = zod_v4.z.object({
	/**
	...
	*/
	textVerbosity: zod_v4.z.string().optional(),
	/**
...
var openaiCompatibleTokenUsageSchema = zod_v4.z.looseObject({
...
var OpenAICompatibleChatResponseSchema = zod_v4.z.looseObject({
	...
	choices: zod_v4.z.array(zod_v4.z.object({
		message: zod_v4.z.object({
			...
			tool_calls: zod_v4.z.array(zod_v4.z.object({
				...
				extra_content: zod_v4.z.object({ google: zod_v4.z.object({ thought_signature: zod_v4.z.string().nullish() }).nullish() }).nullish()
			})).nullish()
		}),
...
var chunkBaseSchema = zod_v4.z.looseObject({
	id: zod_v4.z.string().nullish(),
	created: zod_v4.z.number().nullish(),
	model: zod_v4.z.string().nullish(),
	choices: zod_v4.z.array(zod_v4.z.object({
...
var createOpenAICompatibleChatChunkSchema = (errorSchema) => zod_v4.z.union([chunkBaseSchema, errorSchema]);
...
var openaiCompatibleLanguageModelCompletionOptions = zod_v4.z.object({
	/**
...
var usageSchema$1 = zod_v4.z.object({
	prompt_tokens: zod_v4.z.number(),
	completion_tokens: zod_v4.z.number(),
	total_tokens: zod_v4.z.number()
});
var openaiCompatibleCompletionResponseSchema = zod_v4.z.object({
	id: zod_v4.z.string().nullish(),
	created: zod_v4.z.number().nullish(),
	model: zod_v4.z.string().nullish(),
	choices: zod_v4.z.array(zod_v4.z.object({
...
var createOpenAICompatibleCompletionChunkSchema = (errorSchema) => zod_v4.z.union([zod_v4.z.object({
	id: zod_v4.z.string().nullish(),
	created: zod_v4.z.number().nullish(),
	model: zod_v4.z.string().nullish(),
	choices: zod_v4.z.array(zod_v4.z.object({
...
var openaiCompatibleEmbeddingModelOptions = zod_v4.z.object({
	/**
...
var openaiTextEmbeddingResponseSchema$1 = zod_v4.z.object({
	...
	providerMetadata: zod_v4.z.record(zod_v4.z.string(), zod_v4.z.record(zod_v4.z.string(), zod_v4.z.any())).optional()
});
...
var openaiCompatibleImageResponseSchema = zod_v4.z.object({ data: zod_v4.z.array(zod_v4.z.object({ b64_json: zod_v4.z.string() })) });
...
var openaiChatResponseSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	id: zod_v4.z.string().nullish(),
	created: zod_v4.z.number().nullish(),
	model: zod_v4.z.string().nullish(),
	choices: zod_v4.z.array(zod_v4.z.object({
...
var openaiChatChunkSchema = lazySchema(() => zodSchema(zod_v4.z.union([zod_v4.z.object({
	id: zod_v4.z.string().nullish(),
	created: zod_v4.z.number().nullish(),
	model: zod_v4.z.string().nullish(),
	choices: zod_v4.z.array(zod_v4.z.object({
...
var openaiLanguageModelChatOptions = lazySchema(() => zodSchema(zod_v4.z.object({
	/**
	* Modify the likelihood of specified tokens appearing in the completion.
	*
	* Accepts a JSON object that maps tokens (specified by their token ID in
	...
	*/
	systemMessageMode: zod_v4.z.enum([
		"system",
		"developer",
		"remove"
	]).optional(),
	...
	*/
	forceReasoning: zod_v4.z.boolean().optional()
})));
...
var openaiCompletionResponseSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	id: zod_v4.z.string().nullish(),
	created: zod_v4.z.number().nullish(),
	model: zod_v4.z.string().nullish(),
	choices: zod_v4.z.array(zod_v4.z.object({
...
var openaiCompletionChunkSchema = lazySchema(() => zodSchema(zod_v4.z.union([zod_v4.z.object({
	id: zod_v4.z.string().nullish(),
	created: zod_v4.z.number().nullish(),
	model: zod_v4.z.string().nullish(),
	choices: zod_v4.z.array(zod_v4.z.object({
...
var openaiLanguageModelCompletionOptions = lazySchema(() => zodSchema(zod_v4.z.object({
	/**
	* Echo back the prompt in addition to the completion.
	*/
	echo: zod_v4.z.boolean().optional(),
...
var openaiEmbeddingModelOptions = lazySchema(() => zodSchema(zod_v4.z.object({
	/**
	* The number of dimensions the resulting output embeddings should have.
	* Only supported in text-embedding-3 and later models.
	*/
...
var openaiTextEmbeddingResponseSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	data: zod_v4.z.array(zod_v4.z.object({ embedding: zod_v4.z.array(zod_v4.z.number()) })),
	usage: zod_v4.z.object({ prompt_tokens: zod_v4.z.number() }).nullish()
})));
...
var openaiImageResponseSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	created: zod_v4.z.number().nullish(),
...
*/
inputFidelity: zod_v4.z.enum(["high", "low"]).optional() })));
...
var applyPatchInputSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	callId: zod_v4.z.string(),
...
var applyPatchOutputSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	status: zod_v4.z.enum(["completed", "failed"]),
...
var customArgsSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	name: zod_v4.z.string(),
	description: zod_v4.z.string().optional(),
	format: zod_v4.z.union([zod_v4.z.object({
		type: zod_v4.z.literal("grammar"),
		syntax: zod_v4.z.enum(["regex", "lark"]),
		definition: zod_v4.z.string()
	}), zod_v4.z.object({ type: zod_v4.z.literal("text") })]).optional()
})));
var customToolFactory = createProviderToolFactory({
	id: "openai.custom",
	inputSchema: lazySchema(() => zodSchema(zod_v4.z.string()))
});
...
var shellInputSchema = lazySchema(() => zodSchema(zod_v4.z.object({ action: zod_v4.z.object({
	commands: zod_v4.z.array(zod_v4.z.string()),
	timeoutMs: zod_v4.z.number().optional(),
	maxOutputLength: zod_v4.z.number().optional()
}) })));
var shellOutputSchema = lazySchema(() => zodSchema(zod_v4.z.object({ output: zod_v4.z.array(zod_v4.z.object({
	stdout: zod_v4.z.string(),
	stderr: zod_v4.z.string(),
	outcome: zod_v4.z.discriminatedUnion("type", [zod_v4.z.object({ type: zod_v4.z.literal("timeout") }), zod_v4.z.object({
		type: zod_v4.z.literal("exit"),
		exitCode: zod_v4.z.number()
	})])
})) })));
var shellSkillsSchema = zod_v4.z.array(zod_v4.z.discriminatedUnion("type", [zod_v4.z.object({
	type: zod_v4.z.literal("skillReference"),
	skillId: zod_v4.z.string(),
	version: zod_v4.z.string().optional()
}), zod_v4.z.object({
	type: zod_v4.z.literal("inline"),
	name: zod_v4.z.string(),
	description: zod_v4.z.string(),
	source: zod_v4.z.object({
		type: zod_v4.z.literal("base64"),
		mediaType: zod_v4.z.literal("application/zip"),
		data: zod_v4.z.string()
	})
})])).optional();
var shellArgsSchema = lazySchema(() => zodSchema(zod_v4.z.object({ environment: zod_v4.z.union([
	zod_v4.z.object({
		type: zod_v4.z.literal("containerAuto"),
		fileIds: zod_v4.z.array(zod_v4.z.string()).optional(),
		memoryLimit: zod_v4.z.enum([
			"1g",
			"4g",
			"16g",
			"64g"
		]).optional(),
		networkPolicy: zod_v4.z.discriminatedUnion("type", [zod_v4.z.object({ type: zod_v4.z.literal("disabled") }), zod_v4.z.object({
			type: zod_v4.z.literal("allowlist"),
			allowedDomains: zod_v4.z.array(zod_v4.z.string()),
			domainSecrets: zod_v4.z.array(zod_v4.z.object({
				domain: zod_v4.z.string(),
				name: zod_v4.z.string(),
	...
	zod_v4.z.object({
		type: zod_v4.z.literal("containerReference"),
		containerId: zod_v4.z.string()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("local").optional(),
...
var toolSearchArgsSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	execution: zod_v4.z.enum(["server", "client"]).optional(),
	description: zod_v4.z.string().optional(),
	parameters: zod_v4.z.record(zod_v4.z.string(), zod_v4.z.unknown()).optional()
})));
var toolSearchInputSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	arguments: zod_v4.z.unknown().optional(),
	call_id: zod_v4.z.string().nullish()
})));
var toolSearchOutputSchema = lazySchema(() => zodSchema(zod_v4.z.object({ tools: zod_v4.z.array(zod_v4.z.record(zod_v4.z.string(), zod_v4.z.unknown())) })));
...
var webSearchArgsSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	...
	filters: zod_v4.z.object({ allowedDomains: zod_v4.z.array(zod_v4.z.string()).optional() }).optional(),
...
var jsonValueSchema = zod_v4.z.lazy(() => zod_v4.z.union([
	...
	zod_v4.z.record(zod_v4.z.string(), jsonValueSchema)
]));
var mcpArgsSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	serverLabel: zod_v4.z.string(),
	allowedTools: zod_v4.z.union([zod_v4.z.array(zod_v4.z.string()), zod_v4.z.object({
		readOnly: zod_v4.z.boolean().optional(),
		toolNames: zod_v4.z.array(zod_v4.z.string()).optional()
	})]).optional(),
	authorization: zod_v4.z.string().optional(),
	connectorId: zod_v4.z.string().optional(),
	headers: zod_v4.z.record(zod_v4.z.string(), zod_v4.z.string()).optional(),
	requireApproval: zod_v4.z.union([zod_v4.z.enum(["always", "never"]), zod_v4.z.object({ never: zod_v4.z.object({ toolNames: zod_v4.z.array(zod_v4.z.string()).optional() }).optional() })]).optional(),
	serverDescription: zod_v4.z.string().optional(),
	serverUrl: zod_v4.z.string().optional()
...
var mcpToolFactory = createProviderToolFactoryWithOutputSchema({
	...
	inputSchema: lazySchema(() => zodSchema(zod_v4.z.object({}))),
	outputSchema: lazySchema(() => zodSchema(zod_v4.z.object({
		type: zod_v4.z.literal("call"),
		serverLabel: zod_v4.z.string(),
		name: zod_v4.z.string(),
		arguments: zod_v4.z.string(),
		output: zod_v4.z.string().nullish(),
		error: zod_v4.z.union([zod_v4.z.string(), jsonValueSchema]).optional()
	})))
});
...
var jsonValueSchema2 = zod_v4.z.lazy(() => zod_v4.z.union([
	zod_v4.z.string(),
	zod_v4.z.number(),
	zod_v4.z.boolean(),
	zod_v4.z.null(),
	zod_v4.z.array(jsonValueSchema2),
	zod_v4.z.record(zod_v4.z.string(), jsonValueSchema2.optional())
]));
var openaiResponsesNestedErrorChunkSchema = zod_v4.z.object({
...
var openaiResponsesErrorChunkSchema = zod_v4.z.object({
	type: zod_v4.z.literal("error"),
	sequence_number: zod_v4.z.number(),
	code: zod_v4.z.string().nullish(),
	message: zod_v4.z.string(),
...
var openaiResponsesChunkSchema = lazySchema(() => zodSchema(zod_v4.z.union([
	zod_v4.z.object({
	...
	zod_v4.z.object({
		...
		item: zod_v4.z.discriminatedUnion("type", [
			...
			zod_v4.z.object({
				...
				name: zod_v4.z.string(),
				arguments: zod_v4.z.string(),
				namespace: zod_v4.z.string().nullish()
			}),
			zod_v4.z.object({
			...
			zod_v4.z.object({
				...
				id: zod_v4.z.string(),
				status: zod_v4.z.string(),
				approval_request_id: zod_v4.z.string().nullish()
			}),
			zod_v4.z.object({
				type: zod_v4.z.literal("mcp_list_tools"),
				id: zod_v4.z.string()
			}),
			zod_v4.z.object({
			...
			zod_v4.z.object({
				type: zod_v4.z.literal("apply_patch_call"),
				id: zod_v4.z.string(),
				call_id: zod_v4.z.string(),
				status: zod_v4.z.enum(["in_progress", "completed"]),
				operation: zod_v4.z.discriminatedUnion("type", [
					zod_v4.z.object({
						type: zod_v4.z.literal("create_file"),
						path: zod_v4.z.string(),
			...
			zod_v4.z.object({
				type: zod_v4.z.literal("shell_call"),
				id: zod_v4.z.string(),
				call_id: zod_v4.z.string(),
				...
				action: zod_v4.z.object({ commands: zod_v4.z.array(zod_v4.z.string()) })
			}),
			zod_v4.z.object({
				type: zod_v4.z.literal("shell_call_output"),
				id: zod_v4.z.string(),
				call_id: zod_v4.z.string(),
				status: zod_v4.z.enum([
					"in_progress",
				...
				output: zod_v4.z.array(zod_v4.z.object({
					stdout: zod_v4.z.string(),
					stderr: zod_v4.z.string(),
					outcome: zod_v4.z.discriminatedUnion("type", [zod_v4.z.object({ type: zod_v4.z.literal("timeout") }), zod_v4.z.object({
						type: zod_v4.z.literal("exit"),
						exit_code: zod_v4.z.number()
					})])
				}))
			}),
			zod_v4.z.object({
				type: zod_v4.z.literal("tool_search_call"),
				id: zod_v4.z.string(),
				execution: zod_v4.z.enum(["server", "client"]),
				call_id: zod_v4.z.string().nullable(),
				status: zod_v4.z.enum([
					"in_progress",
					"completed",
					"incomplete"
				]),
				arguments: zod_v4.z.unknown()
			}),
			zod_v4.z.object({
				type: zod_v4.z.literal("tool_search_output"),
				id: zod_v4.z.string(),
				execution: zod_v4.z.enum(["server", "client"]),
				call_id: zod_v4.z.string().nullable(),
				status: zod_v4.z.enum([
				...
				tools: zod_v4.z.array(zod_v4.z.record(zod_v4.z.string(), jsonValueSchema2.optional()))
			})
		])
	}),
	zod_v4.z.object({
		...
		item: zod_v4.z.discriminatedUnion("type", [
			...
			zod_v4.z.object({
				...
				action: zod_v4.z.discriminatedUnion("type", [
					zod_v4.z.object({
						...
						queries: zod_v4.z.array(zod_v4.z.string()).nullish(),
						sources: zod_v4.z.array(zod_v4.z.discriminatedUnion("type", [zod_v4.z.object({
							type: zod_v4.z.literal("url"),
							url: zod_v4.z.string()
						}), zod_v4.z.object({
			...
			zod_v4.z.object({
				...
				output: zod_v4.z.string().nullish(),
				error: zod_v4.z.union([zod_v4.z.string(), zod_v4.z.object({
					type: zod_v4.z.string().optional(),
					code: zod_v4.z.union([zod_v4.z.number(), zod_v4.z.string()]).optional(),
			...
			zod_v4.z.object({
				...
				id: zod_v4.z.string(),
				server_label: zod_v4.z.string(),
				tools: zod_v4.z.array(zod_v4.z.object({
					name: zod_v4.z.string(),
					description: zod_v4.z.string().optional(),
					input_schema: zod_v4.z.any(),
					annotations: zod_v4.z.record(zod_v4.z.string(), zod_v4.z.unknown()).optional()
				})),
				error: zod_v4.z.union([zod_v4.z.string(), zod_v4.z.object({
					type: zod_v4.z.string().optional(),
					code: zod_v4.z.union([zod_v4.z.number(), zod_v4.z.string()]).optional(),
			...
			zod_v4.z.object({
				...
				name: zod_v4.z.string(),
				arguments: zod_v4.z.string(),
				approval_request_id: zod_v4.z.string().optional()
			}),
			zod_v4.z.object({
				type: zod_v4.z.literal("apply_patch_call"),
				id: zod_v4.z.string(),
	...
	zod_v4.z.object({
		...
		annotation: zod_v4.z.discriminatedUnion("type", [
			zod_v4.z.object({
				type: zod_v4.z.literal("url_citation"),
				start_index: zod_v4.z.number(),
				end_index: zod_v4.z.number(),
	...
	zod_v4.z.object({
		type: zod_v4.z.literal("response.apply_patch_call_operation_diff.delta"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number(),
		delta: zod_v4.z.string(),
		obfuscation: zod_v4.z.string().nullish()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.apply_patch_call_operation_diff.done"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number(),
		diff: zod_v4.z.string()
	}),
...
var openaiResponsesResponseSchema = lazySchema(() => zodSchema(zod_v4.z.object({
...
var openaiLanguageModelResponsesOptionsSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	/**
	...
	*/
	passThroughUnsupportedFiles: zod_v4.z.boolean().optional(),
	/**
	* Whether to use strict JSON schema validation.
	* Defaults to `true`.
	*/
	...
	*/
	allowedTools: zod_v4.z.object({
		toolNames: zod_v4.z.array(zod_v4.z.string()).min(1),
		mode: zod_v4.z.enum(["auto", "required"]).optional()
	}).optional()
})));
...
var openaiSpeechModelOptionsSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	instructions: zod_v4.z.string().nullish(),
...
var openaiTranscriptionResponseSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	text: zod_v4.z.string(),
...
var openAITranscriptionModelOptions = lazySchema(() => zodSchema(zod_v4.z.object({
	/**
...
var anthropicFailedResponseHandler = createJsonErrorResponseHandler({
	errorSchema: lazySchema(() => zodSchema(zod_v4.z.object({
		type: zod_v4.z.literal("error"),
		error: zod_v4.z.object({
			type: zod_v4.z.string(),
			message: zod_v4.z.string()
...
var anthropicMessagesResponseSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	type: zod_v4.z.literal("message"),
	id: zod_v4.z.string().nullish(),
	model: zod_v4.z.string().nullish(),
	...
	usage: zod_v4.z.looseObject({
		input_tokens: zod_v4.z.number(),
		output_tokens: zod_v4.z.number(),
		output_tokens_details: zod_v4.z.object({ thinking_tokens: zod_v4.z.number().nullish() }).nullish(),
...
var anthropicMessagesChunkSchema = lazySchema(() => zodSchema(zod_v4.z.discriminatedUnion("type", [
	zod_v4.z.object({
...
var anthropicReasoningMetadataSchema = lazySchema(() => zodSchema(zod_v4.z.object({
...
var anthropicSystemMessageProviderOptions = zod_v4.z.object({ 
/**
...
*/
toolChanges: zod_v4.z.array(zod_v4.z.discriminatedUnion("type", [zod_v4.z.object({
	type: zod_v4.z.literal("tool_addition"),
	toolName: zod_v4.z.string()
}), zod_v4.z.object({
	type: zod_v4.z.literal("tool_removal"),
	toolName: zod_v4.z.string()
})])).optional() });
var anthropicLanguageModelOptions = zod_v4.z.object({
	...
	*/
userId: zod_v4.z.string().optional() }).optional(),
	/**
	...
	*/
	fallbacks: zod_v4.z.union([zod_v4.z.literal("default"), zod_v4.z.array(zod_v4.z.object({
		model: zod_v4.z.string(),
...
var advisor_20260301ArgsSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	model: zod_v4.z.string(),
...
var advisor_20260301OutputSchema = lazySchema(() => zodSchema(zod_v4.z.discriminatedUnion("type", [
	zod_v4.z.object({
		type: zod_v4.z.literal("advisor_result"),
		text: zod_v4.z.string()
	}),
...
var factory = createProviderToolFactoryWithOutputSchema({
	...
	inputSchema: lazySchema(() => zodSchema(zod_v4.z.object({}).strict())),
...
var textEditor_20250728ArgsSchema = lazySchema(() => zodSchema(zod_v4.z.object({ maxCharacters: zod_v4.z.number().optional() })));
...
var webSearch_20260209ArgsSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	maxUses: zod_v4.z.number().optional(),
...
var webSearch_20260209OutputSchema = lazySchema(() => zodSchema(zod_v4.z.array(zod_v4.z.object({
	url: zod_v4.z.string(),
	title: zod_v4.z.string().nullable(),
...
var factory3 = createProviderToolFactoryWithOutputSchema({
	...
	inputSchema: lazySchema(() => zodSchema(zod_v4.z.object({ query: zod_v4.z.string() }))),
...
var webSearch_20250305ArgsSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	maxUses: zod_v4.z.number().optional(),
	allowedDomains: zod_v4.z.array(zod_v4.z.string()).optional(),
	blockedDomains: zod_v4.z.array(zod_v4.z.string()).optional(),
	userLocation: zod_v4.z.object({
...
var webSearch_20250305OutputSchema = lazySchema(() => zodSchema(zod_v4.z.array(zod_v4.z.object({
	url: zod_v4.z.string(),
	title: zod_v4.z.string().nullable(),
	pageAge: zod_v4.z.string().nullable(),
	encryptedContent: zod_v4.z.string(),
...
var webFetch_20260209ArgsSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	maxUses: zod_v4.z.number().optional(),
	allowedDomains: zod_v4.z.array(zod_v4.z.string()).optional(),
	blockedDomains: zod_v4.z.array(zod_v4.z.string()).optional(),
	citations: zod_v4.z.object({ enabled: zod_v4.z.boolean() }).optional(),
...
var webFetch_20260209OutputSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	type: zod_v4.z.literal("web_fetch_result"),
	url: zod_v4.z.string(),
	content: zod_v4.z.object({
		type: zod_v4.z.literal("document"),
...
var factory5 = createProviderToolFactoryWithOutputSchema({
	...
	inputSchema: lazySchema(() => zodSchema(zod_v4.z.object({ url: zod_v4.z.string() }))),
...
var webFetch_20250910ArgsSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	maxUses: zod_v4.z.number().optional(),
	allowedDomains: zod_v4.z.array(zod_v4.z.string()).optional(),
	blockedDomains: zod_v4.z.array(zod_v4.z.string()).optional(),
	citations: zod_v4.z.object({ enabled: zod_v4.z.boolean() }).optional(),
...
var webFetch_20250910OutputSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	type: zod_v4.z.literal("web_fetch_result"),
	url: zod_v4.z.string(),
	content: zod_v4.z.object({
		type: zod_v4.z.literal("document"),
...
var codeExecution_20250522OutputSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	type: zod_v4.z.literal("code_execution_result"),
	stdout: zod_v4.z.string(),
	stderr: zod_v4.z.string(),
	return_code: zod_v4.z.number(),
...
var factory7 = createProviderToolFactoryWithOutputSchema({
	...
	inputSchema: lazySchema(() => zodSchema(zod_v4.z.object({ code: zod_v4.z.string() }))),
	outputSchema: codeExecution_20250522OutputSchema
});
var codeExecution_20250522 = (args = {}) => {
	return factory7(args);
};
var codeExecution_20250825OutputSchema = lazySchema(() => zodSchema(zod_v4.z.discriminatedUnion("type", [
	zod_v4.z.object({
		type: zod_v4.z.literal("code_execution_result"),
		stdout: zod_v4.z.string(),
		stderr: zod_v4.z.string(),
...
var factory8 = createProviderToolFactoryWithOutputSchema({
	...
	inputSchema: lazySchema(() => zodSchema(zod_v4.z.discriminatedUnion("type", [
		zod_v4.z.object({
...
var codeExecution_20260120OutputSchema = lazySchema(() => zodSchema(zod_v4.z.discriminatedUnion("type", [
	zod_v4.z.object({
		type: zod_v4.z.literal("code_execution_result"),
		stdout: zod_v4.z.string(),
		stderr: zod_v4.z.string(),
...
var toolSearchRegex_20251119OutputSchema = lazySchema(() => zodSchema(zod_v4.z.array(zod_v4.z.object({
	type: zod_v4.z.literal("tool_reference"),
	toolName: zod_v4.z.string()
}))));
...
var memory_20250818 = createProviderToolFactory({
	...
	inputSchema: lazySchema(() => zodSchema(zod_v4.z.discriminatedUnion("command", [
		zod_v4.z.object({
			command: zod_v4.z.literal("view"),
			path: zod_v4.z.string(),
...
var toolSearchBm25_20251119OutputSchema = lazySchema(() => zodSchema(zod_v4.z.array(zod_v4.z.object({
	type: zod_v4.z.literal("tool_reference"),
	toolName: zod_v4.z.string()
}))));
...
const MASTRA_USER_AGENT = `mastra/1.60.0`;
...
var googleFailedResponseHandler = createJsonErrorResponseHandler({
	errorSchema: lazySchema(() => zodSchema(zod_v4.z.object({ error: zod_v4.z.object({
		code: zod_v4.z.number().nullable(),
		message: zod_v4.z.string(),
		status: zod_v4.z.string()
	}) }))),
	errorToMessage: (data) => data.error.message
});
var googleEmbeddingContentPartSchema = zod_v4.z.union([
	zod_v4.z.object({ text: zod_v4.z.string() }),
	zod_v4.z.object({ inlineData: zod_v4.z.object({
		mimeType: zod_v4.z.string(),
		data: zod_v4.z.string()
	}) }),
	zod_v4.z.object({ fileData: zod_v4.z.object({
		fileUri: zod_v4.z.string(),
		mimeType: zod_v4.z.string()
	}) })
]);
var googleEmbeddingModelOptions = lazySchema(() => zodSchema(zod_v4.z.object({
	/**
	* Optional. Optional reduced dimension for the output embedding.
	* If set, excessive values in the output embedding are truncated from the end.
	*/
	outputDimensionality: zod_v4.z.number().optional(),
	/**
	...
	*/
	content: zod_v4.z.array(zod_v4.z.array(googleEmbeddingContentPartSchema).min(1).nullable()).optional()
})));
...
var googleGenerativeAITextEmbeddingResponseSchema = lazySchema(() => zodSchema(zod_v4.z.object({ embeddings: zod_v4.z.array(zod_v4.z.object({ values: zod_v4.z.array(zod_v4.z.number()) })) })));
var googleGenerativeAISingleEmbeddingResponseSchema = lazySchema(() => zodSchema(zod_v4.z.object({ embedding: zod_v4.z.object({ values: zod_v4.z.array(zod_v4.z.number()) }) })));
...
var googleLanguageModelOptions = lazySchema(() => zodSchema(zod_v4.z.object({
	responseModalities: zod_v4.z.array(zod_v4.z.enum(["TEXT", "IMAGE"])).optional(),
	thinkingConfig: zod_v4.z.object({
		thinkingBudget: zod_v4.z.number().optional(),
		includeThoughts: zod_v4.z.boolean().optional(),
		thinkingLevel: zod_v4.z.enum([
			"minimal",
			"low",
			"medium",
			"high"
	...
	*/
	cachedContent: zod_v4.z.string().optional(),
	/**
	...
	*/
	safetySettings: zod_v4.z.array(zod_v4.z.object({
		category: zod_v4.z.enum([
	...
	*/
	audioTimestamp: zod_v4.z.boolean().optional(),
	/**
	* Optional. Defines labels used in billing reports. Available on Vertex AI only.
	*
	* https://cloud.google.com/vertex-ai/generative-ai/docs/multimodal/add-labels-to-api-calls
	*/
	labels: zod_v4.z.record(zod_v4.z.string(), zod_v4.z.string()).optional(),
	/**
	* Optional. If specified, the media resolution specified will be used.
	*
	* https://ai.google.dev/api/generate-content#MediaResolution
	*/
	mediaResolution: zod_v4.z.enum([
	...
	*/
	imageConfig: zod_v4.z.object({
		aspectRatio: zod_v4.z.enum([
			"1:1",
			"2:3",
			"3:2",
			"3:4",
		...
		* Vertex AI only.
		*/
		personGeneration: zod_v4.z.enum([
		...
		* Vertex AI only.
		*/
		imageOutputOptions: zod_v4.z.object({
			mimeType: zod_v4.z.enum(["image/jpeg", "image/png"]).optional(),
			compressionQuality: zod_v4.z.number().optional()
		}).optional()
	}).optional(),
	/**
	...
	*/
	retrievalConfig: zod_v4.z.object({ latLng: zod_v4.z.object({
		latitude: zod_v4.z.number(),
		longitude: zod_v4.z.number()
	}).optional() }).optional(),
	/**
	...
	*/
	streamFunctionCallArguments: zod_v4.z.boolean().optional(),
	/**
	...
	*/
	sharedRequestType: zod_v4.z.enum([
		"priority",
		"flex",
		"standard"
	]).optional(),
	...
	* https://docs.cloud.google.com/vertex-ai/generative-ai/docs/priority-paygo
	*/
	requestType: zod_v4.z.enum(["shared"]).optional()
})));
...
var getGroundingMetadataSchema = () => zod_v4.z.object({
	webSearchQueries: zod_v4.z.array(zod_v4.z.string()).nullish(),
	imageSearchQueries: zod_v4.z.array(zod_v4.z.string()).nullish(),
	retrievalQueries: zod_v4.z.array(zod_v4.z.string()).nullish(),
	searchEntryPoint: zod_v4.z.object({ renderedContent: zod_v4.z.string() }).nullish(),
	groundingChunks: zod_v4.z.array(zod_v4.z.object({
		web: zod_v4.z.object({
			uri: zod_v4.z.string(),
			title: zod_v4.z.string().nullish()
		}).nullish(),
		image: zod_v4.z.object({
			sourceUri: zod_v4.z.string(),
			imageUri: zod_v4.z.string(),
			title: zod_v4.z.string().nullish(),
			domain: zod_v4.z.string().nullish()
		}).nullish(),
		retrievedContext: zod_v4.z.object({
			uri: zod_v4.z.string().nullish(),
			title: zod_v4.z.string().nullish(),
			text: zod_v4.z.string().nullish(),
			fileSearchStore: zod_v4.z.string().nullish()
		}).nullish(),
		maps: zod_v4.z.object({
			uri: zod_v4.z.string().nullish(),
			title: zod_v4.z.string().nullish(),
			text: zod_v4.z.string().nullish(),
			placeId: zod_v4.z.string().nullish()
		}).nullish()
	})).nullish(),
	groundingSupports: zod_v4.z.array(zod_v4.z.object({
		segment: zod_v4.z.object({
			startIndex: zod_v4.z.number().nullish(),
			endIndex: zod_v4.z.number().nullish(),
			text: zod_v4.z.string().nullish()
		}).nullish(),
		segment_text: zod_v4.z.string().nullish(),
		groundingChunkIndices: zod_v4.z.array(zod_v4.z.number()).nullish(),
		supportChunkIndices: zod_v4.z.array(zod_v4.z.number()).nullish(),
		confidenceScores: zod_v4.z.array(zod_v4.z.number()).nullish(),
		confidenceScore: zod_v4.z.array(zod_v4.z.number()).nullish()
	})).nullish(),
	retrievalMetadata: zod_v4.z.union([zod_v4.z.object({ webDynamicRetrievalScore: zod_v4.z.number() }), zod_v4.z.object({})]).nullish()
});
var partialArgSchema = zod_v4.z.object({
	jsonPath: zod_v4.z.string(),
	stringValue: zod_v4.z.string().nullish(),
	numberValue: zod_v4.z.number().nullish(),
	boolValue: zod_v4.z.boolean().nullish(),
	nullValue: zod_v4.z.unknown().nullish(),
	willContinue: zod_v4.z.boolean().nullish()
});
var getContentSchema = () => zod_v4.z.object({ parts: zod_v4.z.array(zod_v4.z.union([
	zod_v4.z.object({
		functionCall: zod_v4.z.object({
			id: zod_v4.z.string().nullish(),
			name: zod_v4.z.string().nullish(),
			args: zod_v4.z.unknown().nullish(),
			partialArgs: zod_v4.z.array(partialArgSchema).nullish(),
			willContinue: zod_v4.z.boolean().nullish()
		}),
		thoughtSignature: zod_v4.z.string().nullish()
	}),
	zod_v4.z.object({
		inlineData: zod_v4.z.object({
			mimeType: zod_v4.z.string(),
			data: zod_v4.z.string()
		}),
		thought: zod_v4.z.boolean().nullish(),
		thoughtSignature: zod_v4.z.string().nullish()
	}),
	zod_v4.z.object({
		toolCall: zod_v4.z.object({
			toolType: zod_v4.z.string(),
			args: zod_v4.z.unknown().nullish(),
			id: zod_v4.z.string()
		}),
		thoughtSignature: zod_v4.z.string().nullish()
	...
	zod_v4.z.object({
		toolResponse: zod_v4.z.object({
			toolType: zod_v4.z.string(),
			response: zod_v4.z.unknown().nullish(),
			id: zod_v4.z.string()
		}),
		thoughtSignature: zod_v4.z.string().nullish()
	}),
	zod_v4.z.object({
		executableCode: zod_v4.z.object({
			language: zod_v4.z.string(),
			code: zod_v4.z.string()
		}).nullish(),
		codeExecutionResult: zod_v4.z.object({
			outcome: zod_v4.z.string(),
			output: zod_v4.z.string().nullish()
		}).nullish(),
		text: zod_v4.z.string().nullish(),
		thought: zod_v4.z.boolean().nullish(),
...
var getSafetyRatingSchema = () => zod_v4.z.object({
	category: zod_v4.z.string().nullish(),
	probability: zod_v4.z.string().nullish(),
	probabilityScore: zod_v4.z.number().nullish(),
	severity: zod_v4.z.string().nullish(),
	severityScore: zod_v4.z.number().nullish(),
	blocked: zod_v4.z.boolean().nullish()
});
var tokenDetailsSchema = zod_v4.z.array(zod_v4.z.object({
	modality: zod_v4.z.string(),
	tokenCount: zod_v4.z.number()
})).nullish();
var usageSchema = zod_v4.z.object({
	cachedContentTokenCount: zod_v4.z.number().nullish(),
	thoughtsTokenCount: zod_v4.z.number().nullish(),
	promptTokenCount: zod_v4.z.number().nullish(),
	candidatesTokenCount: zod_v4.z.number().nullish(),
	totalTokenCount: zod_v4.z.number().nullish(),
	trafficType: zod_v4.z.string().nullish(),
	serviceTier: zod_v4.z.string().nullish(),
	promptTokensDetails: tokenDetailsSchema,
	candidatesTokensDetails: tokenDetailsSchema
});
var getUrlContextMetadataSchema = () => zod_v4.z.object({ urlMetadata: zod_v4.z.array(zod_v4.z.object({
	retrievedUrl: zod_v4.z.string(),
	urlRetrievalStatus: zod_v4.z.string()
})).nullish() });
var responseSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	responseId: zod_v4.z.string().nullish(),
	candidates: zod_v4.z.array(zod_v4.z.object({
		content: getContentSchema().nullish().or(zod_v4.z.object({}).strict()),
		finishReason: zod_v4.z.string().nullish(),
		finishMessage: zod_v4.z.string().nullish(),
		safetyRatings: zod_v4.z.array(getSafetyRatingSchema()).nullish(),
		groundingMetadata: getGroundingMetadataSchema().nullish(),
		urlContextMetadata: getUrlContextMetadataSchema().nullish()
	})),
	usageMetadata: usageSchema.nullish(),
	promptFeedback: zod_v4.z.object({
		blockReason: zod_v4.z.string().nullish(),
		safetyRatings: zod_v4.z.array(getSafetyRatingSchema()).nullish()
	}).nullish()
})));
var chunkSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	responseId: zod_v4.z.string().nullish(),
	candidates: zod_v4.z.array(zod_v4.z.object({
...
var codeExecution = createProviderToolFactoryWithOutputSchema({
	...
	inputSchema: zod_v4.z.object({
		language: zod_v4.z.string().describe("The programming language of the code."),
		code: zod_v4.z.string().describe("The code to be executed.")
	}),
	outputSchema: zod_v4.z.object({
		outcome: zod_v4.z.string().describe("The outcome of the execution (e.g., \"OUTCOME_OK\")."),
		output: zod_v4.z.string().describe("The output from the code execution.")
	})
});
...
var fileSearchArgsBaseSchema = zod_v4.z.object({
	/** The names of the file_search_stores to retrieve from.
	*  Example: `fileSearchStores/my-file-search-store-123`
	*/
	fileSearchStoreNames: zod_v4.z.array(zod_v4.z.string()).describe("The names of the file_search_stores to retrieve from. Example: `fileSearchStores/my-file-search-store-123`"),
	/** The number of file search retrieval chunks to retrieve. */
	topK: zod_v4.z.number().int().positive().describe("The number of file search retrieval chunks to retrieve.").optional(),
	/** Metadata filter to apply to the file search retrieval documents.
	*  See https://google.aip.dev/160 for the syntax of the filter expression.
	*/
	metadataFilter: zod_v4.z.string().describe("Metadata filter to apply to the file search retrieval documents. See https://google.aip.dev/160 for the syntax of the filter expression.").optional()
}).passthrough();
...
var googleSearchToolArgsBaseSchema = zod_v4.z.object({
	searchTypes: zod_v4.z.object({
		webSearch: zod_v4.z.object({}).optional(),
		imageSearch: zod_v4.z.object({}).optional()
	}).optional(),
	timeRangeFilter: zod_v4.z.object({
		startTime: zod_v4.z.string(),
		endTime: zod_v4.z.string()
	}).optional()
}).passthrough();
var googleTools = {
	/**
...
var googleImageResponseSchema = lazySchema(() => zodSchema(zod_v4.z.object({ predictions: zod_v4.z.array(zod_v4.z.object({ bytesBase64Encoded: zod_v4.z.string() })).default([]) })));
var googleImageModelOptionsSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	personGeneration: zod_v4.z.enum([
		"dont_allow",
		"allow_adult",
		"allow_all"
...
var googleOperationSchema = zod_v4.z.object({
	name: zod_v4.z.string().nullish(),
	done: zod_v4.z.boolean().nullish(),
	error: zod_v4.z.object({
		code: zod_v4.z.number().nullish(),
		message: zod_v4.z.string(),
		status: zod_v4.z.string().nullish()
	}).nullish(),
	response: zod_v4.z.object({ generateVideoResponse: zod_v4.z.object({ generatedSamples: zod_v4.z.array(zod_v4.z.object({ video: zod_v4.z.object({ uri: zod_v4.z.string().nullish() }).nullish() })).nullish() }).nullish() }).nullish()
});
var googleVideoModelOptionsSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	...
	referenceImages: zod_v4.z.array(zod_v4.z.object({
		bytesBase64Encoded: zod_v4.z.string().nullish(),
		gcsUri: zod_v4.z.string().nullish()
	})).nullish()
}).passthrough()));
...
var tokenByModalitySchema = () => zod_v4.z.object({
	modality: zod_v4.z.string().nullish(),
	tokens: zod_v4.z.number().nullish()
}).loose();
var usageSchema2 = () => zod_v4.z.object({
	total_input_tokens: zod_v4.z.number().nullish(),
	total_output_tokens: zod_v4.z.number().nullish(),
	total_thought_tokens: zod_v4.z.number().nullish(),
	total_cached_tokens: zod_v4.z.number().nullish(),
	total_tool_use_tokens: zod_v4.z.number().nullish(),
	total_tokens: zod_v4.z.number().nullish(),
	input_tokens_by_modality: zod_v4.z.array(tokenByModalitySchema()).nullish(),
	output_tokens_by_modality: zod_v4.z.array(tokenByModalitySchema()).nullish(),
	cached_tokens_by_modality: zod_v4.z.array(tokenByModalitySchema()).nullish(),
	tool_use_tokens_by_modality: zod_v4.z.array(tokenByModalitySchema()).nullish(),
	grounding_tool_count: zod_v4.z.array(zod_v4.z.object({
		type: zod_v4.z.string().nullish(),
		count: zod_v4.z.number().nullish()
	}).loose()).nullish()
}).loose();
var interactionStatusSchema = () => zod_v4.z.enum([
	"in_progress",
	"requires_action",
	"completed",
	"failed",
...
var annotationSchema = () => {
	const urlCitation = zod_v4.z.object({
		type: zod_v4.z.literal("url_citation"),
		url: zod_v4.z.string().nullish(),
		title: zod_v4.z.string().nullish(),
	...
	const fileCitation = zod_v4.z.object({
		type: zod_v4.z.literal("file_citation"),
		file_name: zod_v4.z.string().nullish(),
		document_uri: zod_v4.z.string().nullish(),
		url: zod_v4.z.string().nullish(),
		page_number: zod_v4.z.number().nullish(),
		media_id: zod_v4.z.string().nullish(),
		start_index: zod_v4.z.number().nullish(),
		end_index: zod_v4.z.number().nullish(),
		custom_metadata: zod_v4.z.record(zod_v4.z.string(), zod_v4.z.unknown()).nullish()
	}).loose();
	const placeCitation = zod_v4.z.object({
		type: zod_v4.z.literal("place_citation"),
		name: zod_v4.z.string().nullish(),
		url: zod_v4.z.string().nullish(),
		place_id: zod_v4.z.string().nullish(),
		start_index: zod_v4.z.number().nullish(),
		end_index: zod_v4.z.number().nullish()
	}).loose();
	return zod_v4.z.union([
		urlCitation,
		fileCitation,
		placeCitation,
		zod_v4.z.object({ type: zod_v4.z.string() }).loose()
	]);
};
var thoughtSummaryItemSchema = () => zod_v4.z.object({
	type: zod_v4.z.string(),
	text: zod_v4.z.string().nullish(),
	data: zod_v4.z.string().nullish(),
	mime_type: zod_v4.z.string().nullish()
}).loose();
var contentBlockSchema = () => {
	const textContent = zod_v4.z.object({
		type: zod_v4.z.literal("text"),
		text: zod_v4.z.string(),
		annotations: zod_v4.z.array(annotationSchema()).nullish()
	}).loose();
	const imageContent = zod_v4.z.object({
		type: zod_v4.z.literal("image"),
		data: zod_v4.z.string().nullish(),
		mime_type: zod_v4.z.string().nullish(),
		resolution: zod_v4.z.enum([
			"low",
			"medium",
			"high",
			"ultra_high"
	...
	const videoContent = zod_v4.z.object({
...
var stepSchema = () => {
	const userInputStep = zod_v4.z.object({
		type: zod_v4.z.literal("user_input"),
		content: zod_v4.z.array(contentBlockSchema()).nullish()
	}).loose();
	const modelOutputStep = zod_v4.z.object({
		type: zod_v4.z.literal("model_output"),
		content: zod_v4.z.array(contentBlockSchema()).nullish()
	}).loose();
	const functionCallStep = zod_v4.z.object({
		type: zod_v4.z.literal("function_call"),
		id: zod_v4.z.string(),
		name: zod_v4.z.string(),
		arguments: zod_v4.z.record(zod_v4.z.string(), zod_v4.z.unknown()).nullish(),
		signature: zod_v4.z.string().nullish()
	}).loose();
	const thoughtStep = zod_v4.z.object({
		type: zod_v4.z.literal("thought"),
		signature: zod_v4.z.string().nullish(),
		summary: zod_v4.z.array(thoughtSummaryItemSchema()).nullish()
	}).loose();
	const builtinToolCallStep = zod_v4.z.object({
		type: zod_v4.z.enum(BUILTIN_TOOL_CALL_STEP_TYPES),
		id: zod_v4.z.string(),
		arguments: zod_v4.z.record(zod_v4.z.string(), zod_v4.z.unknown()).nullish(),
		name: zod_v4.z.string().nullish(),
		server_name: zod_v4.z.string().nullish(),
		search_type: zod_v4.z.string().nullish(),
		signature: zod_v4.z.string().nullish()
	}).loose();
	const builtinToolResultStep = zod_v4.z.object({
		type: zod_v4.z.enum(BUILTIN_TOOL_RESULT_STEP_TYPES),
		call_id: zod_v4.z.string(),
		result: zod_v4.z.unknown().nullish(),
		is_error: zod_v4.z.boolean().nullish(),
		name: zod_v4.z.string().nullish(),
		server_name: zod_v4.z.string().nullish(),
		signature: zod_v4.z.string().nullish()
	}).loose();
...
var googleInteractionsResponseSchema = lazySchema(() => zodSchema(zod_v4.z.object({
	id: zod_v4.z.string().nullish(),
	created: zod_v4.z.string().nullish(),
	updated: zod_v4.z.string().nullish(),
	status: interactionStatusSchema(),
	model: zod_v4.z.string().nullish(),
	agent: zod_v4.z.string().nullish(),
	steps: zod_v4.z.array(stepSchema()).nullish(),
	usage: usageSchema2().nullish(),
	service_tier: zod_v4.z.string().nullish(),
	previous_interaction_id: zod_v4.z.string().nullish(),
	response_modalities: zod_v4.z.array(zod_v4.z.string()).nullish()
}).loose()));
var googleInteractionsEventSchema = lazySchema(() => zodSchema((() => {
	...
	const interactionCreatedEvent = zod_v4.z.object({
		event_type: zod_v4.z.literal("interaction.created"),
		event_id: zod_v4.z.string().nullish(),
		interaction: zod_v4.z.object({
			id: zod_v4.z.string().nullish(),
			created: zod_v4.z.string().nullish(),
			model: zod_v4.z.string().nullish(),
			agent: zod_v4.z.string().nullish(),
	...
	const stepStartEvent = zod_v4.z.object({
		event_type: zod_v4.z.literal("step.start"),
		event_id: zod_v4.z.string().nullish(),
		index: zod_v4.z.number(),
		step: stepSchema()
	}).loose();
	const stepDeltaText = zod_v4.z.object({
		type: zod_v4.z.literal("text"),
		text: zod_v4.z.string()
	}).loose();
	const stepDeltaThoughtSummary = zod_v4.z.object({
		type: zod_v4.z.literal("thought_summary"),
		content: thoughtSummaryItem.nullish()
	}).loose();
	const stepDeltaThoughtSignature = zod_v4.z.object({
		type: zod_v4.z.literal("thought_signature"),
		signature: zod_v4.z.string().nullish()
	}).loose();
	const stepDeltaArgumentsDelta = zod_v4.z.object({
		type: zod_v4.z.literal("arguments_delta"),
		arguments: zod_v4.z.string().nullish(),
		id: zod_v4.z.string().nullish(),
		signature: zod_v4.z.string().nullish()
	}).loose();
	const stepDeltaTextAnnotation = zod_v4.z.object({
		type: zod_v4.z.enum(["text_annotation_delta", "text_annotation"]),
		annotations: zod_v4.z.array(annotation).nullish()
	}).loose();
	const stepDeltaImage = zod_v4.z.object({
		type: zod_v4.z.literal("image"),
		data: zod_v4.z.string().nullish(),
		mime_type: zod_v4.z.string().nullish(),
		resolution: zod_v4.z.enum([
	...
	const stepDeltaVideo = zod_v4.z.object({
		type: zod_v4.z.literal("video"),
		data: zod_v4.z.string().nullish(),
		mime_type: zod_v4.z.string().nullish(),
		uri: zod_v4.z.string().nullish()
	}).loose();
	const stepDeltaBuiltinToolCall = zod_v4.z.object({
		type: zod_v4.z.enum(BUILTIN_TOOL_CALL_STEP_TYPES),
		id: zod_v4.z.string().nullish(),
		arguments: zod_v4.z.record(zod_v4.z.string(), zod_v4.z.unknown()).nullish(),
		name: zod_v4.z.string().nullish(),
	...
	const stepDeltaBuiltinToolResult = zod_v4.z.object({
		type: zod_v4.z.enum(BUILTIN_TOOL_RESULT_STEP_TYPES),
		call_id: zod_v4.z.string().nullish(),
		result: zod_v4.z.unknown().nullish(),
		is_error: zod_v4.z.boolean().nullish(),
	...
	const stepDeltaUnknown = zod_v4.z.object({ type: zod_v4.z.string() }).loose();
	const stepDeltaUnion = zod_v4.z.union([
		stepDeltaText,
		stepDeltaImage,
		stepDeltaVideo,
	...
	const stepDeltaEvent = zod_v4.z.object({
		event_type: zod_v4.z.literal("step.delta"),
		event_id: zod_v4.z.string().nullish(),
		index: zod_v4.z.number(),
		delta: stepDeltaUnion
	}).loose();
	const stepStopEvent = zod_v4.z.object({
		event_type: zod_v4.z.literal("step.stop"),
		event_id: zod_v4.z.string().nullish(),
		index: zod_v4.z.number()
	}).loose();
	const interactionStatusUpdateEvent = zod_v4.z.object({
		event_type: zod_v4.z.literal("interaction.status_update"),
		event_id: zod_v4.z.string().nullish(),
		interaction_id: zod_v4.z.string().nullish(),
		status: status.nullish()
	}).loose();
	const interactionInProgressEvent = zod_v4.z.object({
		event_type: zod_v4.z.literal("interaction.in_progress"),
		event_id: zod_v4.z.string().nullish(),
		interaction_id: zod_v4.z.string().nullish(),
		status: status.nullish()
	}).loose();
	const interactionRequiresActionEvent = zod_v4.z.object({
		event_type: zod_v4.z.literal("interaction.requires_action"),
		event_id: zod_v4.z.string().nullish(),
		interaction_id: zod_v4.z.string().nullish(),
		status: status.nullish()
	}).loose();
	const interactionCompletedEvent = zod_v4.z.object({
		event_type: zod_v4.z.literal("interaction.completed"),
		event_id: zod_v4.z.string().nullish(),
		interaction: zod_v4.z.object({
			id: zod_v4.z.string().nullish(),
			status: status.nullish(),
	...
	const errorEvent = zod_v4.z.object({
		event_type: zod_v4.z.literal("error"),
		event_id: zod_v4.z.string().nullish(),
		error: zod_v4.z.object({
			code: zod_v4.z.string().nullish(),
	...
	const unknownEvent = zod_v4.z.object({ event_type: zod_v4.z.string() }).loose();
	return zod_v4.z.union([
...
var googleInteractionsLanguageModelOptions = lazySchema(() => zodSchema(zod_v4.z.object({
	previousInteractionId: zod_v4.z.string().nullish(),
	store: zod_v4.z.boolean().nullish(),
	agent: zod_v4.z.string().nullish(),
	agentConfig: zod_v4.z.union([zod_v4.z.object({ type: zod_v4.z.literal("dynamic") }).loose(), zod_v4.z.object({
		type: zod_v4.z.literal("deep-research"),
		thinkingSummaries: zod_v4.z.enum(["auto", "none"]).nullish(),
		visualization: zod_v4.z.enum(["off", "auto"]).nullish(),
		collaborativePlanning: zod_v4.z.boolean().nullish()
	})]).nullish(),
	thinkingLevel: zod_v4.z.enum([
		"minimal",
		"low",
	...
	*/
	responseFormat: zod_v4.z.array(zod_v4.z.union([
		zod_v4.z.object({
			type: zod_v4.z.literal("text"),
			mimeType: zod_v4.z.string().nullish(),
			schema: zod_v4.z.unknown().nullish()
		}).loose(),
		zod_v4.z.object({
			type: zod_v4.z.literal("image"),
			mimeType: zod_v4.z.string().nullish(),
	...
	*/
	...
	responseModalities: zod_v4.z.array(zod_v4.z.enum([
		"text",
		"image",
		"audio",
		"video",
	...
	*/
	systemInstruction: zod_v4.z.string().nullish(),
	/**
	...
	* `previousInteractionId`.
	*/
	interactionId: zod_v4.z.string().nullish(),
	/**
	...
	*/
	pollingTimeoutMs: zod_v4.z.number().int().positive().nullish(),
	/**
	...
	* requires.
	*/
	background: zod_v4.z.boolean().nullish(),
	/**
	...
	*/
	environment: zod_v4.z.union([zod_v4.z.string(), zod_v4.z.object({
		type: zod_v4.z.literal("remote"),
		sources: zod_v4.z.array(zod_v4.z.union([
			zod_v4.z.object({
				type: zod_v4.z.literal("gcs"),
				source: zod_v4.z.string(),
				target: zod_v4.z.string().nullish()
			}),
			zod_v4.z.object({
				type: zod_v4.z.literal("repository"),
				source: zod_v4.z.string(),
				target: zod_v4.z.string().nullish()
			}),
			zod_v4.z.object({
				type: zod_v4.z.literal("inline"),
				content: zod_v4.z.string(),
				target: zod_v4.z.string()
			})
		])).nullish(),
		network: zod_v4.z.union([zod_v4.z.literal("disabled"), zod_v4.z.object({ allowlist: zod_v4.z.array(zod_v4.z.object({
			domain: zod_v4.z.string(),
			transform: zod_v4.z.array(zod_v4.z.record(zod_v4.z.string(), zod_v4.z.string())).nullish()
		})) })]).nullish()
	})]).nullish()
})));
...
Object.defineProperty(exports, "EXCLUDED_PROVIDERS", {
	enumerable: true,
	get: function() {
		return EXCLUDED_PROVIDERS;
	}
});
Object.defineProperty(exports, "EventSourceParserStream", {
	enumerable: true,
	get: function() {
...
Object.defineProperty(exports, "MASTRA_GATEWAY_STREAM_TRANSPORT", {
	enumerable: true,
	get: function() {
		return MASTRA_GATEWAY_STREAM_TRANSPORT;
	}
});
Object.defineProperty(exports, "MASTRA_USER_AGENT", {
	enumerable: true,
	get: function() {
		return MASTRA_USER_AGENT;
	}
});
Object.defineProperty(exports, "MastraModelGateway", {
	enumerable: true,
	get: function() {
		return MastraModelGateway;
	}
});
...
Object.defineProperty(exports, "OpenAICompatibleChatLanguageModel", {
	enumerable: true,
	get: function() {
		return OpenAICompatibleChatLanguageModel;
	}
});
Object.defineProperty(exports, "OpenAICompatibleCompletionLanguageModel", {
	enumerable: true,
	get: function() {
		return OpenAICompatibleCompletionLanguageModel;
	}
});
Object.defineProperty(exports, "OpenAICompatibleEmbeddingModel", {
	enumerable: true,
	get: function() {
		return OpenAICompatibleEmbeddingModel;
	}
});
Object.defineProperty(exports, "PROVIDERS_WITH_INSTALLED_PACKAGES", {
	enumerable: true,
	get: function() {
		return PROVIDERS_WITH_INSTALLED_PACKAGES;
	}
});
...
Object.defineProperty(exports, "cancelResponseBody", {
	enumerable: true,
	get: function() {
...
Object.defineProperty(exports, "convertImageModelFileToDataUri", {
	enumerable: true,
	get: function() {
		return convertImageModelFileToDataUri;
	}
});
...
Object.defineProperty(exports, "convertUint8ArrayToBase64", {
	enumerable: true,
	get: function() {
...
Object.defineProperty(exports, "createGoogleGenerativeAI", {
	enumerable: true,
	get: function() {
...
Object.defineProperty(exports, "createOpenAICompatible", {
	enumerable: true,
	get: function() {
...
Object.defineProperty(exports, "createStatusCodeErrorResponseHandler", {
	enumerable: true,
	get: function() {
		return createStatusCodeErrorResponseHandler;
	}
});
...
Object.defineProperty(exports, "extractResponseHeaders", {
	enumerable: true,
	get: function() {
		return extractResponseHeaders;
	}
});
...
Object.defineProperty(exports, "getFromApi", {
	enumerable: true,
	get: function() {
		return getFromApi;
	}
});
Object.defineProperty(exports, "injectJsonInstructionIntoMessages", {
	enumerable: true,
	get: function() {
		return injectJsonInstructionIntoMessages;
	}
});
...
Object.defineProperty(exports, "postToApi", {
	enumerable: true,
	get: function() {
		return postToApi;
	}
...
//# sourceMappingURL=dist-D5J4zv7v.cjs.map