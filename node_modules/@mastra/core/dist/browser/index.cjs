...
*/
const DEFAULT_BROWSER_VIEWPORT = {
	width: 1280,
	height: 720
};
/**
...
*/
function resolveViewportSize(viewport) {
	return viewport === "window" ? void 0 : viewport;
}
/**
...
*/
function resolveLaunchViewport(viewport) {
...
exports.resolveLaunchViewport = resolveLaunchViewport;
