...
const require_dist = require("./dist-D5J4zv7v.cjs");
...
function parseArrayDef(def, refs) {
	...
	if (((_a22 = def.type) == null ? void 0 : _a22._def) && ((_c = (_b22 = def.type) == null ? void 0 : _b22._def) == null ? void 0 : _c.typeName) !== zod_v3.ZodFirstPartyTypeKind.ZodAny) res.items = parseDef(def.type._def, __spreadProps(__spreadValues({}, refs), { currentPath: [...refs.currentPath, "items"] }));
...
function parseRecordDef(def, refs) {
	...
	if (((_b22 = def.keyType) == null ? void 0 : _b22._def.typeName) === zod_v3.ZodFirstPartyTypeKind.ZodString && ((_c = def.keyType._def.checks) == null ? void 0 : _c.length)) {
	...
	} else if (((_d = def.keyType) == null ? void 0 : _d._def.typeName) === zod_v3.ZodFirstPartyTypeKind.ZodEnum) return __spreadProps(__spreadValues({}, schema), { propertyNames: { enum: def.keyType._def.values } });
...
var CommonReasoningDetailSchema = zod_v4.z.object({
	id: zod_v4.z.string().nullish(),
	format: zod_v4.z.enum(ReasoningFormat).nullish(),
	index: zod_v4.z.number().optional()
}).loose();
var ReasoningDetailSummarySchema = zod_v4.z.object({
	type: zod_v4.z.literal("reasoning.summary"),
	summary: zod_v4.z.string()
}).extend(CommonReasoningDetailSchema.shape);
var ReasoningDetailEncryptedSchema = zod_v4.z.object({
	type: zod_v4.z.literal("reasoning.encrypted"),
	data: zod_v4.z.string()
}).extend(CommonReasoningDetailSchema.shape);
var ReasoningDetailTextSchema = zod_v4.z.object({
	type: zod_v4.z.literal("reasoning.text"),
	text: zod_v4.z.string().nullish(),
	signature: zod_v4.z.string().nullish()
}).extend(CommonReasoningDetailSchema.shape);
var ReasoningDetailUnionSchema = zod_v4.z.union([
	ReasoningDetailSummarySchema,
	ReasoningDetailEncryptedSchema,
	ReasoningDetailTextSchema
]);
var ReasoningDetailsWithUnknownSchema = zod_v4.z.union([ReasoningDetailUnionSchema, zod_v4.z.unknown().transform(() => null)]);
var ReasoningDetailArraySchema = zod_v4.z.array(ReasoningDetailsWithUnknownSchema).transform((d) => d.filter((d2) => !!d2));
zod_v4.z.union([
	zod_v4.z.object({ delta: zod_v4.z.object({ reasoning_details: zod_v4.z.array(ReasoningDetailsWithUnknownSchema) }) }).transform((data) => data.delta.reasoning_details.filter(isDefinedOrNotNull)),
	zod_v4.z.object({ message: zod_v4.z.object({ reasoning_details: zod_v4.z.array(ReasoningDetailsWithUnknownSchema) }) }).transform((data) => data.message.reasoning_details.filter(isDefinedOrNotNull)),
	zod_v4.z.object({
		text: zod_v4.z.string(),
		reasoning_details: zod_v4.z.array(ReasoningDetailsWithUnknownSchema)
	}).transform((data) => data.reasoning_details.filter(isDefinedOrNotNull))
]);
var OpenRouterErrorResponseSchema = zod_v4.z.object({ error: zod_v4.z.object({
	code: zod_v4.z.union([zod_v4.z.string(), zod_v4.z.number()]).nullable().optional().default(null),
	message: zod_v4.z.string(),
	type: zod_v4.z.string().nullable().optional().default(null),
	param: zod_v4.z.any().nullable().optional().default(null)
...
var FileAnnotationSchema = zod_v4.z.object({
	type: zod_v4.z.literal("file"),
	file: zod_v4.z.object({
		hash: zod_v4.z.string(),
		name: zod_v4.z.string(),
		content: zod_v4.z.array(zod_v4.z.object({
			type: zod_v4.z.string(),
			text: zod_v4.z.string().optional()
		}).catchall(zod_v4.z.any())).optional()
	}).catchall(zod_v4.z.any())
}).catchall(zod_v4.z.any());
var OpenRouterProviderMetadataSchema = zod_v4.z.object({
	provider: zod_v4.z.string(),
	reasoning_details: zod_v4.z.array(ReasoningDetailUnionSchema).optional(),
	annotations: zod_v4.z.array(FileAnnotationSchema).optional(),
	usage: zod_v4.z.object({
		promptTokens: zod_v4.z.number(),
		promptTokensDetails: zod_v4.z.object({ cachedTokens: zod_v4.z.number() }).catchall(zod_v4.z.any()).optional(),
		completionTokens: zod_v4.z.number(),
		completionTokensDetails: zod_v4.z.object({ reasoningTokens: zod_v4.z.number() }).catchall(zod_v4.z.any()).optional(),
		totalTokens: zod_v4.z.number(),
		cost: zod_v4.z.number().optional(),
		costDetails: zod_v4.z.object({ upstreamInferenceCost: zod_v4.z.number() }).catchall(zod_v4.z.any()).optional()
	}).catchall(zod_v4.z.any())
}).catchall(zod_v4.z.any());
var OpenRouterProviderOptionsSchema = zod_v4.z.object({ openrouter: zod_v4.z.object({
...
zod_v4.z.union([
	...
	zod_v4.z.object({
		...
		function: zod_v4.z.object({ name: zod_v4.z.string() })
	})
]);
...
var ImageResponseSchema = zod_v4.z.object({
	type: zod_v4.z.literal("image_url"),
	image_url: zod_v4.z.object({ url: zod_v4.z.string() }).passthrough()
}).passthrough();
var ImageResponseWithUnknownSchema = zod_v4.z.union([ImageResponseSchema, zod_v4.z.unknown().transform(() => null)]);
var ImageResponseArraySchema = zod_v4.z.array(ImageResponseWithUnknownSchema).transform((d) => d.filter((d2) => !!d2));
var OpenRouterChatCompletionBaseResponseSchema = zod_v4.z.object({
	...
	usage: zod_v4.z.object({
		...
		prompt_tokens_details: zod_v4.z.object({
			cached_tokens: zod_v4.z.number(),
			cache_write_tokens: zod_v4.z.number().nullish()
		}).passthrough().nullish(),
		completion_tokens: zod_v4.z.number(),
		completion_tokens_details: zod_v4.z.object({ reasoning_tokens: zod_v4.z.number() }).passthrough().nullish(),
		total_tokens: zod_v4.z.number(),
		cost: zod_v4.z.number().optional(),
		cost_details: zod_v4.z.object({ upstream_inference_cost: zod_v4.z.number().nullish() }).passthrough().nullish()
	}).passthrough().nullish()
}).passthrough();
var OpenRouterNonStreamChatCompletionResponseSchema = zod_v4.z.union([OpenRouterChatCompletionBaseResponseSchema.extend({ choices: zod_v4.z.array(zod_v4.z.object({
	message: zod_v4.z.object({
		role: zod_v4.z.literal("assistant"),
		content: zod_v4.z.string().nullable().optional(),
		reasoning: zod_v4.z.string().nullable().optional(),
		reasoning_details: ReasoningDetailArraySchema.nullish(),
		images: ImageResponseArraySchema.nullish(),
		tool_calls: zod_v4.z.array(zod_v4.z.object({
			id: zod_v4.z.string().optional().nullable(),
			type: zod_v4.z.literal("function"),
		...
		annotations: zod_v4.z.array(zod_v4.z.union([
			zod_v4.z.object({
				type: zod_v4.z.literal("url_citation"),
				url_citation: zod_v4.z.object({
					url: zod_v4.z.string(),
					title: zod_v4.z.string().optional(),
					start_index: zod_v4.z.number().optional(),
					end_index: zod_v4.z.number().optional(),
					content: zod_v4.z.string().optional()
				}).passthrough()
			}).passthrough(),
			zod_v4.z.object({
				type: zod_v4.z.literal("file_annotation"),
				file_annotation: zod_v4.z.object({
					file_id: zod_v4.z.string(),
					quote: zod_v4.z.string().optional()
				}).passthrough()
			}).passthrough(),
			zod_v4.z.object({
				type: zod_v4.z.literal("file"),
	...
	finish_reason: zod_v4.z.string().optional().nullable()
}).passthrough()) }), OpenRouterErrorResponseSchema.extend({ user_id: zod_v4.z.string().optional() })]);
var OpenRouterStreamChatCompletionChunkSchema = zod_v4.z.union([OpenRouterChatCompletionBaseResponseSchema.extend({ choices: zod_v4.z.array(zod_v4.z.object({
	delta: zod_v4.z.object({
		role: zod_v4.z.enum(["assistant"]).optional(),
		content: zod_v4.z.string().nullish(),
		reasoning: zod_v4.z.string().nullish().optional(),
		reasoning_details: ReasoningDetailArraySchema.nullish(),
		images: ImageResponseArraySchema.nullish(),
		tool_calls: zod_v4.z.array(zod_v4.z.object({
			index: zod_v4.z.number().nullish(),
	...
	finish_reason: zod_v4.z.string().nullable().optional(),
	index: zod_v4.z.number().nullish()
...
var OpenRouterCompletionChunkSchema = zod_v4.z.union([zod_v4.z.object({
	id: zod_v4.z.string().optional(),
	model: zod_v4.z.string().optional(),
	provider: zod_v4.z.string().optional(),
	choices: zod_v4.z.array(zod_v4.z.object({
		...
		logprobs: zod_v4.z.object({
			...
			top_logprobs: zod_v4.z.array(zod_v4.z.record(zod_v4.z.string(), zod_v4.z.number())).nullable()
...
var openrouterEmbeddingUsageSchema = zod_v4.z.object({
	prompt_tokens: zod_v4.z.number(),
	total_tokens: zod_v4.z.number(),
	cost: zod_v4.z.number().optional()
});
var openrouterEmbeddingDataSchema = zod_v4.z.object({
	object: zod_v4.z.literal("embedding"),
	embedding: zod_v4.z.array(zod_v4.z.number()),
	index: zod_v4.z.number().optional()
});
var OpenRouterEmbeddingResponseSchema = zod_v4.z.object({
	id: zod_v4.z.string().optional(),
	object: zod_v4.z.literal("list"),
	data: zod_v4.z.array(openrouterEmbeddingDataSchema),
...
var OpenRouterImageResponseSchema = zod_v4.z.object({
	created: zod_v4.z.number().optional(),
	data: zod_v4.z.array(zod_v4.z.object({ b64_json: zod_v4.z.string() }).passthrough()),
	usage: zod_v4.z.object({
		prompt_tokens: zod_v4.z.number(),
		completion_tokens: zod_v4.z.number(),
		total_tokens: zod_v4.z.number()
...
results: zod_v4.z.array(zod_v4.z.unknown()).optional() })
});
...
var VERSION2 = "2.10.0";
var VideoGenerationSubmitResponseSchema = zod_v4.z.object({
	id: zod_v4.z.string(),
	generation_id: zod_v4.z.string().optional(),
	polling_url: zod_v4.z.string(),
	status: zod_v4.z.string()
}).passthrough();
var VideoGenerationPollResponseSchema = zod_v4.z.object({
	id: zod_v4.z.string(),
	generation_id: zod_v4.z.string().optional(),
	polling_url: zod_v4.z.string(),
	status: zod_v4.z.string(),
	unsigned_urls: zod_v4.z.array(zod_v4.z.string()).optional(),
	usage: zod_v4.z.object({
		cost: zod_v4.z.number().optional(),
		is_byok: zod_v4.z.boolean().optional()
	}).passthrough().optional(),
...
var alibabaLanguageModelOptions = zod_v4.z.object({
	/**
	...
	* @default false
	*/
	enableThinking: zod_v4.z.boolean().optional(),
	/**
	* Maximum number of reasoning tokens to generate.
	*/
	thinkingBudget: zod_v4.z.number().positive().optional(),
	/**
...
var alibabaFailedResponseHandler = require_dist.createJsonErrorResponseHandler({
	errorSchema: zod_v4.z.object({ error: zod_v4.z.object({
		message: zod_v4.z.string(),
...
function formatImageUrl({ data, mediaType }) {
	return data instanceof URL ? data.toString() : `data:${mediaType};base64,${require_dist.convertToBase64(data)}`;
}
				...
				messages.push({
					...
					content: content.map((part, index) => {
						...
						switch (part.type) {
							...
							} else throw new require_dist.UnsupportedFunctionalityError({ functionality: "Only image file parts are supported" });
						}
					})
				});
				break;
...
var AlibabaLanguageModel = class {
	...
	*/
	async getArgs({ prompt, maxOutputTokens, temperature, topP, topK, frequencyPenalty, presencePenalty, stopSequences, responseFormat, seed, providerOptions, tools, toolChoice }) {
		...
		const alibabaOptions = await require_dist.parseProviderOptions({
			provider: "alibaba",
			providerOptions,
	...
	async doGenerate(options) {
		...
		const { responseHeaders, value: response, rawValue: rawResponse } = await require_dist.postJsonToApi({
			...
			headers: require_dist.combineHeaders(this.config.headers(), options.headers),
			body: args,
			failedResponseHandler: alibabaFailedResponseHandler,
			successfulResponseHandler: require_dist.createJsonResponseHandler(alibabaChatResponseSchema),
			abortSignal: options.abortSignal,
			fetch: this.config.fetch
		});
		const choice = response.choices[0];
	...
	async doStream(options) {
		...
		const { responseHeaders, value: response } = await require_dist.postJsonToApi({
			...
			body,
			failedResponseHandler: alibabaFailedResponseHandler,
			successfulResponseHandler: require_dist.createEventSourceResponseHandler(alibabaChatChunkSchema),
			abortSignal: options.abortSignal,
			fetch: this.config.fetch
		});
		let finishReason = {
				...
				transform(chunk, controller) {
					...
					if (delta.reasoning_content != null && delta.reasoning_content.length > 0) {
						if (activeReasoningId == null) {
							...
							activeReasoningId = require_dist.generateId();
							controller.enqueue({
								type: "reasoning-start",
					...
					if (delta.tool_calls != null) {
						...
						for (const toolCallDelta of delta.tool_calls) {
							...
							if (toolCalls[index] == null) {
								if (toolCallDelta.id == null) throw new require_dist.InvalidResponseDataError({
									data: toolCallDelta,
									message: `Expected 'id' to be a string.`
								});
								if (((_b = toolCallDelta.function) == null ? void 0 : _b.name) == null) throw new require_dist.InvalidResponseDataError({
									data: toolCallDelta,
									message: `Expected 'function.name' to be a string.`
								});
								controller.enqueue({
...
var alibabaUsageSchema = zod_v4.z.object({
	prompt_tokens: zod_v4.z.number(),
	completion_tokens: zod_v4.z.number(),
	total_tokens: zod_v4.z.number(),
	prompt_tokens_details: zod_v4.z.object({
...
var alibabaChatResponseSchema = zod_v4.z.object({
	id: zod_v4.z.string().nullish(),
...
var alibabaChatChunkSchema = zod_v4.z.object({
	id: zod_v4.z.string().nullish(),
	created: zod_v4.z.number().nullish(),
	model: zod_v4.z.string().nullish(),
	choices: zod_v4.z.array(zod_v4.z.object({
...
var alibabaEmbeddingModelOptions = zod_v4.z.object({
	...
	*/
	outputType: zod_v4.z.enum([
		"dense",
		"sparse",
		"dense&sparse"
	]).optional()
});
var alibabaEmbeddingFailedResponseHandler = require_dist.createJsonErrorResponseHandler({
	errorSchema: zod_v4.z.object({
		code: zod_v4.z.string().nullish(),
		message: zod_v4.z.string(),
		request_id: zod_v4.z.string().nullish()
	}),
...
var AlibabaEmbeddingModel = class {
	...
	async doEmbed({ values, headers, abortSignal, providerOptions }) {
		if (values.length > this.maxEmbeddingsPerCall) throw new require_dist.TooManyEmbeddingValuesForCallError({
		...
		if ((alibabaOptions == null ? void 0 : alibabaOptions.outputType) === "sparse") throw new require_dist.UnsupportedFunctionalityError({
		...
		const { responseHeaders, value: response, rawValue } = await require_dist.postJsonToApi({
			url: `${this.config.baseURL}/services/embeddings/text-embedding/text-embedding`,
			headers: require_dist.combineHeaders(this.config.headers(), headers),
			body: {
				model: this.modelId,
				input: { texts: values },
				parameters: {
			...
			successfulResponseHandler: require_dist.createJsonResponseHandler(alibabaTextEmbeddingResponseSchema),
			abortSignal,
			fetch: this.config.fetch
		});
...
var alibabaTextEmbeddingSparseEmbeddingSchema = zod_v4.z.object({
	index: zod_v4.z.number(),
	value: zod_v4.z.number(),
	token: zod_v4.z.string().nullish()
});
var alibabaTextEmbeddingResponseSchema = zod_v4.z.object({
	output: zod_v4.z.object({ embeddings: zod_v4.z.array(zod_v4.z.object({
		embedding: zod_v4.z.array(zod_v4.z.number()),
		text_index: zod_v4.z.number(),
		sparse_embedding: zod_v4.z.array(alibabaTextEmbeddingSparseEmbeddingSchema).nullish()
	})) }),
	usage: zod_v4.z.object({ total_tokens: zod_v4.z.number() }).nullish()
});
var alibabaVideoModelOptionsSchema = require_dist.lazySchema(() => require_dist.zodSchema(zod_v4.z.object({
	negativePrompt: zod_v4.z.string().nullish(),
	audioUrl: zod_v4.z.string().nullish(),
	promptExtend: zod_v4.z.boolean().nullish(),
	shotType: zod_v4.z.enum(["single", "multi"]).nullish(),
	watermark: zod_v4.z.boolean().nullish(),
	audio: zod_v4.z.boolean().nullish(),
	referenceUrls: zod_v4.z.array(zod_v4.z.string()).nullish(),
	media: zod_v4.z.array(zod_v4.z.object({
		type: zod_v4.z.enum([
			"reference_image",
			"reference_video",
			"first_frame"
		...
		url: zod_v4.z.string(),
		referenceVoice: zod_v4.z.string().nullish()
	})).nullish(),
	ratio: zod_v4.z.enum([
		"16:9",
		"9:16",
	...
	pollIntervalMs: zod_v4.z.number().positive().nullish(),
	pollTimeoutMs: zod_v4.z.number().positive().nullish()
}).passthrough()));
var alibabaVideoFailedResponseHandler = require_dist.createJsonErrorResponseHandler({
	errorSchema: zod_v4.z.object({
		code: zod_v4.z.string().nullish(),
		message: zod_v4.z.string(),
		request_id: zod_v4.z.string().nullish()
...
var alibabaVideoCreateTaskSchema = zod_v4.z.object({
	output: zod_v4.z.object({
		task_status: zod_v4.z.string(),
		task_id: zod_v4.z.string()
	}).nullish(),
	request_id: zod_v4.z.string().nullish()
});
var alibabaVideoTaskStatusSchema = zod_v4.z.object({
	output: zod_v4.z.object({
		task_id: zod_v4.z.string(),
		task_status: zod_v4.z.string(),
		video_url: zod_v4.z.string().nullish(),
		submit_time: zod_v4.z.string().nullish(),
		scheduled_time: zod_v4.z.string().nullish(),
		end_time: zod_v4.z.string().nullish(),
		orig_prompt: zod_v4.z.string().nullish(),
		actual_prompt: zod_v4.z.string().nullish(),
		code: zod_v4.z.string().nullish(),
		message: zod_v4.z.string().nullish()
	}).nullish(),
	usage: zod_v4.z.object({
		duration: zod_v4.z.number().nullish(),
		output_video_duration: zod_v4.z.number().nullish(),
		SR: zod_v4.z.number().nullish(),
...
function fileToImageString(file) {
	...
	return typeof file.data === "string" ? file.data : require_dist.convertUint8ArrayToBase64(file.data);
}
...
function resolveMedia(options, alibabaOptions, warnings) {
	...
	for (const reference of (_a = options.inputReferences) != null ? _a : []) if (reference.type === "url") media.push({
		...
		url: require_dist.convertImageModelFileToDataUri(reference)
	});
	else warnings.push({
		type: "unsupported",
	...
	if (firstFrame != null) media.push({
		type: "first_frame",
		url: require_dist.convertImageModelFileToDataUri(firstFrame)
	});
...
var AlibabaVideoModel = class {
	...
	async doGenerate(options) {
		...
		const { value: createResponse } = await require_dist.postJsonToApi({
			url: `${this.config.baseURL}/api/v1/services/aigc/video-generation/video-synthesis`,
			headers: require_dist.combineHeaders(await require_dist.resolve(this.config.headers), options.headers, { "X-DashScope-Async": "enable" }),
			body: {
				model: this.modelId,
				input,
				parameters
			},
			successfulResponseHandler: require_dist.createJsonResponseHandler(alibabaVideoCreateTaskSchema),
			failedResponseHandler: alibabaVideoFailedResponseHandler,
			abortSignal: options.abortSignal,
			fetch: this.config.fetch
		});
		const taskId = (_i = createResponse.output) == null ? void 0 : _i.task_id;
		if (!taskId) throw new require_dist.AISDKError({
		...
		let responseHeaders;
		while (true) {
			await require_dist.delay(pollIntervalMs, { abortSignal: options.abortSignal });
			if (Date.now() - startTime > pollTimeoutMs) throw new require_dist.AISDKError({
				name: "ALIBABA_VIDEO_GENERATION_TIMEOUT",
				message: `Video generation timed out after ${pollTimeoutMs}ms`
			});
			const { value: statusResponse, responseHeaders: pollHeaders } = await require_dist.getFromApi({
				url: `${this.config.baseURL}/api/v1/tasks/${taskId}`,
				headers: require_dist.combineHeaders(await require_dist.resolve(this.config.headers), options.headers),
				successfulResponseHandler: require_dist.createJsonResponseHandler(alibabaVideoTaskStatusSchema),
				failedResponseHandler: alibabaVideoFailedResponseHandler,
				abortSignal: options.abortSignal,
				fetch: this.config.fetch
			});
			...
			if (taskStatus === "FAILED" || taskStatus === "CANCELED") throw new require_dist.AISDKError({
		...
		if (!videoUrl) throw new require_dist.AISDKError({
			name: "ALIBABA_VIDEO_GENERATION_ERROR",
...
function createAlibaba(options = {}) {
	var _a, _b, _c;
	const baseURL = (_a = require_dist.withoutTrailingSlash(options.baseURL)) != null ? _a : "https://dashscope-intl.aliyuncs.com/compatible-mode/v1";
	const videoBaseURL = (_b = require_dist.withoutTrailingSlash(options.videoBaseURL)) != null ? _b : "https://dashscope-intl.aliyuncs.com";
	const embeddingBaseURL = (_c = require_dist.withoutTrailingSlash(options.embeddingBaseURL)) != null ? _c : "https://dashscope-intl.aliyuncs.com/api/v1";
	const getHeaders = () => require_dist.withUserAgentSuffix({
		Authorization: `Bearer ${require_dist.loadApiKey({
			apiKey: options.apiKey,
...
var CerebrasChatLanguageModel = class extends require_dist.OpenAICompatibleChatLanguageModel {
	async doGenerate(options) {
		var _a;
...
function createCerebras(options = {}) {
	var _a;
	const baseURL = require_dist.withoutTrailingSlash((_a = options.baseURL) != null ? _a : "https://api.cerebras.ai/v1");
	const getHeaders = () => require_dist.withUserAgentSuffix({
		Authorization: `Bearer ${require_dist.loadApiKey({
			apiKey: options.apiKey,
...
var DeepInfraImageModel = class {
	...
	async doGenerate({ prompt, n, size, aspectRatio, seed, providerOptions, headers, abortSignal, files, mask }) {
		...
		if (files != null && files.length > 0) {
			const { value: response2, responseHeaders: responseHeaders2 } = await require_dist.postFormDataToApi({
				url: this.getEditUrl(),
				headers: require_dist.combineHeaders(this.config.headers(), headers),
				formData: require_dist.convertToFormData({
					model: this.modelId,
					prompt,
				...
				failedResponseHandler: require_dist.createJsonErrorResponseHandler({
				...
				successfulResponseHandler: require_dist.createJsonResponseHandler(deepInfraEditResponseSchema),
				abortSignal,
				fetch: this.config.fetch
			});
			return {
		...
		const { value: response, responseHeaders } = await require_dist.postJsonToApi({
			...
			successfulResponseHandler: require_dist.createJsonResponseHandler(deepInfraImageResponseSchema),
			abortSignal,
			fetch: this.config.fetch
		});
		return {
...
var deepInfraErrorSchema = zod_v4.z.object({ detail: zod_v4.z.object({ error: zod_v4.z.string() }) });
var deepInfraImageResponseSchema = zod_v4.z.object({ images: zod_v4.z.array(zod_v4.z.string()) });
var deepInfraEditErrorSchema = zod_v4.z.object({ error: zod_v4.z.object({ message: zod_v4.z.string() }).optional() });
var deepInfraEditResponseSchema = zod_v4.z.object({ data: zod_v4.z.array(zod_v4.z.object({ b64_json: zod_v4.z.string() })) });
async function fileToBlob(file) {
	if (file.type === "url") return require_dist.downloadBlob(file.url);
	const data = file.data instanceof Uint8Array ? file.data : require_dist.convertBase64ToUint8Array(file.data);
	return new Blob([data], { type: file.mediaType });
}
var DeepInfraChatLanguageModel = class extends require_dist.OpenAICompatibleChatLanguageModel {
	constructor(modelId, config) {
...
function createDeepInfra(options = {}) {
	var _a;
	const baseURL = require_dist.withoutTrailingSlash((_a = options.baseURL) != null ? _a : "https://api.deepinfra.com/v1");
	const getHeaders = () => require_dist.withUserAgentSuffix({
		Authorization: `Bearer ${require_dist.loadApiKey({
			apiKey: options.apiKey,
	...
	const createCompletionModel = (modelId) => new require_dist.OpenAICompatibleCompletionLanguageModel(modelId, getCommonModelConfig("completion"));
	const createEmbeddingModel = (modelId) => new require_dist.OpenAICompatibleEmbeddingModel(modelId, getCommonModelConfig("embedding"));
...
var deepseekChatChunkSchema = require_dist.lazySchema(() => require_dist.zodSchema(zod_v4.z.union([zod_v4.z.object({
	id: zod_v4.z.string().nullish(),
	created: zod_v4.z.number().nullish(),
	model: zod_v4.z.string().nullish(),
	choices: zod_v4.z.array(zod_v4.z.object({
...
var deepseekLanguageModelOptions = zod_v4.z.object({
	/**
...
var DeepSeekChatLanguageModel = class {
	constructor(modelId, config) {
		...
		this.modelId = modelId;
		this.config = config;
		this.failedResponseHandler = require_dist.createJsonErrorResponseHandler({
	...
	async getArgs({ prompt, maxOutputTokens, temperature, topP, topK, frequencyPenalty, presencePenalty, providerOptions, stopSequences, responseFormat, seed, toolChoice, tools }) {
		var _a, _b, _c, _d;
		const deepseekOptions = (_a = await require_dist.parseProviderOptions({
	...
	async doGenerate(options) {
		var _a, _b, _c, _d;
		const { args, warnings } = await this.getArgs({ ...options });
		const { responseHeaders, value: responseBody, rawValue: rawResponse } = await require_dist.postJsonToApi({
			url: this.config.url({
				path: "/chat/completions",
				modelId: this.modelId
			}),
			...
			successfulResponseHandler: require_dist.createJsonResponseHandler(deepseekChatResponseSchema),
			abortSignal: options.abortSignal,
			fetch: this.config.fetch
		});
		...
		if (choice.message.tool_calls != null) for (const toolCall of choice.message.tool_calls) content.push({
			type: "tool-call",
			toolCallId: (_a = toolCall.id) != null ? _a : require_dist.generateId(),
			toolName: toolCall.function.name,
			input: toolCall.function.arguments
		});
		const text = choice.message.content;
	...
	async doStream(options) {
		...
		const { responseHeaders, value: response } = await require_dist.postJsonToApi({
			...
			body,
			failedResponseHandler: this.failedResponseHandler,
			successfulResponseHandler: require_dist.createEventSourceResponseHandler(deepseekChatChunkSchema),
			abortSignal: options.abortSignal,
			fetch: this.config.fetch
		});
		const toolCalls = [];
					...
					if (delta.tool_calls != null) {
						...
						for (const toolCallDelta of delta.tool_calls) {
							...
							if (toolCalls[index] == null) {
								...
								if (((_a = toolCallDelta.function) == null ? void 0 : _a.name) == null) throw new require_dist.InvalidResponseDataError({
									data: toolCallDelta,
									message: `Expected 'function.name' to be a string.`
								});
								controller.enqueue({
...
function createDeepSeek(options = {}) {
	var _a;
	const baseURL = require_dist.withoutTrailingSlash((_a = options.baseURL) != null ? _a : "https://api.deepseek.com");
	const getHeaders = () => require_dist.withUserAgentSuffix({
		Authorization: `Bearer ${require_dist.loadApiKey({
			apiKey: options.apiKey,
			...
			messages.push({
				...
				content: content.map((part) => {
					switch (part.type) {
						...
						case "file": {
							if (!part.mediaType.startsWith("image/")) throw new require_dist.UnsupportedFunctionalityError({ functionality: "Non-image file content parts" });
							const mediaType = part.mediaType === "image/*" ? "image/jpeg" : part.mediaType;
							return {
								type: "image_url",
								image_url: { url: part.data instanceof URL ? part.data.toString() : `data:${mediaType};base64,${require_dist.convertToBase64(part.data)}` }
							};
						}
					}
				})
...
var groqLanguageModelOptions = zod_v4.z.object({
	reasoningFormat: zod_v4.z.enum([
		"parsed",
		"raw",
		"hidden"
	]).optional(),
...
var groqErrorDataSchema = zod_v4.z.object({ error: zod_v4.z.object({
	message: zod_v4.z.string(),
	type: zod_v4.z.string()
}) });
var groqFailedResponseHandler = require_dist.createJsonErrorResponseHandler({
...
var GroqChatLanguageModel = class {
	...
	async getArgs({ prompt, maxOutputTokens, temperature, topP, topK, frequencyPenalty, presencePenalty, stopSequences, responseFormat, seed, stream, tools, toolChoice, providerOptions }) {
		var _a, _b, _c;
		const warnings = [];
		const groqOptions = await require_dist.parseProviderOptions({
			provider: "groq",
			providerOptions,
	...
	async doGenerate(options) {
		...
		const { responseHeaders, value: response, rawValue: rawResponse } = await require_dist.postJsonToApi({
			...
			successfulResponseHandler: require_dist.createJsonResponseHandler(groqChatResponseSchema),
			abortSignal: options.abortSignal,
			fetch: this.config.fetch
		});
		const choice = response.choices[0];
	...
	async doStream(options) {
		...
		const { responseHeaders, value: response } = await require_dist.postJsonToApi({
			...
			failedResponseHandler: groqFailedResponseHandler,
			successfulResponseHandler: require_dist.createEventSourceResponseHandler(groqChatChunkSchema),
			abortSignal: options.abortSignal,
			fetch: this.config.fetch
		});
		const toolCalls = [];
				...
				transform(chunk, controller) {
					...
					if (delta.tool_calls != null) {
						...
						for (const toolCallDelta of delta.tool_calls) {
							const index = toolCallDelta.index;
							if (toolCalls[index] == null) {
								if (toolCallDelta.type !== "function") throw new require_dist.InvalidResponseDataError({
									data: toolCallDelta,
									message: `Expected 'function' type.`
								});
								if (toolCallDelta.id == null) throw new require_dist.InvalidResponseDataError({
...
var groqChatResponseSchema = zod_v4.z.object({
	id: zod_v4.z.string().nullish(),
	created: zod_v4.z.number().nullish(),
	model: zod_v4.z.string().nullish(),
	choices: zod_v4.z.array(zod_v4.z.object({
		message: zod_v4.z.object({
			content: zod_v4.z.string().nullish(),
			reasoning: zod_v4.z.string().nullish(),
			tool_calls: zod_v4.z.array(zod_v4.z.object({
				id: zod_v4.z.string().nullish(),
				type: zod_v4.z.literal("function"),
				function: zod_v4.z.object({
	...
	usage: zod_v4.z.object({
		...
		completion_tokens: zod_v4.z.number().nullish(),
		total_tokens: zod_v4.z.number().nullish(),
		prompt_tokens_details: zod_v4.z.object({ cached_tokens: zod_v4.z.number().nullish() }).nullish(),
		completion_tokens_details: zod_v4.z.object({ reasoning_tokens: zod_v4.z.number().nullish() }).nullish()
	}).nullish()
});
var groqChatChunkSchema = zod_v4.z.union([zod_v4.z.object({
	id: zod_v4.z.string().nullish(),
	created: zod_v4.z.number().nullish(),
	model: zod_v4.z.string().nullish(),
	choices: zod_v4.z.array(zod_v4.z.object({
	...
	x_groq: zod_v4.z.object({ usage: zod_v4.z.object({
		prompt_tokens: zod_v4.z.number().nullish(),
		completion_tokens: zod_v4.z.number().nullish(),
		total_tokens: zod_v4.z.number().nullish(),
		prompt_tokens_details: zod_v4.z.object({ cached_tokens: zod_v4.z.number().nullish() }).nullish(),
...
var groqTranscriptionModelOptions = require_dist.lazySchema(() => require_dist.zodSchema(zod_v4.z.object({
	language: zod_v4.z.string().nullish(),
	prompt: zod_v4.z.string().nullish(),
	responseFormat: zod_v4.z.string().nullish(),
	temperature: zod_v4.z.number().min(0).max(1).nullish(),
	timestampGranularities: zod_v4.z.array(zod_v4.z.string()).nullish()
})));
var GroqTranscriptionModel = class {
	...
	async getArgs({ audio, mediaType, providerOptions }) {
		...
		const blob = audio instanceof Uint8Array ? new Blob([audio]) : new Blob([require_dist.convertBase64ToUint8Array(audio)]);
		formData.append("model", this.modelId);
		const fileExtension = require_dist.mediaTypeToExtension(mediaType);
	...
	async doGenerate(options) {
		...
		const { value: response, responseHeaders, rawValue: rawResponse } = await require_dist.postFormDataToApi({
			url: this.config.url({
			...
			formData,
			failedResponseHandler: groqFailedResponseHandler,
			successfulResponseHandler: require_dist.createJsonResponseHandler(groqTranscriptionResponseSchema),
			abortSignal: options.abortSignal,
			fetch: this.config.fetch
		});
		return {
...
var groqTranscriptionResponseSchema = zod_v4.z.object({
	text: zod_v4.z.string(),
	x_groq: zod_v4.z.object({ id: zod_v4.z.string() }),
	task: zod_v4.z.string().nullish(),
	language: zod_v4.z.string().nullish(),
	duration: zod_v4.z.number().nullish(),
...
var groqTools = { browserSearch: require_dist.createProviderToolFactory({
...
function createGroq(options = {}) {
	var _a;
	const baseURL = (_a = require_dist.withoutTrailingSlash(options.baseURL)) != null ? _a : "https://api.groq.com/openai/v1";
	const getHeaders = () => require_dist.withUserAgentSuffix({
		Authorization: `Bearer ${require_dist.loadApiKey({
			apiKey: options.apiKey,
				...
				messages.push({
					...
					content: content.map((part) => {
						switch (part.type) {
							...
							else throw new require_dist.UnsupportedFunctionalityError({ functionality: "Only images and PDF file parts are supported" });
						}
					})
				});
				break;
...
var mistralLanguageModelOptions = zod_v4.z.object({
	/**
	* Whether to inject a safety prompt before all conversations.
	*
	* Defaults to `false`.
	*/
	safePrompt: zod_v4.z.boolean().optional(),
	documentImageLimit: zod_v4.z.number().optional(),
	documentPageLimit: zod_v4.z.number().optional(),
	/**
	* Whether to use structured outputs.
	*
	* @default true
	...
	*/
	reasoningEffort: zod_v4.z.enum(["high", "none"]).optional()
});
var mistralFailedResponseHandler = require_dist.createJsonErrorResponseHandler({
	errorSchema: zod_v4.z.object({
		object: zod_v4.z.literal("error"),
		message: zod_v4.z.string(),
		type: zod_v4.z.string(),
		param: zod_v4.z.string().nullable(),
...
var MistralChatLanguageModel = class {
	...
	async getArgs({ prompt, maxOutputTokens, temperature, topP, topK, frequencyPenalty, presencePenalty, stopSequences, responseFormat, seed, providerOptions, tools, toolChoice }) {
		var _a, _b, _c, _d;
		const warnings = [];
		const options = (_a = await require_dist.parseProviderOptions({
			provider: "mistral",
			providerOptions,
		...
		if ((responseFormat == null ? void 0 : responseFormat.type) === "json" && !(responseFormat == null ? void 0 : responseFormat.schema)) prompt = require_dist.injectJsonInstructionIntoMessages({
			messages: prompt,
			schema: responseFormat.schema
		});
		const baseArgs = {
	...
	async doGenerate(options) {
		...
		const { responseHeaders, value: response, rawValue: rawResponse } = await require_dist.postJsonToApi({
			...
			successfulResponseHandler: require_dist.createJsonResponseHandler(mistralChatResponseSchema),
			abortSignal: options.abortSignal,
			fetch: this.config.fetch
		});
		const choice = response.choices[0];
	...
	async doStream(options) {
		...
		const { responseHeaders, value: response } = await require_dist.postJsonToApi({
			...
			body,
			failedResponseHandler: mistralFailedResponseHandler,
			successfulResponseHandler: require_dist.createEventSourceResponseHandler(mistralChatChunkSchema),
			abortSignal: options.abortSignal,
			fetch: this.config.fetch
		});
		let finishReason = {
...
var mistralContentSchema = zod_v4.z.union([zod_v4.z.string(), zod_v4.z.array(zod_v4.z.discriminatedUnion("type", [
	zod_v4.z.object({
	...
	zod_v4.z.object({
		type: zod_v4.z.literal("image_url"),
		image_url: zod_v4.z.union([zod_v4.z.string(), zod_v4.z.object({
			url: zod_v4.z.string(),
			detail: zod_v4.z.string().nullable()
		})])
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("reference"),
		reference_ids: zod_v4.z.array(zod_v4.z.union([zod_v4.z.string(), zod_v4.z.number()]))
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("thinking"),
		thinking: zod_v4.z.array(zod_v4.z.object({
			type: zod_v4.z.literal("text"),
			text: zod_v4.z.string()
		}))
	})
]))]).nullish();
var mistralUsageSchema = zod_v4.z.object({
	prompt_tokens: zod_v4.z.number(),
	completion_tokens: zod_v4.z.number(),
	total_tokens: zod_v4.z.number(),
	num_cached_tokens: zod_v4.z.number().nullish(),
	prompt_tokens_details: zod_v4.z.object({ cached_tokens: zod_v4.z.number().nullish() }).nullish(),
	prompt_token_details: zod_v4.z.object({ cached_tokens: zod_v4.z.number().nullish() }).nullish()
});
var mistralChatResponseSchema = zod_v4.z.object({
	id: zod_v4.z.string().nullish(),
	created: zod_v4.z.number().nullish(),
	model: zod_v4.z.string().nullish(),
	choices: zod_v4.z.array(zod_v4.z.object({
	...
	object: zod_v4.z.literal("chat.completion"),
	usage: mistralUsageSchema
});
var mistralChatChunkSchema = zod_v4.z.object({
	id: zod_v4.z.string().nullish(),
	created: zod_v4.z.number().nullish(),
	model: zod_v4.z.string().nullish(),
	choices: zod_v4.z.array(zod_v4.z.object({
...
var MistralEmbeddingModel = class {
	...
	async doEmbed({ values, abortSignal, headers }) {
		...
		const { responseHeaders, value: response, rawValue } = await require_dist.postJsonToApi({
			...
			failedResponseHandler: mistralFailedResponseHandler,
			successfulResponseHandler: require_dist.createJsonResponseHandler(MistralTextEmbeddingResponseSchema),
			abortSignal,
			fetch: this.config.fetch
		});
		return {
...
var MistralTextEmbeddingResponseSchema = zod_v4.z.object({
...
var mistralSpeechModelOptions = zod_v4.z.object({ 
/**
...
*/
refAudio: zod_v4.z.string().min(1).optional() });
var MistralSpeechModel = class {
	...
	async getArgs({ text, voice, outputFormat = "mp3", instructions, speed, language, providerOptions }) {
		const warnings = [];
		const mistralOptions = await require_dist.parseProviderOptions({
			provider: "mistral",
			providerOptions,
	...
	async doGenerate(options) {
		...
		const { value: response, responseHeaders, rawValue: rawResponse } = await require_dist.postToApi({
			url: `${this.config.baseURL}/audio/speech`,
			headers: require_dist.combineHeaders({ "Content-Type": "application/json" }, (_e = (_d = this.config).headers) == null ? void 0 : _e.call(_d), options.headers),
			body: {
				content: JSON.stringify(requestBody),
				values: requestBodyValues
			},
			failedResponseHandler: mistralFailedResponseHandler,
			successfulResponseHandler: require_dist.createJsonResponseHandler(mistralSpeechResponseSchema),
			abortSignal: options.abortSignal,
			fetch: this.config.fetch
		});
		return {
...
var mistralSpeechResponseSchema = zod_v4.z.object({ audio_data: zod_v4.z.string() });
var VERSION$3 = "3.0.52";
function createMistral(options = {}) {
	var _a;
	const baseURL = (_a = require_dist.withoutTrailingSlash(options.baseURL)) != null ? _a : "https://api.mistral.ai/v1";
	const getHeaders = () => require_dist.withUserAgentSuffix({
		Authorization: `Bearer ${require_dist.loadApiKey({
			apiKey: options.apiKey,
...
function convertToPerplexityMessages(prompt) {
	...
	for (const { role, content } of prompt) switch (role) {
				...
				switch (part.type) {
					...
					case "file":
						if (getTopLevelMediaType$1(part.mediaType) === "application") {
							...
							if (fullMediaType !== "application/pdf") throw new require_dist.UnsupportedFunctionalityError({ functionality: `file part media type ${fullMediaType}` });
							return part.data instanceof URL ? {
								...
								type: "file_url",
								file_url: { url: typeof part.data === "string" ? part.data : require_dist.convertUint8ArrayToBase64(part.data) },
							...
							type: "image_url",
							image_url: { url: `data:${(_a = part.mediaType) != null ? _a : "image/jpeg"};base64,${typeof part.data === "string" ? part.data : require_dist.convertUint8ArrayToBase64(part.data)}` }
						};
						throw new require_dist.UnsupportedFunctionalityError({ functionality: `file part media type ${part.mediaType}` });
				}
			}).filter(Boolean);
			messages.push({
				role,
		...
		case "tool": throw new require_dist.UnsupportedFunctionalityError({ functionality: "Tool messages" });
		default: throw new Error(`Unsupported role: ${role}`);
	}
	return messages;
}
...
function resolveApplicationMediaType(part) {
	...
	if (part.data instanceof URL) throw new require_dist.UnsupportedFunctionalityError({ functionality: `file of media type "${part.mediaType}" must specify subtype since it is not passed as inline bytes` });
	if (isPdfData(part.data)) return "application/pdf";
	throw new require_dist.UnsupportedFunctionalityError({ functionality: `file of media type "${part.mediaType}" must specify subtype since it could not be auto-detected` });
}
function isPdfData(data) {
	const bytes = typeof data === "string" ? require_dist.convertBase64ToUint8Array(data.substring(0, Math.min(data.length, 8))) : data;
...
var PerplexityLanguageModel = class {
	...
	async doGenerate(options) {
		...
		const { responseHeaders, value: response, rawValue: rawResponse } = await require_dist.postJsonToApi({
			...
			successfulResponseHandler: require_dist.createJsonResponseHandler(perplexityResponseSchema),
			abortSignal: options.abortSignal,
			fetch: this.config.fetch
		});
		const choice = response.choices[0];
	...
	async doStream(options) {
		...
		const { responseHeaders, value: response } = await require_dist.postJsonToApi({
			...
			successfulResponseHandler: require_dist.createEventSourceResponseHandler(perplexityChunkSchema),
			abortSignal: options.abortSignal,
			fetch: this.config.fetch
		});
		let finishReason = {
...
var perplexityCostSchema = zod_v4.z.object({
	input_tokens_cost: zod_v4.z.number().nullish(),
	output_tokens_cost: zod_v4.z.number().nullish(),
	request_cost: zod_v4.z.number().nullish(),
	total_cost: zod_v4.z.number().nullish()
});
var perplexityUsageSchema = zod_v4.z.object({
	prompt_tokens: zod_v4.z.number(),
	completion_tokens: zod_v4.z.number(),
	total_tokens: zod_v4.z.number().nullish(),
	citation_tokens: zod_v4.z.number().nullish(),
	num_search_queries: zod_v4.z.number().nullish(),
	reasoning_tokens: zod_v4.z.number().nullish(),
	cost: perplexityCostSchema.nullish()
});
var perplexityImageSchema = zod_v4.z.object({
	image_url: zod_v4.z.string(),
	origin_url: zod_v4.z.string(),
	height: zod_v4.z.number(),
	width: zod_v4.z.number()
});
var perplexityResponseSchema = zod_v4.z.object({
	id: zod_v4.z.string(),
	...
	citations: zod_v4.z.array(zod_v4.z.string()).nullish(),
	images: zod_v4.z.array(perplexityImageSchema).nullish(),
	usage: perplexityUsageSchema.nullish()
});
var perplexityChunkSchema = zod_v4.z.object({
	id: zod_v4.z.string(),
	created: zod_v4.z.number(),
	model: zod_v4.z.string(),
	choices: zod_v4.z.array(zod_v4.z.object({
		delta: zod_v4.z.object({
			role: zod_v4.z.literal("assistant").optional(),
			content: zod_v4.z.string().nullish()
		}),
		finish_reason: zod_v4.z.string().nullish()
	})),
...
var perplexityErrorSchema = zod_v4.z.object({ error: zod_v4.z.object({
	code: zod_v4.z.number(),
	message: zod_v4.z.string().nullish(),
	type: zod_v4.z.string().nullish()
}) });
...
function createPerplexity(options = {}) {
	...
	const createLanguageModel = (modelId) => {
		...
		return new PerplexityLanguageModel(modelId, {
			baseURL: require_dist.withoutTrailingSlash((_a = options.baseURL) != null ? _a : "https://api.perplexity.ai"),
			headers: getHeaders,
			generateId: require_dist.generateId,
			fetch: options.fetch
		});
	};
	const provider = (modelId) => createLanguageModel(modelId);
...
var togetheraiErrorSchema = require_dist.lazySchema(() => require_dist.zodSchema(zod_v4.z.object({ error: zod_v4.z.object({ message: zod_v4.z.string() }) })));
var togetheraiRerankingResponseSchema = require_dist.lazySchema(() => require_dist.zodSchema(zod_v4.z.object({
	id: zod_v4.z.string().nullish(),
	model: zod_v4.z.string().nullish(),
	results: zod_v4.z.array(zod_v4.z.object({
		index: zod_v4.z.number(),
		relevance_score: zod_v4.z.number()
	})),
	usage: zod_v4.z.object({
		prompt_tokens: zod_v4.z.number(),
		completion_tokens: zod_v4.z.number(),
...
var togetheraiRerankingModelOptionsSchema = require_dist.lazySchema(() => require_dist.zodSchema(zod_v4.z.object({ rankFields: zod_v4.z.array(zod_v4.z.string()).optional() })));
var TogetherAIRerankingModel = class {
	...
	async doRerank({ documents, headers, query, topN, abortSignal, providerOptions }) {
		var _a, _b;
		const rerankingOptions = await require_dist.parseProviderOptions({
			provider: "togetherai",
			providerOptions,
		...
		const { responseHeaders, value: response, rawValue } = await require_dist.postJsonToApi({
			...
			successfulResponseHandler: require_dist.createJsonResponseHandler(togetheraiRerankingResponseSchema),
			abortSignal,
			fetch: this.config.fetch
		});
		return {
...
var TogetherAIImageModel = class {
	...
	async doGenerate({ prompt, n, size, seed, providerOptions, headers, abortSignal, files, mask }) {
		...
		const currentDate = (_c = (_b = (_a = this.config._internal) == null ? void 0 : _a.currentDate) == null ? void 0 : _b.call(_a)) != null ? _c : /* @__PURE__ */ new Date();
		const togetheraiOptions = await require_dist.parseProviderOptions({
			provider: "togetherai",
			providerOptions,
		...
		let imageUrl;
		if (files != null && files.length > 0) {
			imageUrl = require_dist.convertImageModelFileToDataUri(files[0]);
		...
		const { value: response, responseHeaders } = await require_dist.postJsonToApi({
			...
			successfulResponseHandler: require_dist.createJsonResponseHandler(togetheraiImageResponseSchema),
			abortSignal,
			fetch: this.config.fetch
		});
		return {
...
var togetheraiImageResponseSchema = zod_v4.z.object({ data: zod_v4.z.array(zod_v4.z.object({ b64_json: zod_v4.z.string() })) });
var togetheraiErrorSchema2 = zod_v4.z.object({ error: zod_v4.z.object({ message: zod_v4.z.string() }) });
var togetheraiImageModelOptionsSchema = require_dist.lazySchema(() => require_dist.zodSchema(zod_v4.z.object({
	/**
	* Number of generation steps. Higher values can improve quality.
	*/
	steps: zod_v4.z.number().nullish(),
	/**
	* Guidance scale for image generation.
	*/
	guidance: zod_v4.z.number().nullish(),
	/**
	* Negative prompt to guide what to avoid.
	*/
	negative_prompt: zod_v4.z.string().nullish(),
	/**
	...
	*/
	disable_safety_checker: zod_v4.z.boolean().nullish()
}).passthrough()));
...
function createTogetherAI(options = {}) {
	var _a;
	const baseURL = require_dist.withoutTrailingSlash((_a = options.baseURL) != null ? _a : "https://api.together.xyz/v1/");
	const getHeaders = () => {
		var _a2;
	...
	const createChatModel = (modelId) => {
		return new require_dist.OpenAICompatibleChatLanguageModel(modelId, {
			...getCommonModelConfig("chat"),
			includeUsage: true
		});
	};
	const createCompletionModel = (modelId) => new require_dist.OpenAICompatibleCompletionLanguageModel(modelId, {
...
var xaiFilePartProviderOptions = zod_v4.z.object({ 
/**
			...
			for (const part of content) switch (part.type) {
				...
				case "file":
					if (part.mediaType.startsWith("image/")) {
						const mediaType = part.mediaType === "image/*" ? "image/jpeg" : part.mediaType;
						const filePartOptions = await require_dist.parseProviderOptions({
							provider: "xai",
						...
						userContent.push({
							type: "image_url",
							image_url: {
								url: part.data instanceof URL ? part.data.toString() : `data:${mediaType};base64,${require_dist.convertToBase64(part.data)}`,
								...(filePartOptions == null ? void 0 : filePartOptions.imageDetail) != null && { detail: filePartOptions.imageDetail }
							}
						});
					} else throw new require_dist.UnsupportedFunctionalityError({ functionality: `file part media type ${part.mediaType}` });
					break;
			}
			messages.push({
				role: "user",
...
var webSourceSchema = zod_v4.z.object({
	type: zod_v4.z.literal("web"),
	country: zod_v4.z.string().length(2).optional(),
	excludedWebsites: zod_v4.z.array(zod_v4.z.string()).max(5).optional(),
	allowedWebsites: zod_v4.z.array(zod_v4.z.string()).max(5).optional(),
	safeSearch: zod_v4.z.boolean().optional()
});
var xSourceSchema = zod_v4.z.object({
	type: zod_v4.z.literal("x"),
	excludedXHandles: zod_v4.z.array(zod_v4.z.string()).optional(),
	includedXHandles: zod_v4.z.array(zod_v4.z.string()).optional(),
	postFavoriteCount: zod_v4.z.number().int().optional(),
	postViewCount: zod_v4.z.number().int().optional(),
	/**
	* @deprecated use `includedXHandles` instead
	*/
	xHandles: zod_v4.z.array(zod_v4.z.string()).optional()
});
var newsSourceSchema = zod_v4.z.object({
	type: zod_v4.z.literal("news"),
	country: zod_v4.z.string().length(2).optional(),
	excludedWebsites: zod_v4.z.array(zod_v4.z.string()).max(5).optional(),
	safeSearch: zod_v4.z.boolean().optional()
});
var rssSourceSchema = zod_v4.z.object({
	type: zod_v4.z.literal("rss"),
	links: zod_v4.z.array(zod_v4.z.string().url()).max(1)
});
var searchSourceSchema = zod_v4.z.discriminatedUnion("type", [
	webSourceSchema,
	xSourceSchema,
	newsSourceSchema,
	rssSourceSchema
]);
var xaiLanguageModelChatOptions = zod_v4.z.object({
	reasoningEffort: zod_v4.z.enum([
		"none",
		"low",
		"medium",
	...
	logprobs: zod_v4.z.boolean().optional(),
	topLogprobs: zod_v4.z.number().int().min(0).max(8).optional(),
	/**
	* Whether to enable parallel function calling during tool use.
	...
	* Defaults to true.
	*/
	parallel_function_calling: zod_v4.z.boolean().optional(),
	/**
	...
	*/
	searchParameters: zod_v4.z.object({
		/**
		...
		* defaults to true
		*/
		returnCitations: zod_v4.z.boolean().optional(),
		/**
		* start date for search data (ISO8601 format: YYYY-MM-DD)
		*/
		fromDate: zod_v4.z.string().optional(),
		/**
		...
		* defaults to 20
		*/
		maxSearchResults: zod_v4.z.number().min(1).max(50).optional(),
		/**
		...
		*/
		sources: zod_v4.z.array(searchSourceSchema).optional()
	}).optional()
});
var chatCompletionsErrorSchema = zod_v4.z.object({ error: zod_v4.z.object({
	message: zod_v4.z.string(),
	type: zod_v4.z.string().nullish(),
	param: zod_v4.z.any().nullish(),
	code: zod_v4.z.union([zod_v4.z.string(), zod_v4.z.number()]).nullish()
}) });
var responsesErrorSchema = zod_v4.z.object({
	code: zod_v4.z.string(),
	error: zod_v4.z.string()
});
var xaiFailedResponseHandler = require_dist.createJsonErrorResponseHandler({
	errorSchema: zod_v4.z.union([chatCompletionsErrorSchema, responsesErrorSchema]),
...
var XaiChatLanguageModel = class {
	...
	async doGenerate(options) {
		...
		const { responseHeaders, value: response, rawValue: rawResponse } = await require_dist.postJsonToApi({
			...
			successfulResponseHandler: require_dist.createJsonResponseHandler(xaiChatResponseSchema),
			abortSignal: options.abortSignal,
			fetch: this.config.fetch
		});
		if (response.error != null) throw new require_dist.APICallError({
	...
	async doStream(options) {
		...
		const { responseHeaders, value: response } = await require_dist.postJsonToApi({
			...
			successfulResponseHandler: async ({ response: response2 }) => {
				const responseHeaders2 = require_dist.extractResponseHeaders(response2);
				const contentType = response2.headers.get("content-type");
				if (contentType == null ? void 0 : contentType.includes("application/json")) {
					const responseBody = await response2.text();
					const parsedError = await require_dist.safeParseJSON({
						text: responseBody,
						schema: xaiStreamErrorSchema
					});
					if (parsedError.success) throw new require_dist.APICallError({
				...
				return require_dist.createEventSourceResponseHandler(xaiChatChunkSchema)({
					response: response2,
					url,
					requestBodyValues: body
				});
...
var xaiUsageSchema = zod_v4.z.object({
	prompt_tokens: zod_v4.z.number(),
	completion_tokens: zod_v4.z.number(),
	total_tokens: zod_v4.z.number(),
	prompt_tokens_details: zod_v4.z.object({
		text_tokens: zod_v4.z.number().nullish(),
		audio_tokens: zod_v4.z.number().nullish(),
...
var xaiChatResponseSchema = zod_v4.z.object({
	id: zod_v4.z.string().nullish(),
	created: zod_v4.z.number().nullish(),
	model: zod_v4.z.string().nullish(),
	choices: zod_v4.z.array(zod_v4.z.object({
	...
	object: zod_v4.z.literal("chat.completion").nullish(),
	usage: xaiUsageSchema.nullish(),
	citations: zod_v4.z.array(zod_v4.z.string().url()).nullish(),
	code: zod_v4.z.string().nullish(),
	error: zod_v4.z.string().nullish()
});
var xaiChatChunkSchema = zod_v4.z.object({
	id: zod_v4.z.string().nullish(),
	created: zod_v4.z.number().nullish(),
	model: zod_v4.z.string().nullish(),
	choices: zod_v4.z.array(zod_v4.z.object({
...
var xaiStreamErrorSchema = zod_v4.z.object({
	code: zod_v4.z.string(),
	error: zod_v4.z.string()
});
var xaiImageModelOptions = zod_v4.z.object({
	aspect_ratio: zod_v4.z.string().optional(),
	output_format: zod_v4.z.string().optional(),
	sync_mode: zod_v4.z.boolean().optional(),
	resolution: zod_v4.z.enum(["1k", "2k"]).optional(),
...
var XaiImageModel = class {
	...
	async doGenerate({ prompt, n, size, aspectRatio, seed, providerOptions, headers, abortSignal, files, mask }) {
		...
		const xaiOptions = await require_dist.parseProviderOptions({
			provider: "xai",
			providerOptions,
			schema: xaiImageModelOptions
		});
		const hasFiles = files != null && files.length > 0;
		const imageUrls = hasFiles ? files.map((file) => require_dist.convertImageModelFileToDataUri(file)) : [];
		...
		const { value: response, responseHeaders } = await require_dist.postJsonToApi({
			...
			body,
			failedResponseHandler: xaiFailedResponseHandler,
			successfulResponseHandler: require_dist.createJsonResponseHandler(xaiImageResponseSchema),
			abortSignal,
			fetch: this.config.fetch
		});
		return {
	...
	async downloadImage(url, abortSignal) {
		const { value } = await require_dist.getFromApi({
			url,
			abortSignal,
			failedResponseHandler: require_dist.createStatusCodeErrorResponseHandler(),
			successfulResponseHandler: require_dist.createBinaryResponseHandler(),
			fetch: this.config.fetch
		});
		return value;
	}
};
var xaiImageResponseSchema = zod_v4.z.object({
	data: zod_v4.z.array(zod_v4.z.object({
		url: zod_v4.z.string().nullish(),
		b64_json: zod_v4.z.string().nullish(),
		revised_prompt: zod_v4.z.string().nullish()
	})),
	usage: zod_v4.z.object({ cost_in_usd_ticks: zod_v4.z.number().nullish() }).nullish()
});
			...
			for (const block of message.content) switch (block.type) {
				...
				case "file":
					if (block.mediaType.startsWith("image/")) {
						...
						const imageUrl = block.data instanceof URL ? block.data.toString() : `data:${mediaType};base64,${require_dist.convertToBase64(block.data)}`;
						const filePartOptions = await require_dist.parseProviderOptions({
							provider: "xai",
					...
					else throw new require_dist.UnsupportedFunctionalityError({ functionality: `file part media type ${block.mediaType} as inline data (xAI Responses requires a URL or a Files API reference for non-image files)` });
					break;
...
var annotationSchema = zod_v4.z.union([zod_v4.z.object({
	type: zod_v4.z.literal("url_citation"),
	url: zod_v4.z.string(),
	title: zod_v4.z.string().optional()
}), zod_v4.z.object({ type: zod_v4.z.string() })]);
var messageContentPartSchema = zod_v4.z.object({
	type: zod_v4.z.string(),
	text: zod_v4.z.string().optional(),
	logprobs: zod_v4.z.array(zod_v4.z.any()).optional(),
	annotations: zod_v4.z.array(annotationSchema).optional()
});
var reasoningSummaryPartSchema = zod_v4.z.object({
	type: zod_v4.z.string(),
	text: zod_v4.z.string()
});
var toolCallSchema = zod_v4.z.object({
	name: zod_v4.z.string().optional(),
	arguments: zod_v4.z.string().optional(),
	input: zod_v4.z.string().optional(),
	call_id: zod_v4.z.string().optional(),
	id: zod_v4.z.string(),
	status: zod_v4.z.string(),
	action: zod_v4.z.any().optional()
});
var mcpCallSchema = zod_v4.z.object({
	name: zod_v4.z.string().optional(),
	arguments: zod_v4.z.string().optional(),
	output: zod_v4.z.string().optional(),
	error: zod_v4.z.string().optional(),
	id: zod_v4.z.string(),
	status: zod_v4.z.string(),
	server_label: zod_v4.z.string().optional()
});
var outputItemSchema = zod_v4.z.discriminatedUnion("type", [
	zod_v4.z.object({
		type: zod_v4.z.literal("web_search_call"),
		...toolCallSchema.shape
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("x_search_call"),
		...toolCallSchema.shape
	}),
	zod_v4.z.object({
	...
	zod_v4.z.object({
		type: zod_v4.z.literal("code_execution_call"),
		...toolCallSchema.shape
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("view_image_call"),
		...toolCallSchema.shape
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("view_x_video_call"),
		...toolCallSchema.shape
	}),
	zod_v4.z.object({
		...
		id: zod_v4.z.string(),
		status: zod_v4.z.string(),
		queries: zod_v4.z.array(zod_v4.z.string()).optional(),
		results: zod_v4.z.array(zod_v4.z.object({
			file_id: zod_v4.z.string(),
	...
	zod_v4.z.object({
		type: zod_v4.z.literal("custom_tool_call"),
		...toolCallSchema.shape
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("mcp_call"),
		...mcpCallSchema.shape
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("message"),
		role: zod_v4.z.string(),
		content: zod_v4.z.array(messageContentPartSchema),
		id: zod_v4.z.string(),
		status: zod_v4.z.string()
	}),
	zod_v4.z.object({
	...
	zod_v4.z.object({
		...
		id: zod_v4.z.string(),
		summary: zod_v4.z.array(reasoningSummaryPartSchema),
		content: zod_v4.z.array(zod_v4.z.object({
			type: zod_v4.z.string(),
			text: zod_v4.z.string()
		})).nullish(),
...
var xaiResponsesUsageSchema = zod_v4.z.object({
	input_tokens: zod_v4.z.number(),
	output_tokens: zod_v4.z.number(),
	total_tokens: zod_v4.z.number().optional(),
	input_tokens_details: zod_v4.z.object({ cached_tokens: zod_v4.z.number().optional() }).optional(),
	output_tokens_details: zod_v4.z.object({ reasoning_tokens: zod_v4.z.number().optional() }).optional(),
	num_sources_used: zod_v4.z.number().optional(),
	num_server_side_tools_used: zod_v4.z.number().optional()
});
var xaiResponsesResponseSchema = zod_v4.z.object({
	id: zod_v4.z.string().nullish(),
	created_at: zod_v4.z.number().nullish(),
	model: zod_v4.z.string().nullish(),
	object: zod_v4.z.literal("response"),
	output: zod_v4.z.array(outputItemSchema),
	usage: xaiResponsesUsageSchema.nullish(),
	status: zod_v4.z.string()
});
var xaiResponsesChunkSchema = zod_v4.z.union([
	zod_v4.z.object({
	...
	zod_v4.z.object({
		type: zod_v4.z.literal("response.in_progress"),
		response: xaiResponsesResponseSchema.partial({
			usage: true,
			status: true
		})
	...
	zod_v4.z.object({
		type: zod_v4.z.literal("response.content_part.added"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number(),
		content_index: zod_v4.z.number(),
		part: messageContentPartSchema
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.content_part.done"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number(),
		content_index: zod_v4.z.number(),
		part: messageContentPartSchema
	...
	zod_v4.z.object({
		type: zod_v4.z.literal("response.output_text.done"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number(),
		content_index: zod_v4.z.number(),
		text: zod_v4.z.string(),
	...
	zod_v4.z.object({
		...
		output_index: zod_v4.z.number(),
		content_index: zod_v4.z.number(),
		annotation_index: zod_v4.z.number(),
	...
	zod_v4.z.object({
		type: zod_v4.z.literal("response.reasoning_summary_text.done"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number(),
		summary_index: zod_v4.z.number(),
		text: zod_v4.z.string()
	...
	zod_v4.z.object({
		type: zod_v4.z.literal("response.reasoning_text.delta"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number(),
		content_index: zod_v4.z.number(),
		delta: zod_v4.z.string()
	...
	zod_v4.z.object({
		type: zod_v4.z.literal("response.reasoning_text.done"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number(),
		content_index: zod_v4.z.number(),
		text: zod_v4.z.string()
	...
	zod_v4.z.object({
		type: zod_v4.z.literal("response.web_search_call.in_progress"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.web_search_call.searching"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.web_search_call.completed"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.x_search_call.in_progress"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.x_search_call.searching"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.x_search_call.completed"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.file_search_call.in_progress"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.file_search_call.searching"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.file_search_call.completed"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.code_execution_call.in_progress"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.code_execution_call.executing"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.code_execution_call.completed"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.code_interpreter_call.in_progress"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.code_interpreter_call.executing"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.code_interpreter_call.interpreting"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.code_interpreter_call.completed"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number()
	}),
	zod_v4.z.object({
	...
	zod_v4.z.object({
		type: zod_v4.z.literal("response.custom_tool_call_input.delta"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number(),
		delta: zod_v4.z.string()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.custom_tool_call_input.done"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number(),
		input: zod_v4.z.string()
	}),
	zod_v4.z.object({
	...
	zod_v4.z.object({
		type: zod_v4.z.literal("response.function_call_arguments.done"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number(),
		arguments: zod_v4.z.string()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.mcp_call.in_progress"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.mcp_call.executing"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.mcp_call.completed"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.mcp_call.failed"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.mcp_call_arguments.delta"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number(),
		delta: zod_v4.z.string()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.mcp_call_arguments.done"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number(),
		arguments: zod_v4.z.string().optional()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.mcp_call_output.delta"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number(),
		delta: zod_v4.z.string()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.mcp_call_output.done"),
		item_id: zod_v4.z.string(),
		output_index: zod_v4.z.number(),
		output: zod_v4.z.string().optional()
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.incomplete"),
	...
	zod_v4.z.object({
		type: zod_v4.z.literal("response.failed"),
		response: zod_v4.z.object({
	...
	zod_v4.z.object({
		type: zod_v4.z.literal("response.done"),
		response: xaiResponsesResponseSchema
	}),
	zod_v4.z.object({
		type: zod_v4.z.literal("response.completed"),
		response: xaiResponsesResponseSchema
	})
]);
var xaiLanguageModelResponsesOptions = zod_v4.z.object({
	/**
	...
	*/
	previousResponseId: zod_v4.z.string().optional(),
	/**
	* Specify additional output data to include in the model response.
	* Example values: 'file_search_call.results'.
	*/
	include: zod_v4.z.array(zod_v4.z.enum(["file_search_call.results"])).nullish()
});
var fileSearchArgsSchema = require_dist.lazySchema(() => require_dist.zodSchema(zod_v4.z.object({
	vectorStoreIds: zod_v4.z.array(zod_v4.z.string()),
	maxNumResults: zod_v4.z.number().optional()
})));
var fileSearchOutputSchema = require_dist.lazySchema(() => require_dist.zodSchema(zod_v4.z.object({
	queries: zod_v4.z.array(zod_v4.z.string()),
	results: zod_v4.z.array(zod_v4.z.object({
		fileId: zod_v4.z.string(),
		filename: zod_v4.z.string(),
		score: zod_v4.z.number().min(0).max(1),
		text: zod_v4.z.string()
	})).nullable()
})));
var fileSearchToolFactory = require_dist.createProviderToolFactoryWithOutputSchema({
	id: "xai.file_search",
...
var mcpServerArgsSchema = require_dist.lazySchema(() => require_dist.zodSchema(zod_v4.z.object({
	serverUrl: zod_v4.z.string().describe("The URL of the MCP server"),
	serverLabel: zod_v4.z.string().optional().describe("A label for the MCP server"),
	serverDescription: zod_v4.z.string().optional().describe("Description of the MCP server"),
	allowedTools: zod_v4.z.array(zod_v4.z.string()).optional().describe("List of allowed tool names"),
	headers: zod_v4.z.record(zod_v4.z.string(), zod_v4.z.string()).optional().describe("Custom headers to send"),
	authorization: zod_v4.z.string().optional().describe("Authorization header value")
})));
var mcpServerOutputSchema = require_dist.lazySchema(() => require_dist.zodSchema(zod_v4.z.object({
	name: zod_v4.z.string(),
	arguments: zod_v4.z.string(),
	result: zod_v4.z.unknown()
})));
var mcpServerToolFactory = require_dist.createProviderToolFactoryWithOutputSchema({
	id: "xai.mcp",
	inputSchema: require_dist.lazySchema(() => require_dist.zodSchema(zod_v4.z.object({}))),
	outputSchema: mcpServerOutputSchema
});
var mcpServer = (args) => mcpServerToolFactory(args);
var webSearchArgsSchema = require_dist.lazySchema(() => require_dist.zodSchema(zod_v4.z.object({
	allowedDomains: zod_v4.z.array(zod_v4.z.string()).max(5).optional(),
	excludedDomains: zod_v4.z.array(zod_v4.z.string()).max(5).optional(),
	enableImageSearch: zod_v4.z.boolean().optional(),
	enableImageUnderstanding: zod_v4.z.boolean().optional()
})));
var webSearchOutputSchema = require_dist.lazySchema(() => require_dist.zodSchema(zod_v4.z.object({
	query: zod_v4.z.string(),
	sources: zod_v4.z.array(zod_v4.z.object({
		title: zod_v4.z.string(),
		url: zod_v4.z.string(),
		snippet: zod_v4.z.string()
	}))
})));
var webSearchToolFactory = require_dist.createProviderToolFactoryWithOutputSchema({
	id: "xai.web_search",
	inputSchema: require_dist.lazySchema(() => require_dist.zodSchema(zod_v4.z.object({}))),
	outputSchema: webSearchOutputSchema
});
var webSearch = (args = {}) => webSearchToolFactory(args);
var xSearchArgsSchema = require_dist.lazySchema(() => require_dist.zodSchema(zod_v4.z.object({
	allowedXHandles: zod_v4.z.array(zod_v4.z.string()).max(10).optional(),
	excludedXHandles: zod_v4.z.array(zod_v4.z.string()).max(10).optional(),
	fromDate: zod_v4.z.string().optional(),
	toDate: zod_v4.z.string().optional(),
	enableImageUnderstanding: zod_v4.z.boolean().optional(),
	enableVideoUnderstanding: zod_v4.z.boolean().optional()
})));
var xSearchOutputSchema = require_dist.lazySchema(() => require_dist.zodSchema(zod_v4.z.object({
	query: zod_v4.z.string(),
	posts: zod_v4.z.array(zod_v4.z.object({
		author: zod_v4.z.string(),
		text: zod_v4.z.string(),
		url: zod_v4.z.string(),
		likes: zod_v4.z.number()
	}))
})));
var xSearchToolFactory = require_dist.createProviderToolFactoryWithOutputSchema({
	id: "xai.x_search",
	inputSchema: require_dist.lazySchema(() => require_dist.zodSchema(zod_v4.z.object({}))),
...
var XaiResponsesLanguageModel = class {
	...
	async doGenerate(options) {
		...
		const { responseHeaders, value: response, rawValue: rawResponse } = await require_dist.postJsonToApi({
			...
			body,
			failedResponseHandler: xaiFailedResponseHandler,
			successfulResponseHandler: require_dist.createJsonResponseHandler(xaiResponsesResponseSchema),
			abortSignal: options.abortSignal,
			fetch: this.config.fetch
		});
		const content = [];
	...
	async doStream(options) {
		...
		const { responseHeaders, value: response } = await require_dist.postJsonToApi({
			...
			body,
			failedResponseHandler: xaiFailedResponseHandler,
			successfulResponseHandler: require_dist.createEventSourceResponseHandler(xaiResponsesChunkSchema),
			abortSignal: options.abortSignal,
			fetch: this.config.fetch
		});
		let finishReason = {
...
var codeExecutionOutputSchema = zod_v4.z.object({
	output: zod_v4.z.string().describe("the output of the code execution"),
	error: zod_v4.z.string().optional().describe("any error that occurred")
});
var codeExecutionToolFactory = require_dist.createProviderToolFactoryWithOutputSchema({
	id: "xai.code_execution",
	inputSchema: zod_v4.z.object({}).describe("no input parameters"),
	outputSchema: codeExecutionOutputSchema
});
var codeExecution = (args = {}) => codeExecutionToolFactory(args);
var viewImageOutputSchema = zod_v4.z.object({
	description: zod_v4.z.string().describe("description of the image"),
	objects: zod_v4.z.array(zod_v4.z.string()).optional().describe("objects detected in the image")
});
var viewImageToolFactory = require_dist.createProviderToolFactoryWithOutputSchema({
	id: "xai.view_image",
	inputSchema: zod_v4.z.object({}).describe("no input parameters"),
	outputSchema: viewImageOutputSchema
});
var viewImage = (args = {}) => viewImageToolFactory(args);
var viewXVideoOutputSchema = zod_v4.z.object({
	transcript: zod_v4.z.string().optional().describe("transcript of the video"),
	description: zod_v4.z.string().describe("description of the video content"),
	duration: zod_v4.z.number().optional().describe("duration in seconds")
});
var viewXVideoToolFactory = require_dist.createProviderToolFactoryWithOutputSchema({
	id: "xai.view_x_video",
	inputSchema: zod_v4.z.object({}).describe("no input parameters"),
...
var VERSION = "3.0.111";
var nonEmptyStringSchema = zod_v4.z.string().min(1);
var resolutionSchema = zod_v4.z.enum(["480p", "720p"]);
var modeSchema = zod_v4.z.enum([
	"edit-video",
	"extend-video",
	"reference-to-video"
]);
...
var userField = { user: zod_v4.z.string().optional() };
var editVideoSchema = zod_v4.z.object({
	...baseFields,
	...userField,
	mode: zod_v4.z.literal("edit-video"),
	videoUrl: nonEmptyStringSchema,
	referenceImageUrls: zod_v4.z.undefined().optional()
});
var extendVideoSchema = zod_v4.z.object({
	...baseFields,
	mode: zod_v4.z.literal("extend-video"),
	videoUrl: nonEmptyStringSchema,
	referenceImageUrls: zod_v4.z.undefined().optional()
});
var referenceToVideoSchema = zod_v4.z.object({
	...baseFields,
	...userField,
	mode: zod_v4.z.literal("reference-to-video"),
	referenceImageUrls: zod_v4.z.array(nonEmptyStringSchema).min(1).max(7),
	videoUrl: zod_v4.z.undefined().optional()
});
var autoDetectSchema = zod_v4.z.object({
	...baseFields,
	...userField,
	mode: zod_v4.z.undefined().optional(),
	videoUrl: nonEmptyStringSchema.optional(),
	referenceImageUrls: zod_v4.z.array(nonEmptyStringSchema).min(1).max(7).optional()
});
zod_v4.z.union([
	editVideoSchema,
	extendVideoSchema,
...
var runtimeSchema = zod_v4.z.object({
...
var xaiVideoModelOptionsSchema = require_dist.lazySchema(() => require_dist.zodSchema(runtimeSchema));
var RESOLUTION_MAP = {
	"1280x720": "720p",
	"854x480": "480p",
	"640x480": "480p"
...
function fileToXaiImageUrl(file) {
	if (file.type === "url") return file.url;
	const base64Data = typeof file.data === "string" ? file.data : require_dist.convertUint8ArrayToBase64(file.data);
...
var XaiVideoModel = class {
	...
	async doGenerate(options) {
		...
		const { value: createResponse } = await require_dist.postJsonToApi({
			...
			body,
			failedResponseHandler: xaiFailedResponseHandler,
			successfulResponseHandler: require_dist.createJsonResponseHandler(xaiCreateVideoResponseSchema),
			abortSignal: options.abortSignal,
			fetch: this.config.fetch
		});
		const requestId = createResponse.request_id;
		if (!requestId) throw new require_dist.AISDKError({
		...
		while (true) {
			...
			if (statusResponse.status === "done" || statusResponse.status == null && ((_g = statusResponse.video) == null ? void 0 : _g.url)) {
				if (((_h = statusResponse.video) == null ? void 0 : _h.respect_moderation) === false) throw new require_dist.AISDKError({
					name: "XAI_VIDEO_MODERATION_ERROR",
					message: "Video generation was blocked due to a content policy violation."
				});
				if (!((_i = statusResponse.video) == null ? void 0 : _i.url)) throw new require_dist.AISDKError({
					name: "XAI_VIDEO_GENERATION_ERROR",
			...
			if (statusResponse.status === "expired") throw new require_dist.AISDKError({
				name: "XAI_VIDEO_GENERATION_EXPIRED",
				message: "Video generation request expired."
			});
			if (statusResponse.status === "failed") throw new require_dist.AISDKError({
...
var xaiCreateVideoResponseSchema = zod_v4.z.object({ request_id: zod_v4.z.string().nullish() });
var xaiVideoStatusJsonResponseHandler = require_dist.createJsonResponseHandler(zod_v4.z.object({
	status: zod_v4.z.string().nullish(),
	video: zod_v4.z.object({
		url: zod_v4.z.string(),
		duration: zod_v4.z.number().nullish(),
		respect_moderation: zod_v4.z.boolean().nullish()
	}).nullish(),
	model: zod_v4.z.string().nullish(),
	usage: zod_v4.z.object({ cost_in_usd_ticks: zod_v4.z.number().nullish() }).nullish(),
	progress: zod_v4.z.number().nullish(),
	error: zod_v4.z.object({
		code: zod_v4.z.string().nullish(),
		message: zod_v4.z.string().nullish()
	}).nullish()
...
var xaiVideoStatusResponseHandler = async (options) => {
	if (options.response.status === 202) {
		const responseHeaders = require_dist.extractResponseHeaders(options.response);
		await require_dist.cancelResponseBody(options.response);
		return {
			responseHeaders,
...
function createXai(options = {}) {
	var _a;
	const baseURL = require_dist.withoutTrailingSlash((_a = options.baseURL) != null ? _a : "https://api.x.ai/v1");
	const getHeaders = () => require_dist.withUserAgentSuffix({
		Authorization: `Bearer ${require_dist.loadApiKey({
			apiKey: options.apiKey,
...
function parseModelRouterId(routerId, gatewayPrefix) {
	...
	if (gatewayPrefix === "azure-openai") {
		...
		if (!modelId) throw new Error(`Expected format azure-openai/deployment-name, but got ${routerId}`);
		return {
...
var models_dev_exports = /* @__PURE__ */ require_rolldown_runtime.__exportAll({ ModelsDevGateway: () => ModelsDevGateway });
...
var ModelsDevGateway = class extends require_dist.MastraModelGateway {
	id = "models.dev";
	name = "models.dev";
	providerConfigs = {};
	...
	async fetchProviders() {
		...
		for (const [providerId, providerInfo] of Object.entries(data)) {
			if (require_dist.EXCLUDED_PROVIDERS.includes(providerId)) continue;
			...
			const hasInstalledPackage = require_dist.PROVIDERS_WITH_INSTALLED_PACKAGES.includes(providerId);
	...
	*/
	...
	async resolveLanguageModel({ modelId, providerId, apiKey, headers }) {
		...
		if (override?.shape === "responses") return require_dist.createOpenAI({
			apiKey,
			baseURL,
			headers: mastraHeaders
		}).responses(modelId);
		switch (providerId) {
			case "openai": return require_dist.createOpenAI({
				apiKey,
				baseURL,
				headers: mastraHeaders
			}).responses(modelId);
			case "gemini":
			case "google": return require_dist.createGoogleGenerativeAI({
				apiKey,
				baseURL,
				headers: mastraHeaders
			}).chat(modelId);
			case "anthropic": return require_dist.createAnthropic({
				apiKey,
				baseURL,
				headers: mastraHeaders
			})(modelId);
			...
			case "vercel": return require_dist_3jq9sPhA.createGatewayProvider({
				apiKey,
				baseURL,
				headers: mastraHeaders
			})(modelId);
			...
			case "moonshotai-cn":
				...
				return require_dist.createAnthropic({
					apiKey,
					baseURL,
					headers: mastraHeaders
				})(modelId);
			default: {
				...
				if (npm === "@ai-sdk/openai") {
					if (!baseURL) throw new Error(`No API URL found for ${providerId}/${modelId}`);
					return require_dist.createOpenAI({
						apiKey,
						baseURL,
						headers: mastraHeaders
					}).chat(modelId);
				...
				if (npm === "@ai-sdk/google") {
					if (!baseURL) throw new Error(`No API URL found for ${providerId}/${modelId}`);
					return require_dist.createGoogleGenerativeAI({
						apiKey,
						baseURL,
						headers: mastraHeaders
					}).chat(modelId);
				...
				if (!baseURL) throw new Error(`No API URL found for ${providerId}/${modelId}`);
				return require_dist.createOpenAICompatible({
					name: providerId,
					apiKey,
					baseURL,
					headers: mastraHeaders,
...
Object.defineProperty(exports, "createOpenRouter", {
	enumerable: true,
	get: function() {
		return createOpenRouter;
	}
});
Object.defineProperty(exports, "models_dev_exports", {
	enumerable: true,
	get: function() {
		return models_dev_exports;
	}
});
Object.defineProperty(exports, "parseModelRouterId", {
	enumerable: true,
	get: function() {
		return parseModelRouterId;
	}
});

//# sourceMappingURL=models-dev-BPHvRLCw.cjs.map