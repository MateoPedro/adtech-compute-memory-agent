...
import type { ActiveThreadRun } from '../agent/thread-stream-runtime.js';
import type { MastraBrowser } from '../browser/browser.js';
import { AgentControllerChannels } from '../channels/agent-controller-channels.js';
...
import type { AvailableModel, IntervalHandler, AgentControllerConfig, AgentControllerMode, AgentControllerSessionCreatedListener, AgentControllerSessionCreatedOptions, AgentControllerSessionDeletedListener, AgentControllerThread, ModelAuthStatus, ToolCategory } from './types.js';
/**
...
export declare class AgentController<TState = {}> {
     ...
     */
    onSessionCreated(listener: AgentControllerSessionCreatedListener<TState>, options?: AgentControllerSessionCreatedOptions): () => void;
    /**
     ...
     */
    createSession({ resourceId, ownerId, id, scope, tags, threadId, workspace, browser, requestContext, }?: {
        resourceId?: string;
        id?: string;
        ownerId?: string;
        /**
     ...
     * arbitrary session.
     */
    getSessionByResource(resourceId: string, scope?: string): Promise<Session<TState> | undefined>;
    /**
     ...
     */
    queryThreads({ resourceId, includeForkedSubagents, metadata, }: {
        resourceId?: string;
     ...
     * creation.
     */
    queryThreadMessages({ threadId, limit }: {
        threadId: string;
        limit?: number;
