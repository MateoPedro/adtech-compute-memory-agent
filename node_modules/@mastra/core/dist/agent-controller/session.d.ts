...
import type { MastraDBMessage, MastraProviderMetadata } from '../agent/message-list/state/types.js';
import type { AgentSignalAttributes, AgentSignalContents, AgentSignalInput } from '../agent/signals.js';
import type { AgentThreadSubscription, MastraBrowser, SendAgentNotificationSignalOptions, SendAgentNotificationSignalResult, SendAgentSignalAccepted, ToolsetsInput } from '../agent/types.js';
...
import type { AgentControllerDisplayState, AgentControllerEvent, AgentControllerEventListener, AgentControllerMode, AgentControllerOMConfig, AgentControllerRequestState, AgentControllerThread, ModelUseCountTracker, PermissionPolicy, PermissionRules, TokenUsage, ToolCategory } from './types.js';
/**
...
export type SessionBeforeAgentEndListener = (event: Extract<AgentControllerEvent, {
    type: 'agent_end';
}>) => void | Promise<void>;
 ...
 */
export declare const ABORTED_BY_USER_REASON = "Aborted by the user";
/**
 ...
 */
declare const RESERVED_THREAD_METADATA_KEYS: readonly ["currentModelId", "currentModeId", "observerModelId", "reflectorModelId", "observationThreshold", "reflectionThreshold", "tokenUsage", "thinkingLevel", "notifications"];
...
export interface ThreadDataStore {
    ...
    firstUserMessages(input: {
        threadIds: string[];
    }): Promise<Map<string, MastraDBMessage>>;
...
export declare class Session<TState = unknown> {
    ...
    finishAgentRun(reason: NonNullable<Extract<AgentControllerEvent, {
        type: 'agent_end';
    }>['reason']>): Promise<void>;
    /**
    ...
    sendSignal(input: AgentSignalInput | {
        ...
        accepted: Promise<{
            accepted: true;
            runId?: string;
            action?: SendAgentSignalAccepted['action'];
        }>;
    };
    /**
